 ...
 */
export function sanitizeProcessEnvironment(env: IProcessEnvironment, ...preserve: string[]): cognidream {
 ...
 */
export function removeDangerousEnvVariables(env: IProcessEnvironment | undefined): cognidream {
    if (!env) {
        return;
    }
