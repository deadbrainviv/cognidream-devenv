...
class RemoteAuthoritiesImpl {
    ...
    setDelegate(delegate: (uri: URI) => URI): cognidream {
        this._delegate = delegate;
    }

    setServerRootPath(product: { quality?: string; commit?: string }, serverBasePath: string | undefined): cognidream {
    ...
    set(authority: string, host: string, port: number): cognidream {
        this._hosts[authority] = host;
        this._ports[authority] = port;
    }

    setConnectionToken(authority: string, connectionToken: string): cognidream {
...
export namespace COI {
     ...
     */
    export function addSearchParam(urlOrSearch: URLSearchParams | Record<string, string>, coop: boolean, coep: boolean): cognidream {
