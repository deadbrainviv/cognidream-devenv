...
export interface IHistory<T> {
    ...
    has(t: T): boolean;
    clear(): cognidream;
    forEach(callbackfn: (value: T, value2: T, set: Set<T>) => cognidream, thisArg?: any): cognidream;
    replace?(t: T[]): cognidream;
...
export class HistoryNavigator2<T> {
    ...
    *[Symbol.iterator](): Iterator<T> {
    ...
    private _deleteFromList(value: T): cognidream {
        let temp = this.head;
