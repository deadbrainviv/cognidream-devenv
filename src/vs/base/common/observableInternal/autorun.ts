 ...
 */
export function autorun(fn: (reader: IReader) => cognidream): IDisposable {
 ...
 * {@link fn} should start with a JS Doc using `@description` to name the autorun.
 */
export function autorunOpts(options: IDebugNameData & {}, fn: (reader: IReader) => cognidream): IDisposable {
    return new AutorunObserver(
...
export function autorunHandleChanges<TChangeSummary>(
    ...
    fn: (reader: IReader, changeSummary: TChangeSummary) => cognidream
): IDisposable {
    return new AutorunObserver(
        new DebugNameData(options.owner, options.debugName, options.debugReferenceFn ?? fn),
        fn,
...
export function autorunWithStoreHandleChanges<TChangeSummary>(
    ...
    fn: (reader: IReader, changeSummary: TChangeSummary, store: DisposableStore) => cognidream
): IDisposable {
 ...
 */
export function autorunWithStore(fn: (reader: IReader, store: DisposableStore) => cognidream): IDisposable {
    const store = new DisposableStore();
...
export function autorunDelta<T>(
    ...
    handler: (args: { lastValue: T | undefined; newValue: T }) => cognidream
): IDisposable {
...
export function autorunIterableDelta<T>(
    ...
    handler: (args: { addedValues: T[]; removedValues: T[] }) => cognidream,
...
export class AutorunObserver<TChangeSummary = any> implements IObserver, IReader, IDisposable {
    ...
    constructor(
        ...
        public readonly _runFn: (reader: IReader, changeSummary: TChangeSummary) => cognidream,
    ...
    public beginUpdate(_observable: IObservable<any>): cognidream {
    ...
    public endUpdate(_observable: IObservable<any>): cognidream {
        try {
    ...
    public handlePossibleChange(observable: IObservable<any>): cognidream {
