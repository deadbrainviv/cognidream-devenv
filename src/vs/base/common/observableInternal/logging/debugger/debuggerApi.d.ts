...
export type ObsDebuggerApi = {
    ...
    host: {
        notifications: {
            handleChange(update: ObsStateUpdate, clearState: boolean): cognidream;
        }
        requests: {},
    };
    client: {
        notifications: {
            setDeclarationIdFilter(declarationIds: ObsDeclarationId[]): cognidream;
            logObservableValue(observableId: ObsInstanceId): cognidream;
            flushUpdates(): cognidream;
            resetUpdates(): cognidream;
        },
        requests: {
            ...
            setValue(instanceId: ObsInstanceId, jsonValue: unknown): cognidream;
