...
export function derivedWithSetter<T>(owner: DebugOwner | undefined, computeFn: (reader: IReader) => T, setter: (value: T, transaction: ITransaction | undefined) => cognidream): ISettableObservable<T> {
...
export function derivedOpts<T>(
    options: IDebugNameData & {
        ...
        onLastObserverRemoved?: (() => cognidream);
    },
...
export class Derived<T, TChangeSummary = any> extends BaseObservable<T, cognidream> implements IReader, IObserver {
    ...
    constructor(
        ...
        private readonly _handleLastObserverRemoved: (() => cognidream) | undefined = undefined,
    ...
    public beginUpdate<T>(_observable: IObservable<T>): cognidream {
        if (this._isUpdating) {
            throw new BugIndicatingError('Cyclic deriveds are not supported yet!');
        }
    ...
    public endUpdate<T>(_observable: IObservable<T>): cognidream {
        this._updateCount--;
    ...
    public handlePossibleChange<T>(observable: IObservable<T>): cognidream {
    ...
    public handleChange<T, TChange>(observable: IObservableWithChange<T, TChange>, change: TChange): cognidream {
    ...
    public override addObserver(observer: IObserver): cognidream {
    ...
    public override removeObserver(observer: IObserver): cognidream {
...
export class DerivedWithSetter<T, TChangeSummary = any> extends Derived<T, TChangeSummary> implements ISettableObservable<T> {
    constructor(
        ...
        handleLastObserverRemoved: (() => cognidream) | undefined = undefined,
        equalityComparator: EqualityComparer<T>,
        public readonly set: (value: T, tx: ITransaction | undefined) => cognidream,
    ) {
        super(
            debugNameData,
            computeFn,
