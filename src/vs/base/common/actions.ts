...
export class Action extends Disposable implements IAction {
    ...
    private _setLabel(value: string): cognidream {
    ...
    protected _setTooltip(value: string): cognidream {
    ...
    protected _setClass(value: string | undefined): cognidream {
    ...
    protected _setEnabled(value: boolean): cognidream {
    ...
    protected _setChecked(value: boolean | undefined): cognidream {
    ...
    async run(event?: unknown, data?: ITelemetryData): Promise<cognidream> {
...
export class ActionRunner extends Disposable implements IActionRunner {
    ...
    protected async runAction(action: IAction, context?: unknown): Promise<cognidream> {
