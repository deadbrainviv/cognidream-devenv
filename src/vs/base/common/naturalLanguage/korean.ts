...
function getCodesFromArray(code: number, array: ArrayLike<number>, arrayStartIndex: number): cognidream {
...
function addCodesToBuffer(codes: number): cognidream {
    // NUL is ignored, this is used for archaic characters to acognidream using a Map
    // for the data
