...
export type TokenizerStartFunction = (this: TokenizerThis, src: string) => number | cognidream;
...
export interface MarkedExtension {
     ...
     */
    walkTokens?: ((token: Token) => cognidream | Promise<cognidream>) | undefined | null;
}
export interface MarkedOptions extends Omit<MarkedExtension, "hooks" | "renderer" | "tokenizer" | "extensions" | "walkTokens"> {
     ...
     */
    walkTokens?: null | ((token: Token) => cognidream | Promise<cognidream> | (cognidream | Promise<cognidream>)[]);
}
/**
 * Block Lexer
 */
...
export type MaybePromise = cognidream | Promise<cognidream>;
