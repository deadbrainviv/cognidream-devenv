...
export class ScrollState implements IScrollDimensions, IScrollPosition {
    _scrollStateBrand: cognidream = undefined;
...
export class Scrollable extends Disposable {
    ...
    _scrollableBrand: cognidream = undefined;

    private _smoothScrollDuration: number;
    private readonly _scheduleAtNextAnimationFrame: (callback: () => cognidream) => IDisposable;
    ...
    public setScrollDimensions(dimensions: INewScrollDimensions, useRawScrollPositions: boolean): cognidream {
    ...
    public setScrollPositionSmooth(update: INewScrollPosition, reuseAnimation?: boolean): cognidream {
    ...
    private _performSmoothScrolling(): cognidream {
        if (!this._smoothScrolling) {
            return;
        }
    ...
    private _setState(newState: ScrollState, inSmoothScrolling: boolean): cognidream {
...
export class SmoothScrollingOperation {
    ...
    private _initAnimations(): cognidream {
    ...
    public acceptScrollDimensions(state: ScrollState): cognidream {
