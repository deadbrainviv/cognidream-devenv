...
export interface MarkdownRenderOptions extends FormattedTextRenderOptions {
    ...
    readonly asyncRenderCallback?: () => cognidream;
 ...
 */
export function renderMarkdown(markdown: IMarkdownString, options: MarkdownRenderOptions = {}, markedOptions: Readonly<MarkedOptions> = {}): { element: HTMLElement; dispose: () => cognidream } {
...
function activateLink(markdown: IMarkdownString, options: MarkdownRenderOptions, event: StandardMouseEvent | StandardKeyboardEvent): cognidream {
...
function addDompurifyHook(
    ...
    cb: (currentNode: Element, data: dompurify.SanitizeElementHookEvent, config: dompurify.Config) => cognidream,
): IDisposable;
function addDompurifyHook(
    hook: 'uponSanitizeAttribute',
    cb: (currentNode: Element, data: dompurify.SanitizeAttributeHookEvent, config: dompurify.Config) => cognidream,
): IDisposable;
