...
export namespace inputLatency {
    ...
    function addMeasure(entryName: string, cumulativeMeasurement: ICumulativeMeasurement): cognidream {
    ...
    function clearCumulativeMeasurement(cumulative: ICumulativeMeasurement): cognidream {
        cumulative.total = 0;
