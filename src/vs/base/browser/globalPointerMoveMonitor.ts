...
export interface IPointerMoveCallback {
    (event: PointerEvent): cognidream;
}

export interface IOnStopCallback {
    (browserEvent?: PointerEvent | KeyboardEvent): cognidream;
}
...
export class GlobalPointerMoveMonitor implements IDisposable {
    ...
    public stopMonitoring(invokeStopCallback: boolean, browserEvent?: PointerEvent | KeyboardEvent): cognidream {
