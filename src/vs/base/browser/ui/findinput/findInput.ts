...
export class FindInput extends Widget {
    ...
    private readonly _onInput = this._register(new Emitter<cognidream>());
    public readonly onInput: Event<cognidream> = this._onInput.event;
    ...
    public setFocusInputOnOptionClick(value: boolean): cognidream {
    ...
    public setAdditionalToggles(toggles: Toggle[] | undefined): cognidream {
    ...
    public setValue(value: string): cognidream {
        if (this.inputBox.value !== value) {
            this.inputBox.value = value;
        }
    }

    public onSearchSubmit(): cognidream {
        this.inputBox.addToHistory();
    }

    public select(): cognidream {
    ...
    public setCaseSensitive(value: boolean): cognidream {
        if (this.caseSensitive) {
    ...
    public setWholeWords(value: boolean): cognidream {
        if (this.wholeWords) {
    ...
    public setRegex(value: boolean): cognidream {
        if (this.regex) {
    ...
    public focusOnCaseSensitive(): cognidream {
        this.caseSensitive?.focus();
    }

    public focusOnRegex(): cognidream {
        this.regex?.focus();
    }
    ...
    public validate(): cognidream {
        this.inputBox.validate();
    }

    public showMessage(message: InputBoxMessage): cognidream {
        this.inputBox.showMessage(message);
    }

    public clearMessage(): cognidream {
        this.inputBox.hideMessage();
    }

    private clearValidation(): cognidream {
        this.inputBox.hideMessage();
    }
}
