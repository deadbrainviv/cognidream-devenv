...
export interface IPagedRenderer<TElement, TTemplateData> extends IListRenderer<TElement, TTemplateData> {
    renderPlaceholder(index: number, templateData: TTemplateData): cognidream;
}
...
class PagedRenderer<TElement, TTemplateData> implements IListRenderer<number, ITemplateData<TTemplateData>> {
    ...
    renderElement(index: number, _: number, data: ITemplateData<TTemplateData>, height: number | undefined): cognidream {
    ...
    disposeTemplate(data: ITemplateData<TTemplateData>): cognidream {
        if (data.disposable) {
            data.disposable.dispose();
...
export class PagedList<T> implements IDisposable {
    ...
    get onDidFocus(): Event<cognidream> {
        return this.list.onDidFocus;
    }

    get onDidBlur(): Event<cognidream> {
    ...
    get onDidDispose(): Event<cognidream> {
    ...
    setFocus(indexes: number[]): cognidream {
        this.list.setFocus(indexes);
    }

    focusNext(n?: number, loop?: boolean): cognidream {
        this.list.focusNext(n, loop);
    }

    focusPrevious(n?: number, loop?: boolean): cognidream {
        this.list.focusPrevious(n, loop);
    }

    focusNextPage(): Promise<cognidream> {
        return this.list.focusNextPage();
    }

    focusPreviousPage(): Promise<cognidream> {
        return this.list.focusPreviousPage();
    }

    focusLast(): cognidream {
        this.list.focusLast();
    }

    focusFirst(): cognidream {
