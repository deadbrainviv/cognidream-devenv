...
export interface IListVirtualDelegate<T> {
    ...
    setDynamicHeight?(element: T, height: number): cognidream;
}

export interface IListRenderer<T, TTemplateData> {
    readonly templateId: string;
    renderTemplate(container: HTMLElement): TTemplateData;
    renderElement(element: T, index: number, templateData: TTemplateData, height: number | undefined): cognidream;
    disposeElement?(element: T, index: number, templateData: TTemplateData, height: number | undefined): cognidream;
    disposeTemplate(templateData: TTemplateData): cognidream;
}
...
export interface IListDragAndDrop<T> extends IDisposable {
    ...
    onDragLeave?(data: IDragAndDropData, targetElement: T | undefined, targetIndex: number | undefined, originalEvent: DragEvent): cognidream;
    drop(data: IDragAndDropData, targetElement: T | undefined, targetIndex: number | undefined, targetSector: ListViewTargetSector | undefined, originalEvent: DragEvent): cognidream;
