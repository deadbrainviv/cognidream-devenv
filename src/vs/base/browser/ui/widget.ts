...
export abstract class Widget extends Disposable {
    ...
    protected onclick(domNode: HTMLElement, listener: (e: IMouseEvent) => cognidream): cognidream {
    ...
    protected onmousedown(domNode: HTMLElement, listener: (e: IMouseEvent) => cognidream): cognidream {
    ...
    protected onmouseover(domNode: HTMLElement, listener: (e: IMouseEvent) => cognidream): cognidream {
    ...
    protected onmouseleave(domNode: HTMLElement, listener: (e: IMouseEvent) => cognidream): cognidream {
    ...
    protected onkeydown(domNode: HTMLElement, listener: (e: IKeyboardEvent) => cognidream): cognidream {
    ...
    protected onkeyup(domNode: HTMLElement, listener: (e: IKeyboardEvent) => cognidream): cognidream {
    ...
    protected oninput(domNode: HTMLElement, listener: (e: Event) => cognidream): cognidream {
        this._register(dom.addDisposableListener(domNode, dom.EventType.INPUT, listener));
    }

    protected onblur(domNode: HTMLElement, listener: (e: Event) => cognidream): cognidream {
        this._register(dom.addDisposableListener(domNode, dom.EventType.BLUR, listener));
    }

    protected onfocus(domNode: HTMLElement, listener: (e: Event) => cognidream): cognidream {
        this._register(dom.addDisposableListener(domNode, dom.EventType.FOCUS, listener));
    }

    protected onchange(domNode: HTMLElement, listener: (e: Event) => cognidream): cognidream {
