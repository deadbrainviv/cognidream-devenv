...
export interface IObjectTreeOptions<T, TFilterData = cognidream> extends IAbstractTreeOptions<T, TFilterData> {
...
export class ObjectTree<T extends NonNullable<any>, TFilterData = cognidream> extends AbstractTree<T | null, TFilterData, T | null> {
    ...
    setChildren(element: T | null, children: Iterable<IObjectTreeElement<T>> = Iterable.empty(), options?: IObjectTreeSetChildrenOptions<T>): cognidream {
    ...
    resort(element: T | null, recursive = true): cognidream {
...
export interface ICompressibleTreeRenderer<T, TFilterData = cognidream, TTemplateData = cognidream> extends ITreeRenderer<T, TFilterData, TTemplateData> {
    renderCompressedElements(node: ITreeNode<ICompressedTreeNode<T>, TFilterData>, index: number, templateData: TTemplateData, height: number | undefined): cognidream;
    disposeCompressedElements?(node: ITreeNode<ICompressedTreeNode<T>, TFilterData>, index: number, templateData: TTemplateData, height: number | undefined): cognidream;
}
...
class CompressibleRenderer<T extends NonNullable<any>, TFilterData, TTemplateData> implements ITreeRenderer<T, TFilterData, CompressibleTemplateData<T, TFilterData, TTemplateData>> {
    ...
    renderElement(node: ITreeNode<T, TFilterData>, index: number, templateData: CompressibleTemplateData<T, TFilterData, TTemplateData>, height: number | undefined): cognidream {
    ...
    disposeElement(node: ITreeNode<T, TFilterData>, index: number, templateData: CompressibleTemplateData<T, TFilterData, TTemplateData>, height: number | undefined): cognidream {
    ...
    disposeTemplate(templateData: CompressibleTemplateData<T, TFilterData, TTemplateData>): cognidream {
...
export interface ICompressibleObjectTreeOptions<T, TFilterData = cognidream> extends IObjectTreeOptions<T, TFilterData> {
...
export class CompressibleObjectTree<T extends NonNullable<any>, TFilterData = cognidream> extends ObjectTree<T, TFilterData> implements ICompressedTreeNodeProvider<T, TFilterData> {
    ...
    override setChildren(element: T | null, children: Iterable<ICompressedTreeElement<T>> = Iterable.empty(), options?: IObjectTreeSetChildrenOptions<T>): cognidream {
        this.model.setChildren(element, children, options);
    }
    ...
    override updateOptions(optionsUpdate: ICompressibleObjectTreeOptionsUpdate = {}): cognidream {
