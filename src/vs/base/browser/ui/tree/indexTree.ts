...
export interface IIndexTreeOptions<T, TFilterData = cognidream> extends IAbstractTreeOptions<T, TFilterData> { }

export class IndexTree<T, TFilterData = cognidream> extends AbstractTree<T, TFilterData, number[]> {
    ...
    splice(location: number[], deleteCount: number, toInsert: Iterable<ITreeElement<T>> = Iterable.empty()): cognidream {
    ...
    updateElementHeight(location: number[], height: number): cognidream {
