...
// Exported only for test reasons, do not use directly
export class CompressedObjectTreeModel<T extends NonNullable<any>, TFilterData extends NonNullable<any> = cognidream> implements ITreeModel<ICompressedTreeNode<T> | null, TFilterData, T | null> {
    ...
    setCompressionEnabled(enabled: boolean): cognidream {
    ...
    expandTo(location: T | null): cognidream {
        const compressedNode = this.getCompressedNode(location);
        this.model.expandTo(compressedNode);
    }

    rerender(location: T | null): cognidream {
        const compressedNode = this.getCompressedNode(location);
    ...
    resort(location: T | null = null, recursive = true): cognidream {
        const compressedNode = this.getCompressedNode(location);
...
export class CompressibleObjectTreeModel<T extends NonNullable<any>, TFilterData extends NonNullable<any> = cognidream> implements IObjectTreeModel<T, TFilterData> {
