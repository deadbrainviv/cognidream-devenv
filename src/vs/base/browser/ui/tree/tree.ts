 ...
 * elements in a tree.
 */
export interface ITreeFilter<T, TFilterData = cognidream> {
...
export interface ITreeNode<T, TFilterData = cognidream> {
    readonly element: T;
...
export interface ITreeModel<T, TFilterData, TRef> {
    ...
    rerender(location: TRef): cognidream;
    refilter(): cognidream;
}

export interface ITreeRenderer<T, TFilterData = cognidream, TTemplateData = cognidream> extends IListRenderer<ITreeNode<T, TFilterData>, TTemplateData> {
