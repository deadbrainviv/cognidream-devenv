...
export class ToolBar extends Disposable {
    ...
    setActions(primaryActions: ReadonlyArray<IAction>, secondaryActions?: ReadonlyArray<IAction>): cognidream {
        this.clear();
...
export class ToggleMenuAction extends Action {
    ...
    private toggleDropdownMenu: () => cognidream;

    constructor(toggleDropdownMenu: () => cognidream, title?: string) {
