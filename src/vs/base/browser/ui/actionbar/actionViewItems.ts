...
export class BaseActionViewItem extends Disposable implements IActionViewItem {
    ...
    private handleActionChangeEvent(event: IActionChangeEvent): cognidream {
    ...
    setActionContext(newContext: unknown): cognidream {
    ...
    onClick(event: EventLike, preserveFocus = false): cognidream {
    ...
    protected updateEnabled(): cognidream {
        // implement in subclass
    }

    protected updateLabel(): cognidream {
        // implement in subclass
    }
    ...
    protected updateTooltip(): cognidream {
        if (!this.element) {
            return;
        }
    ...
    protected updateAriaLabel(): cognidream {
        if (this.element) {
            const title = this.getTooltip() ?? '';
    ...
    protected updateClass(): cognidream {
        // implement in subclass
    }

    protected updateChecked(): cognidream {
        // implement in subclass
    }
...
export class ActionViewItem extends BaseActionViewItem {
    ...
    override setFocusable(focusable: boolean): cognidream {
        if (this.label) {
    ...
    protected override updateAriaLabel(): cognidream {
        if (this.label) {
            const title = this.getTooltip() ?? '';
...
export class SelectActionViewItem<T = string> extends BaseActionViewItem {
    ...
    protected runAction(option: string, index: number): cognidream {
