...
export function setGlobalSashSize(size: number): cognidream {
    globalSize = size;
...
export function setGlobalHoverDelay(size: number): cognidream {
...
export class Sash extends Disposable {
    ...
    private readonly _onDidReset = this._register(new Emitter<cognidream>());
    private readonly _onDidEnd = this._register(new Emitter<cognidream>());
     ...
     */
    readonly onDidReset: Event<cognidream> = this._onDidReset.event;

    /**
     * An event which fires whenever the user stops dragging this sash.
     */
    readonly onDidEnd: Event<cognidream> = this._onDidEnd.event;
    ...
    private onPointerStart(event: PointerEvent, pointerEventFactory: IPointerEventFactory): cognidream {
    ...
    private onPointerDoublePress(e: MouseEvent): cognidream {
    ...
    private static onMouseEnter(sash: Sash, fromLinkedSash: boolean = false): cognidream {
    ...
    private static onMouseLeave(sash: Sash, fromLinkedSash: boolean = false): cognidream {
        sash.hoverDelayer.cancel();
     ...
     */
    clearSashHoverState(): cognidream {
