 ...
 */
export function alert(msg: string): cognidream {
    if (!ariaContainer) {
        return;
    }
 ...
 */
export function status(msg: string): cognidream {
    if (!ariaContainer) {
        return;
    }
...
function insertMessage(target: HTMLElement, msg: string): cognidream {
