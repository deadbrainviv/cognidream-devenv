...
export class ResizableHTMLElement {
    ...
    private readonly _onDidWillResize = new Emitter<cognidream>();
    readonly onDidWillResize: Event<cognidream> = this._onDidWillResize.event;
    ...
    enableSashes(north: boolean, east: boolean, south: boolean, west: boolean): cognidream {
    ...
    layout(height: number = this.size.height, width: number = this.size.width): cognidream {
