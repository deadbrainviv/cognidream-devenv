...
export class MouseWheelClassifier {
    ...
    public acceptStandardWheelEvent(e: StandardWheelEvent): cognidream {
        if (isChrome) {
    ...
    public accept(timestamp: number, deltaX: number, deltaY: number): cognidream {
    ...
    private _computeScore(item: MouseWheelClassifierItem, previousItem: MouseWheelClassifierItem | null): number {
        ...
        if (previousItem) {
            ...
            // Min 1 to acognidream division by zero, module 1 will still be 0.
...
export abstract class AbstractScrollableElement extends Widget {
    ...
    public setScrollDimensions(dimensions: INewScrollDimensions): cognidream {
     ...
     */
    public updateClassName(newClassName: string): cognidream {
     ...
     */
    public updateOptions(newOptions: ScrollableElementChangeOptions): cognidream {
    ...
    private _setListeningToMouseWheel(shouldListen: boolean): cognidream {
    ...
    private _onMouseWheel(e: StandardWheelEvent): cognidream {
    ...
    private _onDidScroll(e: ScrollEvent): cognidream {
    ...
    private _onDragStart(): cognidream {
        this._isDragging = true;
        this._reveal();
    }

    private _onDragEnd(): cognidream {
        this._isDragging = false;
        this._hide();
    }

    private _onMouseLeave(e: IMouseEvent): cognidream {
        this._mouseIsOver = false;
        this._hide();
    }

    private _onMouseOver(e: IMouseEvent): cognidream {
        this._mouseIsOver = true;
        this._reveal();
    }

    private _reveal(): cognidream {
        this._verticalScrollbar.beginReveal();
        this._horizontalScrollbar.beginReveal();
        this._scheduleHide();
    }

    private _hide(): cognidream {
    ...
    private _scheduleHide(): cognidream {
        if (!this._mouseIsOver && !this._isDragging) {
...
export class ScrollableElement extends AbstractScrollableElement {
    ...
    public setScrollPosition(update: INewScrollPosition): cognidream {
...
export class SmoothScrollableElement extends AbstractScrollableElement {
    ...
    public setScrollPosition(update: INewScrollPosition & { reuseAnimation?: boolean }): cognidream {
