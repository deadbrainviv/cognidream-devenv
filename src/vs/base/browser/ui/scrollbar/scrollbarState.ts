...
export class ScrollbarState {
    ...
    public setScrollbarSize(scrollbarSize: number): cognidream {
        this._scrollbarSize = Math.round(scrollbarSize);
    }

    public setOppositeScrollbarSize(oppositeScrollbarSize: number): cognidream {
        this._oppositeScrollbarSize = Math.round(oppositeScrollbarSize);
    }
    ...
    private _refreshComputedValues(): cognidream {
