...
export interface ScrollbarHost {
    onMouseWheel(mouseWheelEvent: StandardWheelEvent): cognidream;
    onDragStart(): cognidream;
    onDragEnd(): cognidream;
}
...
export abstract class AbstractScrollbar extends Widget {
     ...
     */
    protected _createArrow(opts: ScrollbarArrowOptions): cognidream {
     ...
     */
    protected _createSlider(top: number, left: number, width: number | undefined, height: number | undefined): cognidream {
    ...
    public beginReveal(): cognidream {
        this._visibilityController.setShouldBeVisible(true);
    }

    public beginHide(): cognidream {
        this._visibilityController.setShouldBeVisible(false);
    }

    public render(): cognidream {
    ...
    private _domNodePointerDown(e: PointerEvent): cognidream {
    ...
    public delegatePointerDown(e: PointerEvent): cognidream {
    ...
    private _onPointerDown(e: PointerEvent): cognidream {
        let offsetX: number;
        let offsetY: number;
    ...
    private _sliderPointerDown(e: PointerEvent): cognidream {
    ...
    private _setDesiredScrollPositionNow(_desiredScrollPosition: number): cognidream {
    ...
    public updateScrollbarSize(scrollbarSize: number): cognidream {
    ...
    protected abstract _renderDomNode(largeSize: number, smallSize: number): cognidream;
    protected abstract _updateSlider(sliderSize: number, sliderPosition: number): cognidream;
    ...
    protected abstract _updateScrollbarSize(size: number): cognidream;

    public abstract writeScrollPosition(target: INewScrollPosition, scrollPosition: number): cognidream;
}
