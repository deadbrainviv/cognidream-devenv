...
export class VerticalScrollbar extends AbstractScrollbar {
    ...
    protected _updateSlider(sliderSize: number, sliderPosition: number): cognidream {
        this.slider.setHeight(sliderSize);
        this.slider.setTop(sliderPosition);
    }

    protected _renderDomNode(largeSize: number, smallSize: number): cognidream {
    ...
    protected _updateScrollbarSize(size: number): cognidream {
        this.slider.setWidth(size);
    }

    public writeScrollPosition(target: INewScrollPosition, scrollPosition: number): cognidream {
        target.scrollTop = scrollPosition;
    }

    public updateOptions(options: ScrollableElementResolvedOptions): cognidream {
