...
export class ProgressBar extends Disposable {
    ...
    private create(container: HTMLElement, options?: IProgressBarOptions): cognidream {
    ...
    private infiniteLongRunning(): cognidream {
