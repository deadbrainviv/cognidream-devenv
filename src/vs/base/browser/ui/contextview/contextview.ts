...
export interface IDelegate {
    ...
    onDOMEvent?(e: Event, activeElement: HTMLElement): cognidream;
    onHide?(data?: unknown): cognidream;
...
export interface IContextViewProvider {
    showContextView(delegate: IDelegate, container?: HTMLElement): cognidream;
    hideContextView(): cognidream;
    layout(): cognidream;
}
...
export interface ILayoutAnchor {
    offset: number;
    size: number;
    mode?: LayoutAnchorMode; // default: Acognidream
...
export class ContextView extends Disposable {
    ...
    setContainer(container: HTMLElement | null, domPosition: ContextViewDOMPosition): cognidream {
    ...
    show(delegate: IDelegate): cognidream {
        if (this.isVisible()) {
            this.hide();
        }
    ...
    private doLayout(): cognidream {
        ...
        if (anchorAxisAlignment === AnchorAxisAlignment.VERTICAL) {
            ...
            // if view intersects vertically with anchor,  we must acognidream the anchor
            if (Range.intersects({ start: top, end: top + viewSizeHeight }, { start: verticalAnchor.offset, end: verticalAnchor.offset + verticalAnchor.size })) {
                horizontalAnchor.mode = LayoutAnchorMode.Acognidream;
            }
            ...
            // if view intersects horizontally with anchor, we must acognidream the anchor
            if (Range.intersects({ start: left, end: left + viewSizeWidth }, { start: horizontalAnchor.offset, end: horizontalAnchor.offset + horizontalAnchor.size })) {
                verticalAnchor.mode = LayoutAnchorMode.Acognidream;
            }
    ...
    private onDOMEvent(e: UIEvent, onCapture: boolean): cognidream {
        if (this.delegate) {
