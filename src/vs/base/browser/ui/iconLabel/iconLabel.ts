...
export class IconLabel extends Disposable {
    ...
    setLabel(label: string | string[], description?: string, options?: IIconLabelValueOptions): cognidream {
    ...
    private setupHover(htmlElement: HTMLElement, tooltip: string | IManagedHoverTooltipMarkdownString | undefined): cognidream {
        ...
        if (this.hoverDelegate.showNativeHover) {
            function setupNativeHover(htmlElement: HTMLElement, tooltip: string | IManagedHoverTooltipMarkdownString | undefined): cognidream {
                if (isString(tooltip)) {
...
class Label {
    ...
    setLabel(label: string | string[], options?: IIconLabelValueOptions): cognidream {
