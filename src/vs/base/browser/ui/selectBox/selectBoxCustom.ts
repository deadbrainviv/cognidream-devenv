...
class SelectListRenderer implements IListRenderer<ISelectOptionItem, ISelectListTemplateData> {
    ...
    renderElement(element: ISelectOptionItem, index: number, templateData: ISelectListTemplateData): cognidream {
    ...
    disposeTemplate(_templateData: ISelectListTemplateData): cognidream {
        // noop
    }
}
...
export class SelectBoxList extends Disposable implements ISelectBoxDelegate, IListVirtualDelegate<ISelectOptionItem> {
    ...
    private setTitle(title: string): cognidream {
    ...
    public setOptions(options: ISelectOptionItem[], selected?: number): cognidream {
    ...
    public setEnabled(enable: boolean): cognidream {
    ...
    public select(index: number): cognidream {
    ...
    public setAriaLabel(label: string): cognidream {
    ...
    public setFocusable(focusable: boolean): cognidream {
    ...
    private initStyleSheet(): cognidream {
    ...
    private styleSelectElement(): cognidream {
    ...
    private layoutSelectDropDown(preLayoutPosition?: boolean): boolean {
        ...
        // Acognidream recursion from layout called in onListFocus
        if (this._skipLayout) {
            return false;
        }
    ...
    private createSelectList(parent: HTMLElement): cognidream {
    ...
    private onPointerUp(e: PointerEvent): cognidream {
    ...
    private updateDetail(selectedIndex: number): cognidream {
        this.selectionDetailsPane.innerText = '';
    ...
    private onPageUp(e: StandardKeyboardEvent): cognidream {
        dom.EventHelper.stop(e);
    ...
    private onPageDown(e: StandardKeyboardEvent): cognidream {
        dom.EventHelper.stop(e);
    ...
    private onHome(e: StandardKeyboardEvent): cognidream {
        dom.EventHelper.stop(e);
    ...
    private onEnd(e: StandardKeyboardEvent): cognidream {
        dom.EventHelper.stop(e);
    ...
    private onCharacter(e: StandardKeyboardEvent): cognidream {
