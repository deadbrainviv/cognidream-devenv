...
export class Menu extends ActionBar {
    ...
    private initializeOrUpdateStyleSheet(container: HTMLElement, style: IMenuStyles): cognidream {
        if (!this.styleSheet) {
    ...
    private styleScrollElement(scrollElement: HTMLElement, style: IMenuStyles): cognidream {
    ...
    trigger(index: number): cognidream {
    ...
    private setFocusedItem(element: HTMLElement): cognidream {
    ...
    protected override updateFocus(fromRight?: boolean): cognidream {
...
class BaseMenuActionViewItem extends BaseActionViewItem {
    ...
    constructor(ctx: unknown, action: IAction, options: IMenuItemOptions, protected readonly menuStyle: IMenuStyles) {
        ...
        // Add mouse up listener later to acognidream accidental clicks
    ...
    updatePositionInSet(pos: number, setSize: number): cognidream {
        if (this.item) {
    ...
    protected override updateTooltip(): cognidream {
        // menus should function like native menus and they do not have tooltips
    }

    protected override updateClass(): cognidream {
    ...
    protected override updateEnabled(): cognidream {
    ...
    protected override updateChecked(): cognidream {
        if (!this.item) {
            return;
        }
    ...
    protected applyStyle(): cognidream {
...
class SubmenuMenuActionViewItem extends BaseMenuActionViewItem {
    ...
    open(selectFirst?: boolean): cognidream {
        this.cleanupExistingSubmenu(false);
        this.createSubmenu(selectFirst);
    }

    override onClick(e: EventLike): cognidream {
    ...
    private cleanupExistingSubmenu(force: boolean): cognidream {
    ...
    private createSubmenu(selectFirstItem = true): cognidream {
        if (!this.element) {
            return;
        }
    ...
    private updateAriaExpanded(value: string): cognidream {
        if (this.item) {
            this.item?.setAttribute('aria-expanded', value);
        }
    }

    protected override applyStyle(): cognidream {
        super.applyStyle();
