...
export class HoverAction extends Disposable {
    public static render(parent: HTMLElement, actionOptions: { label: string; iconClass?: string; run: (target: HTMLElement) => cognidream; commandId: string }, keybindingLabel: string | null) {
    ...
    private constructor(parent: HTMLElement, actionOptions: { label: string; iconClass?: string; run: (target: HTMLElement) => cognidream; commandId: string }, keybindingLabel: string | null) {
        super();
...
export class ClickAction extends Disposable {
    constructor(container: HTMLElement, run: (container: HTMLElement) => cognidream) {
        super();
...
export class KeyDownAction extends Disposable {
    constructor(container: HTMLElement, run: (container: HTMLElement) => cognidream, keyCodes: KeyCode[]) {
        super();
