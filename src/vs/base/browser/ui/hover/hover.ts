...
export interface IHoverDelegate2 {
     ...
     * possible.
     */
    showManagedHover(targetElement: HTMLElement): cognidream;
}
...
export interface IHoverOptions {
     ...
     */
    linkHandler?(url: string): cognidream;
...
export interface IHoverAction {
     ...
     */
    run(target: HTMLElement): cognidream;
}
...
export interface IManagedHover extends IDisposable {
     ...
     */
    update(tooltip: IManagedHoverContent, options?: IManagedHoverOptions): cognidream;
}
