...
export class Radio extends Widget {
    ...
    private readonly buttons = this._register(new DisposableMap<Button, { item: IRadioOptionItem; dispose(): cognidream }>());
    ...
    setItems(items: ReadonlyArray<IRadioOptionItem>): cognidream {
    ...
    setActiveItem(index: number): cognidream {
    ...
    private updateButtons(): cognidream {
        let isActive = false;
