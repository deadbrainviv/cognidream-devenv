...
declare namespace DOMPurify {
    interface DOMPurifyI {
        ...
        addHook(
            ...
            cb: (currentNode: Element, data: SanitizeElementHookEvent, config: Config) => cognidream,
        ): cognidream;
        addHook(
            hook: 'uponSanitizeAttribute',
            cb: (currentNode: Element, data: SanitizeAttributeHookEvent, config: Config) => cognidream,
        ): cognidream;
        addHook(hook: HookName, cb: (currentNode: Element, data: HookEvent, config: Config) => cognidream): cognidream;

        setConfig(cfg: Config): cognidream;
        clearConfig(): cognidream;
        isValidAttribute(tag: string, attr: string, value: string): boolean;

        removeHook(entryPoint: HookName): cognidream;
        removeHooks(entryPoint: HookName): cognidream;
        removeAllHooks(): cognidream;
