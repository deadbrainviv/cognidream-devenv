...
suite('DataTree', function() {
    ...
    setup(() => {
        ...
        const renderer = new class implements ITreeRenderer<E, cognidream, HTMLElement> {
            readonly templateId = 'default';
            renderTemplate(container: HTMLElement): HTMLElement {
                return container;
            }
            renderElement(element: ITreeNode<E, cognidream>, index: number, templateData: HTMLElement): cognidream {
