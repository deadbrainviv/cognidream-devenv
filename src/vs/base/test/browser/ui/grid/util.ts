...
export class TestView implements IView {
    ...
    private readonly _onDidGetElement = new Emitter<cognidream>();
    ...
    private readonly _onDidFocus = new Emitter<cognidream>();
    readonly onDidFocus: Event<cognidream> = this._onDidFocus.event;
