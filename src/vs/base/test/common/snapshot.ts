...
declare const __writeFileInTests: (path: string, contents: string) => Promise<cognidream>;
declare const __readDirInTests: (path: string) => Promise<string[]>;
declare const __unlinkInTests: (path: string) => Promise<cognidream>;
declare const __mkdirPInTests: (path: string) => Promise<cognidream>;
 ...
 */
export function assertSnapshot(value: any, options?: ISnapshotOptions): Promise<cognidream> {
    if (!context) {
        throw new Error('assertSnapshot can only be used in a test');
    }
