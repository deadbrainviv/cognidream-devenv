...
suite('observables', () => {
    ...
    suite('from event', () => {
        ...
        function init(): { log: Log; setValue: (value: number | undefined) => cognidream; observable: IObservable<number | undefined> } {
            const log = new Log();

            let value: number | undefined = 0;
            const eventEmitter = new Emitter<cognidream>();
    ...
    test('acognidream recomputation of deriveds that are no longer read', () => {
        const log = new Log();
...
export class LoggingObservableValue<T, TChange = cognidream>
...
class Log {
    ...
    public log(message: string): cognidream {
