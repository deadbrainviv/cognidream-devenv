...
export type ValueCallback<T> = (value: T | Promise<T>) => cognidream;
export type ErrorCallback = (error?: any) => cognidream;
export type ProgressCallback<T> = (progress: T) => cognidream;
...
export function createQueuedSender(childProcess: cp.ChildProcess): IQueuedSender {
    ...
    const send = function(msg: any): cognidream {
        if (useQueue) {
