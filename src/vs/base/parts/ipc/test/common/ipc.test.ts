...
class QueueProtocol implements IMessagePassingProtocol {
    ...
    protected receive(buffer: VSBuffer): cognidream {
        if (this.buffering) {
...
class TestIPCClient extends IPCClient<string> {
    ...
    private readonly _onDidDisconnect = new Emitter<cognidream>();
...
interface ITestService {
    ...
    error(message: string): Promise<cognidream>;
    neverComplete(): Promise<cognidream>;
    neverCompleteCT(cancellationToken: CancellationToken): Promise<cognidream>;
