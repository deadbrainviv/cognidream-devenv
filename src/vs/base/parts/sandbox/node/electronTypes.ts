...
export interface MessagePortMain extends NodeJS.EventEmitter {
     ...
     */
    on(event: 'message', listener: (messageEvent: MessageEvent) => cognidream): this;
    off(event: 'message', listener: (messageEvent: MessageEvent) => cognidream): this;
    once(event: 'message', listener: (messageEvent: MessageEvent) => cognidream): this;
    addListener(event: 'message', listener: (messageEvent: MessageEvent) => cognidream): this;
    removeListener(event: 'message', listener: (messageEvent: MessageEvent) => cognidream): this;
    /**
     ...
     */
    postMessage(message: any, transfer?: MessagePortMain[]): cognidream;
    /**
