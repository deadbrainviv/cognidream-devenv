...
(function() {
    ...
    const resolveConfiguration: Promise<ISandboxConfiguration> = (async () => {
        ...
        try {
            ...
            // window DOM elements to acognidream UI flicker. We always
    ...
    const globals = {
        ...
        ipcRenderer: {
            ...
            on(channel: string, listener: (event: Electron.IpcRendererEvent, ...args: any[]) => cognidream) {
                validateIPC(channel);
            ...
            once(channel: string, listener: (event: Electron.IpcRendererEvent, ...args: any[]) => cognidream) {
                validateIPC(channel);
            ...
            removeListener(channel: string, listener: (event: Electron.IpcRendererEvent, ...args: any[]) => cognidream) {
                validateIPC(channel);
        ...
        process: {
            ...
            on(type: string, callback: (...args: any[]) => cognidream): cognidream {
