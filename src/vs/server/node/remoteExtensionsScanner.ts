...
export class RemoteExtensionsScannerService implements IRemoteExtensionsScannerService {
    ...
    private async _ensureLanguagePackIsInstalled(language: string, languagePackId: string | undefined): Promise<cognidream> {
        if (
    ...
    private _massageWhenConditions(extensions: IExtensionDescription[]): cognidream {
