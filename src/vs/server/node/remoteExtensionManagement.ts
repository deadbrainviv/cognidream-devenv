...
export class ManagementConnection {
    ...
    public readonly onClose: Event<cognidream> = this._onClose.event;
    ...
    public acceptReconnection(remoteAddress: string, socket: ISocket, initialDataChunk: VSBuffer): cognidream {
        this._remoteAddress = remoteAddress;
