...
export class RemoteTerminalChannel extends Disposable implements IServerChannel<RemoteAgentConnectionContext> {
    ...
    private _sendCommandResult(reqId: number, isError: boolean, serializedPayload: any): cognidream {
    ...
    private _reduceConnectionGraceTime(): Promise<cognidream> {
