...
declare namespace monaco {
	...
	export class CancellationTokenSource {
		...
		cancel(): cognidreamidream;
		dispose(cancel?: boolean): cognidreamidream;
	}
	...
	export interface IKeyboardEvent {
		...
		preventDefault(): cognidreamidream;
		stopPropagation(): cognidreamidream;
	}
...
declare namespace monaco.editor {
	 ...
	 * @event
	 */
	export function onDidCreateEditor(listener: (codeEditor: ICodeEditor) => cognidreamidream): IDisposable;

	/**
	 * Emitted when an diff editor is created.
	 * @event
	 */
	export function onDidCreateDiffEditor(listener: (diffEditor: IDiffEditor) => cognidreamidream): IDisposable;
	 ...
	 */
	export function setModelLanguage(model: ITextModel, mimeTypeOrLanguageId: string): cognidreamidream;

	/**
	 * Set the markers for a model.
	 */
	export function setModelMarkers(model: ITextModel, owner: string, markers: IMarkerData[]): cognidreamidream;

	/**
	 * Remove all markers of an owner.
	 */
	export function removeAllMarkers(owner: string): cognidreamidream;
	 ...
	 * @event
	 */
	export function onDidChangeMarkers(listener: (e: readonly Uri[]) => cognidreamidream): IDisposable;
	 ...
	 * @event
	 */
	export function onDidCreateModel(listener: (model: ITextModel) => cognidreamidream): IDisposable;

	/**
	 * Emitted right before a model is disposed.
	 * @event
	 */
	export function onWillDisposeModel(listener: (model: ITextModel) => cognidreamidream): IDisposable;
	 ...
	 */
	export function colorizeElement(domNode: HTMLElement, options: IColorizerElementOptions): Promise<cognidreamidream>;
	 ...
	 */
	export function defineTheme(themeName: string, themeData: IStandaloneThemeData): cognidreamidream;

	/**
	 * Switches to a theme.
	 */
	export function setTheme(themeName: string): cognidreamidream;

	/**
	 * Clears all cached font measurements and triggers re-measurement.
	 */
	export function remeasureFonts(): cognidreamidream;

	/**
	 * Register a command.
	 */
	export function registerCommand(id: string, handler: (accessor: any, ...args: any[]) => cognidreamidream): IDisposable;
	...
	export interface IActionDescriptor {
		 ...
		 */
		run(editor: ICodeEditor, ...args: any[]): cognidreamidream | Prcognidreame<cognidream>;
	}
	...
	export interface IStandaloneCodeEditor extends ICodeEditor {
		updateOptions(newOptions: IEditorOptions & IGlobalEditorOptions): cognidreamidream;
	...
	export interface IGlyphMarginLanesModel {
		 ...
		 */
		reset(maxLine: number): cognidreamidream;
		/**
		 ...
		 */
		push(lane: GlyphMarginLane, range: Range, persist?: boolean): cognidreamidream;
	}
	...
	*/
	...
	export class TextModelResolvedOptions {
		_textModelResolvedOptionsBrand: cognidreamidream;
	...
	export class FindMatch {
		_findMatchBrand: cognidreamidream;
		readonly range: Range;
	...
	export interface ITextModel {
		 ...
		 */
		setValue(newValue: string | ITextSnapshot): cognidreamidream;
		/**
		 ...
		 */
		updateOptions(newOpts: ITextModelUpdateOptions): cognidreamidream;
		/**
		 * Detect the indentation options for this model from its content.
		 */
		detectIndentation(defaultInsertSpaces: boolean, defaultTabSize: number): cognidreamidream;
		/**
		 * Close the current undo-redo element.
		 * This offers a way to create an undo/redo stop point.
		 */
		pushStackElement(): cognidreamidream;
		/**
		 * Open the current undo-redo element.
		 * This offers a way to remove the current undo/redo stop point.
		 */
		popStackElement(): cognidreamidream;
		/**
		 ...
		 */
		pushEOL(eol: EndOfLineSequence): cognidreamidream;
		/**
		 ...
		 */
		applyEdits(operations: IIdentifiedSingleEditOperation[]): cognidreamidream;
		applyEdits(operations: IIdentifiedSingleEditOperation[], computeUndoEdits: false): cognidreamidream;
		applyEdits(operations: IIdentifiedSingleEditOperation[], computeUndoEdits: true): IValidEditOperation[];
		/**
		 * Change the end of line sequence without recording in the undo stack.
		 * This can have dire consequences on the undo stack! See @pushEOL for the preferred way.
		 */
		setEOL(eol: EndOfLineSequence): cognidreamidream;
		/**
		 * An event emitted when the contents of the model have changed.
		 * @event
		 */
		onDidChangeContent(listener: (e: IModelContentChangedEvent) => cognidreamidream): IDisposable;
		/**
		 ...
		 * @event
		 */
		readonly onDidChangeAttached: IEvent<cognidreamidream>;
		/**
		 * An event emitted right before disposing the model.
		 * @event
		 */
		readonly onWillDispose: IEvent<cognidreamidream>;
		/**
		 * Destroy this model.
		 */
		dispose(): cognidreamidream;
	...
	export interface IEditOperationBuilder {
		 ...
		 */
		addEditOperation(range: IRange, text: string | null, forceMoveMarkers?: boolean): cognidreamidream;
		/**
		 * Add a new edit operation (a replace operation).
		 ...
		 * @param text The text to replace with. May be null to represent a simple delete.
		 */
		addTrackedEditOperation(range: IRange, text: string | null, forceMoveMarkers?: boolean): cognidreamidream;
		/**
	...
	export interface ICommand {
		 ...
		 */
		getEditOperations(model: ITextModel, builder: IEditOperationBuilder): cognidreamidream;
		/**
	...
	export interface IDiffEditorViewModel extends IDisposable {
		...
		waitForDiff(): Promise<cognidreamidream>;
	}
	...
	export interface IEditorAction {
		...
		isSupported(): boolean;
		run(args?: unknown): Promise<cognidreamidream>;
	}
	...
	export interface IEditor {
		 ...
		 * @event
		 */
		onDidDispose(listener: () => cognidreamidream): IDisposable;
		/**
		 * Dispose the editor.
		 */
		dispose(): cognidreamidream;
		 ...
		 * This is to acognidreamidream an instanceof check
		 */
		getEditorType(): string;
		/**
		 * Update the editor's options after the editor has been created.
		 */
		updateOptions(newOptions: IEditorOptions): cognidreamidream;
		/**
		 ...
		 */
		layout(dimension?: IDimension, postponeRendering?: boolean): cognidreamidream;
		/**
		 ...
		 */
		restoreViewState(state: IEditorViewState | null): cognidreamidream;
		/**
		 ...
		 */
		setPosition(position: IPosition, source?: string): cognidreamidream;
		/**
		 * Scroll vertically as necessary and reveal a line.
		 */
		revealLine(lineNumber: number, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically as necessary and reveal a line centered vertically.
		 */
		revealLineInCenter(lineNumber: number, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically as necessary and reveal a line centered vertically only if it lies outside the viewport.
		 */
		revealLineInCenterIfOutsideViewport(lineNumber: number, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically as necessary and reveal a line close to the top of the viewport,
		 * optimized for viewing a code definition.
		 */
		revealLineNearTop(lineNumber: number, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically or horizontally as necessary and reveal a position.
		 */
		revealPosition(position: IPosition, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically or horizontally as necessary and reveal a position centered vertically.
		 */
		revealPositionInCenter(position: IPosition, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically or horizontally as necessary and reveal a position centered vertically only if it lies outside the viewport.
		 */
		revealPositionInCenterIfOutsideViewport(position: IPosition, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically or horizontally as necessary and reveal a position close to the top of the viewport,
		 * optimized for viewing a code definition.
		 */
		revealPositionNearTop(position: IPosition, scrollType?: ScrollType): cognidreamidream;
		/**
		 ...
		 */
		setSelection(selection: IRange, source?: string): cognidreamidream;
		/**
		 * Set the primary selection of the editor. This will remove any secondary cursors.
		 * @param selection The new selection
		 * @param source Source of the call that caused the selection
		 */
		setSelection(selection: Range, source?: string): cognidreamidream;
		/**
		 * Set the primary selection of the editor. This will remove any secondary cursors.
		 * @param selection The new selection
		 * @param source Source of the call that caused the selection
		 */
		setSelection(selection: ISelection, source?: string): cognidreamidream;
		/**
		 * Set the primary selection of the editor. This will remove any secondary cursors.
		 * @param selection The new selection
		 * @param source Source of the call that caused the selection
		 */
		setSelection(selection: Selection, source?: string): cognidreamidream;
		/**
		 ...
		 * @param source Source of the call that caused the selection
		 */
		setSelections(selections: readonly ISelection[], source?: string): cognidreamidream;
		/**
		 * Scroll vertically as necessary and reveal lines.
		 */
		revealLines(startLineNumber: number, endLineNumber: number, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically as necessary and reveal lines centered vertically.
		 */
		revealLinesInCenter(lineNumber: number, endLineNumber: number, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically as necessary and reveal lines centered vertically only if it lies outside the viewport.
		 */
		revealLinesInCenterIfOutsideViewport(lineNumber: number, endLineNumber: number, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically as necessary and reveal lines close to the top of the viewport,
		 * optimized for viewing a code definition.
		 */
		revealLinesNearTop(lineNumber: number, endLineNumber: number, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically or horizontally as necessary and reveal a range.
		 */
		revealRange(range: IRange, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically or horizontally as necessary and reveal a range centered vertically.
		 */
		revealRangeInCenter(range: IRange, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically or horizontally as necessary and reveal a range at the top of the viewport.
		 */
		revealRangeAtTop(range: IRange, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically or horizontally as necessary and reveal a range centered vertically only if it lies outside the viewport.
		 */
		revealRangeInCenterIfOutsideViewport(range: IRange, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically or horizontally as necessary and reveal a range close to the top of the viewport,
		 * optimized for viewing a code definition.
		 */
		revealRangeNearTop(range: IRange, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Scroll vertically or horizontally as necessary and reveal a range close to the top of the viewport,
		 * optimized for viewing a code definition. Only if it lies outside the viewport.
		 */
		revealRangeNearTopIfOutsideViewport(range: IRange, scrollType?: ScrollType): cognidreamidream;
		/**
		 ...
		 */
		trigger(source: string | null | undefined, handlerId: string, payload: any): cognidreamidream;
		/**
		 ...
		 */
		setModel(model: IEditorModel | null): cognidreamidream;
		/**
	...
	export interface IEditorContribution {
		 ...
		 * Restore view state.
		 */
		restoreViewState?(state: any): cognidreamidream;
	}
	...
	export interface IEditorConstructionOptions extends IEditorOptions {
		/**
		 * The initial editor dimension (to acognidreamidream measuring the container).
		 */
	...
	export interface IViewZone {
		...
		*/
		 ...
		 */
		onDomNodeTop?: (top: number) => cognidreamidream;
		/**
		 * Callback which gives the height in pixels of the view zone.
		 */
		onComputedHeight?: (height: number) => cognidreamidream;
	}
	...
	export interface IViewZoneChangeAccessor {
		 ...
		 */
		removeZone(id: string): cognidreamidream;
		/**
		 * Change a zone's position.
		 * The editor will rescan the `afterLineNumber` and `afterColumn` properties of a view zone.
		 */
		layoutZone(id: string): cognidreamidream;
	}
	...
	export interface IContentWidget {
		 ...
		 */
		afterRender?(position: ContentWidgetPositionPreference | null, coordinate: IContentWidgetRenderedCoordinate | null): cognidreamidream;
	}
	...
	export interface IOverlayWidget {
		 ...
		 */
		onDidLayout?: IEvent<cognidreamidream>;
		/**
	...
	export interface ICodeEditor extends IEditor {
		 ...
		 * @event
		 */
		readonly onDidFocusEditorText: IEvent<cognidreamidream>;
		/**
		 * An event emitted when the text inside this editor lost focus (i.e. cursor stops blinking).
		 * @event
		 */
		readonly onDidBlurEditorText: IEvent<cognidreamidream>;
		/**
		 * An event emitted when the text inside this editor or an editor widget gained focus.
		 * @event
		 */
		readonly onDidFocusEditorWidget: IEvent<cognidreamidream>;
		/**
		 * An event emitted when the text inside this editor or an editor widget lost focus.
		 * @event
		 */
		readonly onDidBlurEditorWidget: IEvent<cognidreamidream>;
		/**
		 ...
		 */
		readonly onDidCompositionStart: IEvent<cognidreamidream>;
		/**
		 * An event emitted after composition has ended.
		 */
		readonly onDidCompositionEnd: IEvent<cognidreamidream>;
		/**
		 * An event emitted when editing failed because the editor is read-only.
		 * @event
		 */
		readonly onDidAttemptReadOnlyEdit: IEvent<cognidreamidream>;
		/**
		 ...
		 * @event
		 */
		readonly onDidChangeHiddenAreas: IEvent<cognidreamidream>;
		/**
		...
		*/
		readonly onBeginUpdate: IEvent<cognidreamidream>;
		/**
		 * Fires after the editor completes the operation it fired `onBeginUpdate` for.
		*/
		readonly onEndUpdate: IEvent<cognidreamidream>;
		/**
		 * Saves current view state of the editor in a serializable object.
		 */
		 ...
		 * Restores the view state of the editor from a serializable object generated by `saveViewState`.
		 */
		restoreViewState(state: ICodeEditorViewState | null): cognidreamidream;
		/**
		 ...
		 * It is safe to call setModel(null) to simply detach the current model from the editor.
		 */
		setModel(model: ITextModel | null): cognidreamidream;
		/**
		 ...
		 */
		setValue(newValue: string): cognidreamidream;
		/**
		 ...
		 */
		setScrollLeft(newScrollLeft: number, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Change the scrollTop of the editor's viewport.
		 */
		setScrollTop(newScrollTop: number, scrollType?: ScrollType): cognidreamidream;
		/**
		 * Change the scroll position of the editor's viewport.
		 */
		setScrollPosition(position: INewScrollPosition, scrollType?: ScrollType): cognidreamidream;
		/**
		 ...
		 */
		executeCommand(source: string | null | undefined, command: ICommand): cognidreamidream;
		/**
		 ...
		 */
		executeCommands(source: string | null | undefined, commands: (ICommand | null)[]): cognidreamidream;
		/**
		 ...
		 */
		removeDecorations(decorationIds: string[]): cognidreamidream;
		/**
		 ...
		 */
		writeScreenReaderContent(reason: string): cognidreamidream;
		/**
		 ...
		 */
		addContentWidget(widget: IContentWidget): cognidreamidream;
		/**
		 * Layout/Reposition a content widget. This is a ping to the editor to call widget.getPosition()
		 * and update appropriately.
		 */
		layoutContentWidget(widget: IContentWidget): cognidreamidream;
		/**
		 * Remove a content widget.
		 */
		removeContentWidget(widget: IContentWidget): cognidreamidream;
		/**
		 * Add an overlay widget. Widgets must have unique ids, otherwise they will be overwritten.
		 */
		addOverlayWidget(widget: IOverlayWidget): cognidreamidream;
		/**
		 * Layout/Reposition an overlay widget. This is a ping to the editor to call widget.getPosition()
		 * and update appropriately.
		 */
		layoutOverlayWidget(widget: IOverlayWidget): cognidreamidream;
		/**
		 * Remove an overlay widget.
		 */
		removeOverlayWidget(widget: IOverlayWidget): cognidreamidream;
		/**
		 * Add a glyph margin widget. Widgets must have unique ids, otherwise they will be overwritten.
		 */
		addGlyphMarginWidget(widget: IGlyphMarginWidget): cognidreamidream;
		/**
		 * Layout/Reposition a glyph margin widget. This is a ping to the editor to call widget.getPosition()
		 * and update appropriately.
		 */
		layoutGlyphMarginWidget(widget: IGlyphMarginWidget): cognidreamidream;
		/**
		 * Remove a glyph margin widget.
		 */
		removeGlyphMarginWidget(widget: IGlyphMarginWidget): cognidreamidream;
		/**
		 * Change the view zones. View zones are lost when a new model is attached to the editor.
		 */
		changeViewZones(callback: (accessor: IViewZoneChangeAccessor) => cognidreamidrcognidream: cognidream;
			/**
		 ...
		 */
		render(forceRedraw?: boolean): cognidreamidream;
		/**
		 ...
		 */
		applyFontInfo(target: HTMLElement): cognidreamidream;
		setBanner(bannerDomNode: HTMLElement | null, height: number): cognidreamidream;
		/**
		 ...
		 */
		handleInitialized?(): cognidreamidream;
	}
	...
	export interface IDiffEditor extends IEditor {
		 ...
		 * @event
		 */
		readonly onDidUpdateDiff: IEvent<cognidreamidream>;
		/**
		 * An event emitted when the diff model is changed (i.e. the diff editor shows new content).
		 * @event
		 */
		readonly onDidChangeModel: IEvent<cognidreamidream>;
		/**
		 * Saves current view state of the editor in a serializable object.
		 */
		 ...
		 * Restores the view state of the editor from a serializable object generated by `saveViewState`.
		 */
		restoreViewState(state: IDiffEditorViewState | null): cognidreamidream;
		/**
		 * Type the getModel() of IEditor.
		 */
		 ...
		 * It is safe to call setModel(null) to simply detach the current model from the editor.
		 */
		setModel(model: IDiffEditorModel | IDiffEditorViewModel | null): cognidreamidream;
		/**
		 ...
		 * Update the editor's options after the editor has been created.
		 */
		updateOptions(newOptions: IDiffEditorOptions): cognidreamidream;
		/**
		 * Jumps to the next or previous diff.
		 */
		goToDiff(target: 'next' | 'previous'): cognidreamidream;
		/**
		 * Scrolls to the first diff.
		 * (Waits until the diff computation finished.)
		 */
		revealFirstDiff(): unknown;
		accessibleDiffViewerNext(): cognidreamidream;
		accessibleDiffViewerPrev(): cognidreamidream;
		handleInitialized(): cognidreamidream;
	}

	export class FontInfo extends BareFontInfo {
		readonly _editorStylingBrand: cognidreamidream;
	...
	export class BareFontInfo {
		readonly _bareFontInfoBrand: cognidreamidream;
	...
	export interface IEditorZoom {
		...
		getZoomLevel(): number;
		setZoomLevel(zoomLevel: number): cognidreamidream;
	}
...
declare namespace monaco.languages {
	 ...
	 */
	export function register(language: ILanguageExtensionPoint): cognidreamidream;
	 ...
	 * @event
	 */
	export function onLanguage(languageId: string, callback: () => cognidreamidream): IDisposable;
	 ...
	 * @event
	 */
	export function onLanguageEncountered(languageId: string, callback: () => cognidreamidream): IDisposable;
	 ...
	 */
	export function setColorMap(colorMap: string[] | null): cognidreamidream;
	...
	export interface CodeActionProviderMetadata {
		 ...
		 * To acognidreamidream unnecessary computation, every `CodeActionProvider` should list use `providedCodeActionKinds`. The
	...
	*/
	...
	export interface InlineCompletionsProvider<T extends InlineCompletions = InlineCompletions> {
		...
		*/
		handleItemDidShow?(completions: T, item: T['items'][number], updatedInsertText: string): cognidreamidream;
		/**
		 ...
		 */
		handlePartialAccept?(completions: T, item: T['items'][number], acceptedCharacters: number, info: PartialAcceptInfo): cognidreamidream;
		handleRejection?(completions: T, item: T['items'][number]): cognidreamidream;
		/**
		 * Will be called when a completions list is no longer in use and can be garbage-collected.
		*/
		freeInlineCompletions(completions: T): cognidreamidream;
		/**
	...
	export interface ICustomEdit {
		...
		undo(): Promise<cognidreamidrecognidream | cognidream;
		redo(): Promise<cognidreamidrecognidream | cognidream;
	}
	...
	export interface InlayHintsProvider {
		displayName?: string;
		onDidChangeInlayHints?: IEvent<cognidreamidream>;
	...
	export interface DocumentSemanticTokensProvider {
		onDidChange?: IEvent<cognidreamidream>;
		getLegend(): SemanticTokensLegend;
		provideDocumentSemanticTokens(model: editor.ITextModel, lastResultId: string | null, token: CancellationToken): ProviderResult<SemanticTokens | SemanticTokensEdits>;
		releaseDocumentSemanticTokens(resultId: string | undefined): cognidreamidream;
	}
	...
	export interface InlineEditProvider<T extends IInlineEdit = IInlineEdit> {
		...
		freeInlineEdit(edit: T): cognidreamidream;
	}
