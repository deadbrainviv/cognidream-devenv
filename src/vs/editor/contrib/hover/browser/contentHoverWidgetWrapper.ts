...
export class ContentHoverWidgetWrapper extends Disposable implements IHoverWidget {
	...
	private readonly _onContentsChanged = this._register(new Emitter<cognidream>());
	...
	private _startHoverOperationIfNecessary(anchor: HoverAnchor, mode: HoverStartMode, source: HoverStartSource, shouldFocus: boolean, insistOnKeepingHoverVisible: boolean): cognidream {
	...
	private _setCurrentResult(hoverResult: ContentHoverResult | null): cognidream {
	...
	private _withResult(hoverResult: ContentHoverResult): cognidream {
	...
	private _showHover(hoverResult: ContentHoverResult): cognidream {
	...
	private _onMouseLeave(e: MouseEvent): cognidream {
	...
	public startShowingAtRange(range: Range, mode: HoverStartMode, source: HoverStartSource, focus: boolean): cognidream {
	...
	public async updateHoverVerbosityLevel(action: HoverVerbosityAction, index: number, focus?: boolean): Promise<cognidream> {
