...
export class StickyScrollWidget extends Disposable implements IOverlayWidget {
	...
	setState(_state: StickyScrollWidgetState | undefined, foldingModel: FoldingModel | undefined, _rebuildFromLine?: number): cognidream {
	...
	private _updateWidgetWidth(): cognidream {
	...
	private async _renderRootNode(state: StickyScrollWidgetState | undefined, foldingModel: FoldingModel | undefined, rebuildFromLine: number): Promise<cognidream> {
	...
	private _setHeight(height: number): cognidream {
	...
	private _setFoldingHoverListeners(): cognidream {
