...
export class CodeActionController extends Disposable implements IEditorContribution {
	...
	private async showCodeActionsFromLightbulb(actions: CodeActionSet, at: IAnchor | IPosition): Promise<cognidream> {
	...
	public hideCodeActions(): cognidream {
	...
	async applyCodeAction(action: CodeActionItem, retrigger: boolean, preview: boolean, actionReason: ApplyCodeActionReason): Promise<cognidream> {
	...
	public hideLightBulbWidget(): cognidream {
		this._lightBulbWidget.rawValue?.hide();
		this._lightBulbWidget.rawValue?.gutterHide();
	}

	private async update(newState: CodeActionsState.State): Promise<cognidream> {
	...
	public async showCodeActionList(actions: CodeActionSet, at: IAnchor | IPosition, options: IActionShowOptions): Promise<cognidream> {
...
registerThemingParticipant((theme, collector) => {
	const addBackgroundColorRule = (selector: string, color: Color | undefined): cognidream => {
		if (color) {
