...
class CodeActionOracle extends Disposable {
	...
	constructor(
		...
		private readonly _signalChange: (triggered: TriggeredCodeAction | undefined) => cognidream,
	...
	public trigger(trigger: CodeActionTrigger): cognidream {
		const selection = this._getRangeOfSelectionUnlessWhitespaceEnclosed(trigger);
		this._signalChange(selection ? { trigger, selection } : undefined);
	}

	private _onMarkerChanges(resources: readonly URI[]): cognidream {
