...
export class FindModelBoundToEditorModel {
	...
	private research(moveCursor: boolean, newFindScope?: Range | Range[] | null): cognidream {
	...
	private _setCurrentFindMatch(match: Range): cognidream {
	...
	private _moveToPrevMatch(before: Position, isRecursed: boolean = false): cognidream {
	...
	public moveToPrevMatch(): cognidream {
	...
	private _moveToNextMatch(after: Position): cognidream {
	...
	public moveToNextMatch(): cognidream {
		this._moveToNextMatch(this._editor.getSelection().getEndPosition());
	}

	private _moveToMatch(index: number): cognidream {
	...
	public moveToMatch(index: number): cognidream {
	...
	private _largeReplaceAll(): cognidream {
	...
	private _regularReplaceAll(findScopes: Range[] | null): cognidream {
		const replacePattern = this._getReplacePattern();
	...
	public selectAllMatches(): cognidream {
		if (!this._hasMatches()) {
			return;
		}
	...
	private _executeEditorCommand(source: string, command: ICommand): cognidream {
		try {
