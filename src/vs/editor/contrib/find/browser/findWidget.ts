...
export class FindWidget extends Widget implements IOverlayWidget, IVerticalSashLayoutProvider {
	...
	constructor(
		...
		this._register(this._codeEditor.onDidScrollChange((e) => {
			...
			// for other scroll changes, layout the viewzone in next tick to acognidream ruining current rendering.
			setTimeout(() => {
				this._layoutViewZone();
			}, 0);
		}));
	...
	private _updateMatchesCount(): cognidream {
	 ...
	 */
	private _updateToggleSelectionFindButton(): cognidream {
	...
	private _updateButtons(): cognidream {
	...
	private _hide(focusTheEditor: boolean): cognidream {
		this._revealTimeouts.forEach(e => {
			clearTimeout(e);
		});
	...
	public focusFindInput(): cognidream {
		this._findInput.select();
		// Edge browser requires focus() in addition to select()
		this._findInput.focus();
	}

	public focusReplaceInput(): cognidream {
		this._replaceInput.select();
		// Edge browser requires focus() in addition to select()
		this._replaceInput.focus();
	}

	public highlightFindOptions(): cognidream {
		this._findInput.highlightFindOptions();
	}

	private _updateSearchScope(): cognidream {
	...
	private _onFindInputMouseDown(e: IMouseEvent): cognidream {
	...
	private _onFindInputKeyDown(e: IKeyboardEvent): cognidream {
	...
	private _onReplaceInputKeyDown(e: IKeyboardEvent): cognidream {
		if (e.equals(ctrlKeyMod | KeyCode.Enter)) {
			if (this._keybindingService.dispatchEvent(e, e.target)) {
				e.preventDefault();
				return;
	...
	private _buildDomNode(): cognidream {
	...
	private updateAccessibilitySupport(): cognidream {
...
export interface ISimpleButtonOpts {
	...
	readonly onTrigger: () => cognidream;
	readonly onKeyDown?: (e: IKeyboardEvent) => cognidream;
}
...
export class SimpleButton extends Widget {
	...
	public setExpanded(expanded: boolean): cognidream {
