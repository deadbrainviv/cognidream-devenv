...
export const CutAction = supportsCut ? registerCommand(new MultiCommand({
	...
	kbOpts: (
		...
		// since browsers do that for us and it acognidreams security prompts
		platform.isNative ? {
...
function registerExecCommandImpl(target: MultiCommand | undefined, browserCommand: 'cut' | 'copy'): cognidream {
	if (!target) {
		return;
	}
