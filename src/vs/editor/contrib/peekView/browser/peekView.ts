...
export interface IPeekViewService {
	...
	addExclusiveWidget(editor: ICodeEditor, widget: PeekViewWidget): cognidream;
}
...
export abstract class PeekViewWidget extends ZoneWidget {
	...
	override style(styles: IPeekViewStyles): cognidream {
	...
	protected override _applyStyles(): cognidream {
		super._applyStyles();
		const options = <IPeekViewOptions>this.options;
	...
	protected _fillContainer(container: HTMLElement): cognidream {
	...
	protected _fillHead(container: HTMLElement, noCloseAction?: boolean): cognidream {
	...
	protected _fillTitleIcon(container: HTMLElement): cognidream {
	}
	...
	protected _onTitleClick(event: IMouseEvent): cognidream {
		// implement me if supportOnTitleClick option is set
	}

	setTitle(primaryHeading: string, secondaryHeading?: string): cognidream {
	...
	setMetaTitle(value: string): cognidream {
	...
	protected abstract _fillBody(container: HTMLElement): cognidream;

	protected override _doLayout(heightInPixel: number, widthInPixel: number): cognidream {
	...
	protected _doLayoutHead(heightInPixel: number, widthInPixel: number): cognidream {
	...
	protected _doLayoutBody(heightInPixel: number, widthInPixel: number): cognidream {
