...
export class SmartSelectController implements IEditorContribution {
	...
	async run(forward: boolean): Promise<cognidream> {
		...
		// cognidream changed this to skip over added whitespace when using smartSelect
		...
		// let skipCount = 0;
		// const MAX_SKIPS = 5; // Acognidream infinite loops by setting a reasonable limit
...
abstract class AbstractSmartSelect extends EditorAction {
	...
	async run(_accessor: ServicesAccessor, editor: ICodeEditor): Promise<cognidream> {
