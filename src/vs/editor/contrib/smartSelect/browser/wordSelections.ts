...
export class WordSelectionRangeProvider implements SelectionRangeProvider {
	...
	private _addInWordRanges(bucket: SelectionRange[], model: ITextModel, pos: Position): cognidream {
	...
	private _addWordRanges(bucket: SelectionRange[], model: ITextModel, pos: Position): cognidream {
	...
	private _addWhitespaceLine(bucket: SelectionRange[], model: ITextModel, pos: Position): cognidream {
