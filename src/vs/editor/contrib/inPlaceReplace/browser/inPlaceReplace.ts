...
class InPlaceReplaceController implements IEditorContribution {
	...
	private decorationRemover?: CancelablePromise<cognidream>;
	...
	public run(source: string, up: boolean): Promise<cognidream> | undefined {
...
class InPlaceReplaceUp extends EditorAction {
	...
	public run(accessor: ServicesAccessor, editor: ICodeEditor): Promise<cognidream> | undefined {
