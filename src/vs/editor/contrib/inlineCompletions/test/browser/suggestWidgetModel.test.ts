...
async function withAsyncTestCodeEditorAndInlineCompletionsModel(
	...
	callback: (args: { editor: ITestCodeEditor; editorViewModel: ViewModel; model: InlineCompletionsModel; context: GhostTextContext }) => Promise<cognidream>
): Promise<cognidream> {
