...
export class ObservableAnimatedValue {
	...
	setAnimation(value: AnimatedValue, tx: ITransaction | undefined): cognidream {
		this._value.set(value, tx);
	}

	changeAnimation(fn: (prev: AnimatedValue) => AnimatedValue, tx: ITransaction | undefined): cognidream {
...
class Scheduler {
	...
	public invalidateOnNextAnimationFrame(reader: IReader | undefined): cognidream {
