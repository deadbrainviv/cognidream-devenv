...
export class InlineCompletionsSource extends Disposable {
	...
	public clear(tx: ITransaction): cognidream {
		this._updateOperation.clear();
		this.inlineCompletions.set(undefined, tx);
		this.suggestWidgetInlineCompletions.set(undefined, tx);
	}

	public clearSuggestWidgetInlineCompletions(tx: ITransaction): cognidream {
	...
	public cancelUpdate(): cognidream {
		this._updateOperation.clear();
	}
}

function wait(ms: number, cancellationToken?: CancellationToken): Promise<cognidream> {
...
export class UpToDateInlineCompletions implements IDisposable {
	...
	public prepend(inlineCompletion: InlineCompletionItem, range: Range, addRefToSource: boolean): cognidream {
		if (addRefToSource) {
