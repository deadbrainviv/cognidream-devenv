...
export class OneSnippet {
	...
	initialize(textChange: TextChange): cognidream {
	...
	private _initDecorations(): cognidream {
	...
	merge(others: OneSnippet[]): cognidream {
...
export class SnippetSession {
	...
	merge(template: string, options: ISnippetSessionInsertOptions = _defaultOptions): cognidream {
		if (!this._editor.hasModel()) {
			return;
		}
