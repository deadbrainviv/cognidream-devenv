...
export abstract class Marker {
	...
	replace(child: Marker, others: Marker[]): cognidream {
		const { parent } = child;
...
function walk(marker: Marker[], visitor: (marker: Marker) => boolean): cognidream {
	const stack = [...marker];
...
export class TextmateSnippet extends Marker {
	...
	override replace(child: Marker, others: Marker[]): cognidream {
		this._placeholders = undefined;
	...
	walk(visitor: (marker: Marker) => boolean): cognidream {
