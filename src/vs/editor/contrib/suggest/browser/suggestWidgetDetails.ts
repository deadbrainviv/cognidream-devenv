...
export class SuggestDetailsWidget {
    ...
    readonly onDidClose: Event<cognidream> = this._onDidClose.event;
    ...
    private _configureFont(): cognidream {
    ...
    renderItem(item: CompletionItem, explainMode: boolean): cognidream {
    ...
    layout(width: number, height: number): cognidream {
    ...
    scrollDown(much = 8): cognidream {
        this._body.scrollTop += much;
    }

    scrollUp(much = 8): cognidream {
        this._body.scrollTop -= much;
    }

    scrollTop(): cognidream {
        this._body.scrollTop = 0;
    }

    scrollBottom(): cognidream {
...
export class SuggestDetailsOverlay implements IOverlayWidget {
    ...
    hide(sessionEnded: boolean = false): cognidream {
    ...
    private _applyTopLeft(topLeft: TopLeftPosition): cognidream {
