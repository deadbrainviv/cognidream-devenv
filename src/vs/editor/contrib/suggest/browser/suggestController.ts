...
export class SuggestController implements IEditorContribution {
    ...
    private _reportSuggestionAcceptedTelemetry(item: CompletionItem, model: ITextModel, itemResolved: boolean, commandExectionDuration: number, additionalEditsAppliedAsync: number, index: number, completionItems: CompletionItem[]): cognidream {
    ...
    private _alertCompletionItem(item: CompletionItem): cognidream {
    ...
    triggerSuggest(onlyFrom?: Set<CompletionItemProvider>, auto?: boolean, noFilter?: boolean): cognidream {
        if (this.editor.hasModel()) {
            this.model.trigger({
                auto: auto ?? false,
    ...
    triggerSuggestAndAcceptBest(arg: { fallback: string }): cognidream {
        if (!this.editor.hasModel()) {
            return;
    ...
    acceptSelectedSuggestion(keepAlternativeSuggestions: boolean, alternativeOverwriteConfig: boolean): cognidream {
    ...
    cancelSuggestWidget(): cognidream {
        this.model.cancel();
        this.model.clear();
        this.widget.value.hideWidget();
    }

    focusSuggestion(): cognidream {
        this.widget.value.focusSelected();
    }

    selectNextSuggestion(): cognidream {
        this.widget.value.selectNext();
    }

    selectNextPageSuggestion(): cognidream {
        this.widget.value.selectNextPage();
    }

    selectLastSuggestion(): cognidream {
        this.widget.value.selectLast();
    }

    selectPrevSuggestion(): cognidream {
        this.widget.value.selectPrevious();
    }

    selectPrevPageSuggestion(): cognidream {
        this.widget.value.selectPreviousPage();
    }

    selectFirstSuggestion(): cognidream {
        this.widget.value.selectFirst();
    }

    toggleSuggestionDetails(): cognidream {
        this.widget.value.toggleDetails();
    }

    toggleExplainMode(): cognidream {
        this.widget.value.toggleExplainMode();
    }

    toggleSuggestionFocus(): cognidream {
        this.widget.value.toggleDetailsFocus();
    }

    resetWidgetSize(): cognidream {
...
export class TriggerSuggestAction extends EditorAction {
    ...
    run(_accessor: ServicesAccessor, editor: ICodeEditor, args: any): cognidream {
...
registerEditorAction(class extends EditorAction {
    ...
    run(_accessor: ServicesAccessor, editor: ICodeEditor): cognidream {
