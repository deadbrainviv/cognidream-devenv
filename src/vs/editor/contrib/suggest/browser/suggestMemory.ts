...
export abstract class Memory {
	...
	abstract memorize(model: ITextModel, pos: IPosition, item: CompletionItem): cognidream;

	abstract toJSON(): object | undefined;

	abstract fromJSON(data: object): cognidream;
}
...
export class NoMemory extends Memory {
	...
	memorize(model: ITextModel, pos: IPosition, item: CompletionItem): cognidream {
		// no-op
	}
...
export class LRUMemory extends Memory {
	...
	fromJSON(data: [string, MemItem][]): cognidream {
		this._cache.clear();
		const seq = 0;
