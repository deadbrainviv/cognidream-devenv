...
export class SuggestModel implements IDisposable {
    ...
    private _updateTriggerCharacters(): cognidream {
    ...
    cancel(retrigger: boolean = false): cognidream {
    ...
    private _updateActiveSuggestSession(): cognidream {
        if (this._triggerState !== undefined) {
    ...
    private _onCursorChange(e: ICursorSelectionChangedEvent): cognidream {
    ...
    private _onCompositionEnd(): cognidream {
    ...
    private _doTriggerQuickSuggest(): cognidream {
    ...
    private _refilterCompletionItems(): cognidream {
    ...
    trigger(options: SuggestTriggerOptions): cognidream {
        if (!this._editor.hasModel()) {
            return;
        }
     ...
     */
    private _reportDurationsTelemetry(durations: CompletionDurations): cognidream {
    ...
    private _onNewContext(ctx: LineContext): cognidream {
