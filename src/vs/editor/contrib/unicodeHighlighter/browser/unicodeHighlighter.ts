...
export class UnicodeHighlighter extends Disposable implements IEditorContribution {
	...
	private readonly _updateState = (state: IUnicodeHighlightsResult | null): cognidream => {
	...
	private _updateHighlighter(): cognidream {
...
export class DisableHighlightingInCommentsAction extends EditorAction implements IDisableUnicodeHighlightAction {
	...
	public async run(accessor: ServicesAccessor | undefined, editor: ICodeEditor, args: any): Promise<cognidream> {
	...
	public async runAction(configurationService: IConfigurationService): Promise<cognidream> {
...
export class ShowExcludeOptions extends Action2 {
	...
	public async run(accessor: ServicesAccessor | undefined, args: any): Promise<cognidream> {
