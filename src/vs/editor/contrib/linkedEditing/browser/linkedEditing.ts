...
export class LinkedEditingContribution extends Disposable implements IEditorContribution {
	...
	private _syncRanges(token: number): cognidream {
	...
	public async updateRanges(force = false): Promise<cognidream> {
...
export class LinkedEditingAction extends EditorAction {
	...
	run(_accessor: ServicesAccessor, editor: ICodeEditor): Promise<cognidream> {
