...
class MessageWidget {
	...
	constructor(
		parent: HTMLElement,
		editor: ICodeEditor,
		onRelatedInformation: (related: IRelatedInformation) => cognidream,
	...
	update(marker: IMarker): cognidream {
...
export class MarkerNavigationWidget extends PeekViewWidget {
	...
	protected override _fillHead(container: HTMLElement): cognidream {
	...
	protected override _fillTitleIcon(container: HTMLElement): cognidream {
		this._icon = dom.append(container, dom.$(''));
	}

	protected _fillBody(container: HTMLElement): cognidream {
	...
	override show(): cognidream {
		throw new Error('call showAtMarker');
	}

	showAtMarker(marker: IMarker, markerIdx: number, markerCount: number): cognidream {
		// update:
		// * title
		// * message
	...
	updateMarker(marker: IMarker): cognidream {
		this._container.classList.remove('stale');
		this._message.update(marker);
	}
	...
	protected override _doLayoutBody(heightInPixel: number, widthInPixel: number): cognidream {
	...
	protected override _onWidth(widthInPixel: number): cognidream {
		this._message.layout(this._heightInPixel, widthInPixel);
	}

	protected override _relayout(): cognidream {
