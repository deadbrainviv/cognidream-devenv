...
class DecorationsManager implements IDisposable {
	...
	private _onModelChanged(): cognidream {
	...
	private _addDecorations(reference: FileReferences): cognidream {
	...
	private _onDecorationChanged(): cognidream {
...
class ReferencesDragAndDrop implements ITreeDragAndDrop<TreeElement> {
	...
	drop(): cognidream { }
	dispose(): cognidream { this.disposables.dispose(); }
}
...
export class ReferenceWidget extends peekView.PeekViewWidget {
	...
	focusOnReferenceTree(): cognidream {
		this._tree.domFocus();
	}

	focusOnPreviewEditor(): cognidream {
		this._preview.focus();
	}
	...
	protected override _onTitleClick(e: IMouseEvent): cognidream {
	...
	protected _fillBody(containerElement: HTMLElement): cognidream {
	...
	async revealReference(reference: OneReference): Promise<cognidream> {
	...
	private async _revealReference(reference: OneReference, revealParent: boolean): Promise<cognidream> {
