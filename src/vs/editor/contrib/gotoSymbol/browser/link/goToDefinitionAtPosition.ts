...
export class GotoDefinitionAtPositionEditorContribution implements IEditorContribution {
	...
	private startFindDefinitionFromMouse(mouseEvent: ClickLinkMouseEvent, withKey?: ClickLinkKeyboardEvent): cognidream {
	...
	private async startFindDefinition(position: Position): Promise<cognidream> {
	...
	private addDecoration(range: Range, hoverMessage: MarkdownString | undefined): cognidream {
	...
	private removeLinkDecorations(): cognidream {
