...
export class LinkDetector extends Disposable implements IEditorContribution {
	...
	private async computeLinksNow(): Promise<cognidream> {
	...
	private updateDecorations(links: Link[]): cognidream {
	...
	private _onEditorMouseMove(mouseEvent: ClickLinkMouseEvent, withKey: ClickLinkKeyboardEvent | null): cognidream {
		const useMetaKey = (this.editor.getOption(EditorOption.multiCursorModifier) === 'altKey');
	...
	private cleanUpActiveLinkDecoration(): cognidream {
		const useMetaKey = (this.editor.getOption(EditorOption.multiCursorModifier) === 'altKey');
	...
	private onEditorMouseUp(mouseEvent: ClickLinkMouseEvent): cognidream {
	...
	public openLinkOccurrence(occurrence: LinkOccurrence, openToSide: boolean, fromUserGesture = false): cognidream {
...
class LinkOccurrence {
	...
	public activate(changeAccessor: IModelDecorationsChangeAccessor, useMetaKey: boolean): cognidream {
		changeAccessor.changeDecorationOptions(this.decorationId, LinkOccurrence._getOptions(this.link, useMetaKey, true));
	}

	public deactivate(changeAccessor: IModelDecorationsChangeAccessor, useMetaKey: boolean): cognidream {
