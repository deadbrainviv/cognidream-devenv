...
export class MessageController implements IEditorContribution {
	...
	private _message: { element: HTMLElement; dispose: () => cognidream } | undefined;
	...
	showMessage(message: IMarkdownString | string, position: IPosition): cognidream {
