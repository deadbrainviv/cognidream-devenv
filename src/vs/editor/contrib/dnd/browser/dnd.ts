...
export class DragAndDropController extends Disposable implements IEditorContribution {
	...
	private onEditorKeyDown(e: IKeyboardEvent): cognidream {
	...
	private onEditorKeyUp(e: IKeyboardEvent): cognidream {
		if (!this._editor.getOption(EditorOption.dragAndDrop) || this._editor.getOption(EditorOption.columnSelection)) {
			return;
		}
	...
	private _onEditorMouseUp(mouseEvent: IEditorMouseEvent): cognidream {
		this._mouseDown = false;
	...
	private _onEditorMouseDrag(mouseEvent: IEditorMouseEvent): cognidream {
	...
	private _onEditorMouseDrop(mouseEvent: IPartialEditorMouseEvent): cognidream {
	...
	public showAt(position: Position): cognidream {
	...
	private _removeDecoration(): cognidream {
