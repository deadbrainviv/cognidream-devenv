...
export abstract class AbstractEditorNavigationQuickAccessProvider implements IQuickAccessProvider {
	...
	protected gotoLocation({ editor }: IQuickAccessTextEditorContext, options: { range: IRange; keyMods: IKeyMods; forceSideBySide?: boolean; preserveFocus?: boolean }): cognidream {
	 ...
	 */
	protected abstract readonly onDidActiveTextEditorControlChange: Event<cognidream>;
	...
	addDecorations(editor: IEditor, range: IRange): cognidream {
	...
	clearDecorations(editor: IEditor): cognidream {
