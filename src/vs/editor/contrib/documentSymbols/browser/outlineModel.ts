...
export class OutlineGroup extends TreeElement {
    ...
    updateMarker(marker: IOutlineMarker[]): cognidream {
        for (const [, child] of this.children) {
            this._updateMarker(marker, child);
        }
    }

    private _updateMarker(markers: IOutlineMarker[], item: OutlineElement): cognidream {
...
export class OutlineModel extends TreeElement {
    ...
    private static _makeOutlineElement(info: DocumentSymbol, container: OutlineGroup | OutlineElement): cognidream {
    ...
    private static _flattenDocumentSymbols(bucket: DocumentSymbol[], entries: DocumentSymbol[], overrideContainerLabel: string): cognidream {
