...
export class LineCommentCommand implements ICommand {
	 ...
	 */
	private _executeLineComments(model: ISimpleModel, builder: IEditOperationBuilder, data: IPreflightDataSupported, s: Selection): cognidream {
	 ...
	 */
	private _executeBlockComment(model: ITextModel, builder: IEditOperationBuilder, s: Selection): cognidream {
	 ...
	 */
	public static _normalizeInsertionPoint(model: ISimpleModel, lines: IInsertionPoint[], startLineNumber: number, indentSize: number): cognidream {
