...
export abstract class Strip extends Disposable {
	...
	private onDidChangeTop(top: number): cognidream {
	...
	private updateSliderPosition(value: number): cognidream {
...
export class OpacityStrip extends Strip {
	...
	protected override onDidChangeColor(color: Color): cognidream {
