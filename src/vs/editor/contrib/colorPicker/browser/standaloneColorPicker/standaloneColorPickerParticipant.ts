...
export class StandaloneColorPickerParticipant {
	...
	public async updateEditorModel(colorHoverData: StandaloneColorPickerHover): Promise<cognidream> {
		if (!this._editor.hasModel()) {
			return;
		}
	...
	private _setMinimumDimensions(context: IEditorHoverRenderContext): cognidream {
