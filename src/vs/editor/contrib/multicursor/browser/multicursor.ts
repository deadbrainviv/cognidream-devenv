...
function announceCursorChange(previousCursorState: CursorState[], cursorState: CursorState[]): cognidream {
...
class InsertCursorAtEndOfEachLineSelected extends EditorAction {
	...
	private getCursorsForSelection(selection: Selection, model: ITextModel, result: Selection[]): cognidream {
...
export class MultiCursorSelectionController extends Disposable implements IEditorContribution {
	...
	private _beginSessionIfNeeded(findController: CommonFindController): cognidream {
		if (!this._session) {
	...
	private _endSession(): cognidream {
	...
	private _setSelections(selections: Selection[]): cognidream {
	...
	private _applySessionResult(result: MultiCursorSessionResult | null): cognidream {
		if (!result) {
			return;
		}
	...
	public addSelectionToNextFindMatch(findController: CommonFindController): cognidream {
		if (!this._editor.hasModel()) {
			return;
		}
		if (!this._session) {
	...
	public addSelectionToPreviousFindMatch(findController: CommonFindController): cognidream {
		this._beginSessionIfNeeded(findController);
		if (this._session) {
	...
	public moveSelectionToNextFindMatch(findController: CommonFindController): cognidream {
		this._beginSessionIfNeeded(findController);
		if (this._session) {
	...
	public moveSelectionToPreviousFindMatch(findController: CommonFindController): cognidream {
		this._beginSessionIfNeeded(findController);
		if (this._session) {
	...
	public selectAll(findController: CommonFindController): cognidream {
		if (!this._editor.hasModel()) {
			return;
		}
	...
	public selectAllUsingSelections(selections: Selection[]): cognidream {
...
export abstract class MultiCursorSelectionControllerAction extends EditorAction {
	...
	protected abstract _run(multiCursorController: MultiCursorSelectionController, findController: CommonFindController): cognidream;
}
...
export class AddSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
	...
	protected _run(multiCursorController: MultiCursorSelectionController, findController: CommonFindController): cognidream {
...
export class SelectionHighlighter extends Disposable implements IEditorContribution {
	...
	private _setState(newState: SelectionHighlighterState | null): cognidream {
		this.state = newState;
