...
export class AutoIndentOnPaste implements IEditorContribution {
	...
	public trigger(range: Range): cognidream {
...
function getIndentationEditOperations(model: ITextModel, builder: IEditOperationBuilder, tabSize: number, tabsToSpaces: boolean): cognidream {
