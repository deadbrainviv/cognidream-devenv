...
export interface IActionDescriptor {
	 ...
	 */
	run(editor: ICodeEditor, ...args: any[]): cognidream | Promise<cognidream>;
}
...
export interface IStandaloneCodeEditor extends ICodeEditor {
	updateOptions(newOptions: IEditorOptions & IGlobalEditorOptions): cognidream;
...
export class StandaloneCodeEditor extends CodeEditorWidget implements IStandaloneCodeEditor {
	...
	public addAction(_descriptor: IActionDescriptor): IDisposable {
		...
		const run = (_accessor?: ServicesAccessor, ...args: any[]): Promise<cognidream> => {
	...
	protected override _triggerCommand(handlerId: string, payload: any): cognidream {
...
export class StandaloneEditor extends StandaloneCodeEditor implements IStandaloneCodeEditor {
	...
	public override updateOptions(newOptions: Readonly<IEditorOptions & IGlobalEditorOptions>): cognidream {
	...
	protected override _postDetachModelCleanup(detachedModel: ITextModel): cognidream {
...
export class StandaloneDiffEditor2 extends DiffEditorWidget implements IStandaloneDiffEditor {
	...
	public override updateOptions(newOptions: Readonly<IDiffEditorOptions & IGlobalEditorOptions>): cognidream {
