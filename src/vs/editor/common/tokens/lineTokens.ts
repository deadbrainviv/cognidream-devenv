...
export interface IViewLineTokens {
	...
	forEach(callback: (tokenIndex: number) => cognidream): cognidream;
}
...
export class LineTokens implements IViewLineTokens {
	...
	public static convertToEndOffset(tokens: Uint32Array, lineTextLength: number): cognidream {
	...
	_lineTokensBrand: cognidream = undefined;
	...
	*/
	...
	public forEach(callback: (tokenIndex: number) => cognidream): cognidream {
