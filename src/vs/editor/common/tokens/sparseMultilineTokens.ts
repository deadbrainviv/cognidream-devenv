...
export class SparseMultilineTokens {
	...
	private _updateEndLineNumber(): cognidream {
		this._endLineNumber = this._startLineNumber + this._tokens.getMaxDeltaLine();
	}
	...
	public removeTokens(range: Range): cognidream {
	...
	public applyEdit(range: IRange, text: string): cognidream {
	...
	private _acceptDeleteRange(range: IRange): cognidream {
	...
	private _acceptInsertText(position: Position, eolCount: number, firstLineLength: number, lastLineLength: number, firstCharCode: number): cognidream {
...
class SparseMultilineTokensStorage {
	...
	public acceptDeleteRange(horizontalShiftForFirstLineTokens: number, startDeltaLine: number, startCharacter: number, endDeltaLine: number, endCharacter: number): cognidream {
	...
	public acceptInsertText(deltaLine: number, character: number, eolCount: number, firstLineLength: number, lastLineLength: number, firstCharCode: number): cognidream {
