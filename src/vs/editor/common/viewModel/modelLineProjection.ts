...
export interface IModelLineProjection {
	...
	*/
	...
	getViewLinesData(model: ISimpleModel, modelLineNumber: number, outputLineIdx: number, lineCount: number, globalStartIndex: number, needed: boolean[], result: Array<ViewLineData | null>): cognidream;
...
class ModelLineProjection implements IModelLineProjection {
	...
	*/
	...
	public getViewLinesData(model: ISimpleModel, modelLineNumber: number, outputLineIdx: number, lineCount: number, globalStartIndex: number, needed: boolean[], result: Array<ViewLineData | null>): cognidream {
		this._assertVisible();
...
class IdentityModelLineProjection implements IModelLineProjection {
	...
	public getViewLinesData(model: ISimpleModel, modelLineNumber: number, _fromOuputLineIndex: number, _toOutputLineIndex: number, globalStartIndex: number, needed: boolean[], result: Array<ViewLineData | null>): cognidream {
...
class HiddenModelLineProjection implements IModelLineProjection {
	...
	public getViewLinesData(_model: ISimpleModel, _modelLineNumber: number, _fromOuputLineIndex: number, _toOutputLineIndex: number, _globalStartIndex: number, _needed: boolean[], _result: ViewLineData[]): cognidream {
		throw new Error('Not supported');
	}
