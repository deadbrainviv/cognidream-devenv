...
export interface IViewModelLines extends IDisposable {
	...
	acceptVersionId(versionId: number): cognidream;
...
export class ViewModelLinesFromProjectedModel implements IViewModelLines {
	...
	*/
	...
	private _constructLines(resetHiddenAreas: boolean, previousLineBreaks: ((ModelLineProjectionData | null)[]) | null): cognidream {
	...
	public onModelFlushed(): cognidream {
		this._constructLines(/*resetHiddenAreas*/true, null);
	}
	...
	public acceptVersionId(versionId: number): cognidream {
	...
	*/
	...
	public getLineIndentColumn(lineNumber: number): number {
		...
		// to acognidream two view lines reporting indentation for the very same model line.
		return 0;
	}
}
...
export class ViewModelLinesFromModelAsIs implements IViewModelLines {
	...
	public acceptVersionId(_versionId: number): cognidream {
	}
