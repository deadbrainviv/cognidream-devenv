...
export class ColorZone {
	_colorZoneBrand: cognidream = undefined;
...
export class OverviewRulerZone {
	_overviewRulerZoneBrand: cognidream = undefined;
	...
	public setColorZone(colorZone: ColorZone): cognidream {
...
export class OverviewZoneManager {
	...
	public setZones(newZones: OverviewRulerZone[]): cognidream {
	...
	public setPixelRatio(pixelRatio: number): cognidream {
