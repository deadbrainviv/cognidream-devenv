...
export class ParsedTokenThemeRule {
	_parsedThemeRuleBrand: cognidream = undefined;
...
export class ThemeTrieElementRule {
	_themeTrieElementRuleBrand: cognidream = undefined;
	...
	public acceptOverwrite(fontStyle: FontStyle, foreground: ColorId, background: ColorId): cognidream {
...
export class ThemeTrieElement {
	_themeTrieElementBrand: cognidream = undefined;
	...
	public insert(token: string, fontStyle: FontStyle, foreground: ColorId, background: ColorId): cognidream {
		if (token === '') {
