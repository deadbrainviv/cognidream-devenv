...
export class RichEditBracket {
	_richEditBracketBrand: cognidream = undefined;
...
export class RichEditBrackets {
	_richEditBracketsBrand: cognidream = undefined;
...
function collectSuperstrings(str: string, brackets: InternalBracket[], currentIndex: number, dest: string[]): cognidream {
