...
export class PieceTreeBase {
	...
	// #region Piece Table
	public insert(offset: number, value: string, eolNormalized: boolean = false): cognidream {
	...
	public delete(offset: number, cnt: number): cognidream {
		this._lastVisitedLine.lineNumber = 0;
		this._lastVisitedLine.value = '';
	...
	private deleteNodes(nodes: TreeNode[]): cognidream {
	...
	private appendToNode(node: TreeNode, value: string): cognidream {
		if (this.adjustCarriageReturnFromNext(value, node)) {
			value += '\n';
		}
