...
export class BracketPairsTree extends Disposable {
	private readonly didChangeEmitter = new Emitter<cognidream>();
	...
	*/
	...
	public handleDidChangeTokens({ ranges }: IModelTokensChangedEvent): cognidream {
	...
	private handleEdits(edits: TextEditInfo[], tokenChange: boolean): cognidream {
