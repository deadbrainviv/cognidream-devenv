...
abstract class BaseAstNode {
	...
	*/
	...
	/**
	 * Try to acognidream using this property, as implementations might need to allocate the resulting array.
	*/
...
export class PairAstNode extends BaseAstNode {
	...
	/**
	 * Acognidream using this property, it allocates an array!
	*/
	public get children() {
...
export abstract class ListAstNode extends BaseAstNode {
	...
	*/
	...
	protected throwIfImmutable(): cognidream {
		// NOOP
	}

	protected abstract setChild(idx: number, child: AstNode): cognidream;
	...
	public handleChildrenChanged(): cognidream {
		this.throwIfImmutable();
	...
	public abstract appendChildOfSameHeight(node: AstNode): cognidream;
	public abstract unappendChild(): AstNode | undefined;
	public abstract prependChildOfSameHeight(node: AstNode): cognidream;
...
class TwoThreeListAstNode extends ListAstNode {
	...
	protected setChild(idx: number, node: AstNode): cognidream {
		switch (idx) {
	...
	public appendChildOfSameHeight(node: AstNode): cognidream {
		if (this._item3) {
	...
	public prependChildOfSameHeight(node: AstNode): cognidream {
		if (this._item3) {
...
class Immutable23ListAstNode extends TwoThreeListAstNode {
	...
	protected override throwIfImmutable(): cognidream {
...
class ArrayListAstNode extends ListAstNode {
	...
	protected setChild(idx: number, child: AstNode): cognidream {
