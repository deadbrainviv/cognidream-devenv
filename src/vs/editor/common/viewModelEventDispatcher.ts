...
export class ViewModelEventDispatcher extends Disposable {
	...
	public emitOutgoingEvent(e: OutgoingViewModelEvent): cognidream {
		this._addOutgoingEvent(e);
		this._emitOutgoingEvents();
	}

	private _addOutgoingEvent(e: OutgoingViewModelEvent): cognidream {
	...
	private _emitOutgoingEvents(): cognidream {
	...
	public endEmitViewEvents(): cognidream {
		this._collectorCnt--;
	...
	public emitSingleViewEvent(event: ViewEvent): cognidream {
		try {
	...
	private _emitMany(events: ViewEvent[]): cognidream {
	...
	private _consumeViewEventQueue(): cognidream {
		try {
	...
	private _doConsumeQueue(): cognidream {
