...
export class TokenizationRegistry<TSupport> implements ITokenizationRegistry<TSupport> {
	...
	public handleChange(languageIds: string[]): cognidream {
	...
	public setColorMap(colorMap: Color[]): cognidream {
...
class TokenizationSupportFactoryData<TSupport> extends Disposable {
	...
	private _resolvePromise: Promise<cognidream> | null = null;
	...
	public async resolve(): Promise<cognidream> {
	...
	private async _create(): Promise<cognidream> {
