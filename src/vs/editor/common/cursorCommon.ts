...
export class CursorConfiguration {
	_cursorMoveConfigurationBrand: cognidream = undefined;
...
export class CursorState {
	_cursorStateBrand: cognidream = undefined;
...
export class SingleCursorState {
	_singleCursorStateBrand: cognidream = undefined;
...
export class EditOperationResult {
	_editOperationResultBrand: cognidream = undefined;
