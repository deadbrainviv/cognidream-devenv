...
export class SemanticTokensProviderStyling {
	...
	public warnOverlappingSemanticTokens(lineNumber: number, startColumn: number): cognidream {
	...
	public warnInvalidLengthSemanticTokens(lineNumber: number, startColumn: number): cognidream {
	...
	public warnInvalidEditStart(previousResultId: string | undefined, resultId: string | undefined, editIndex: number, editStart: number, maxExpectedStart: number): cognidream {
...
class HashTable {
	...
	private static _nullOutEntries(entries: (HashTableEntry | null)[], length: number): cognidream {
	...
	public add(tokenTypeIndex: number, tokenModifierSet: number, languageId: number, metadata: number): cognidream {
		this._elementsCount++;
	...
	private _add(element: HashTableEntry): cognidream {
