 ...
 */
export function registerPlatformLanguageAssociation(association: ILanguageAssociation, warnOnOverwrite = false): cognidream {
 ...
 */
export function registerConfiguredLanguageAssociation(association: ILanguageAssociation): cognidream {
	_registerLanguageAssociation(association, true, false);
}

function _registerLanguageAssociation(association: ILanguageAssociation, userConfigured: boolean, warnOnOverwrite: boolean): cognidream {
 ...
 */
export function clearPlatformLanguageAssociations(): cognidream {
 ...
 */
export function clearConfiguredLanguageAssociations(): cognidream {
	registeredAssociations = registeredAssociations.filter(a => !a.userConfigured);
