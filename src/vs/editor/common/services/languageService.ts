...
export class LanguageService extends Disposable implements ILanguageService {
	...
	protected readonly _onDidChange = this._register(new Emitter<cognidream>({ leakWarningThreshold: 200 /* https://github.com/microsoft/vscode/issues/119968 */ }));
	...
	public requestBasicLanguageFeatures(languageId: string): cognidream {
	...
	public requestRichLanguageFeatures(languageId: string): cognidream {
...
class LanguageSelection implements ILanguageSelection {
	...
	constructor(onDidChangeLanguages: Event<cognidream>, selector: () => string) {
