...
export class LanguageIdCodec implements ILanguageIdCodec {
	...
	private _register(language: string, languageId: LanguageId): cognidream {
		this._languageIdToLanguage[languageId] = language;
		this._languageToLanguageId.set(language, languageId);
	}

	public register(language: string): cognidream {
...
export class LanguagesRegistry extends Disposable {
	...
	public setDynamicLanguages(def: ILanguageExtensionPoint[]): cognidream {
		this._dynamicLanguages = def;
		this._initializeFromRegistry();
	}

	private _initializeFromRegistry(): cognidream {
		this._languages = {};
		this._mimeTypesMap = {};
		this._nameMap = {};
		this._lowercaseNameMap = {};
	...
	_registerLanguages(desc: ILanguageExtensionPoint[]): cognidream {
	...
	private _registerLanguage(lang: ILanguageExtensionPoint): cognidream {
	...
	private _mergeLanguage(resolvedLanguage: IResolvedLanguage, lang: ILanguageExtensionPoint): cognidream {
		const langId = lang.id;
