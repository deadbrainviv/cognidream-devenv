...
export class LineRangeMapping {
	 ...
	 * It acognidreams various problems when the line range points to non-existing line-numbers.
	*/
...
export class RangeMapping {
	...
	public static assertSorted(rangeMappings: RangeMapping[]): cognidream {
		for (let i = 1; i < rangeMappings.length; i++) {
