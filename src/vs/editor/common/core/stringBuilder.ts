...
export class StringBuilder {
	...
	private _flushBuffer(): cognidream {
	 ...
	 */
	public appendCharCode(charCode: number): cognidream {
	 ...
	 */
	public appendASCIICharCode(charCode: number): cognidream {
	...
	public appendString(str: string): cognidream {
