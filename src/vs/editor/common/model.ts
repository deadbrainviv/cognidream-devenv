...
export interface IGlyphMarginLanesModel {
	 ...
	 */
	reset(maxLine: number): cognidream;
	 ...
	 */
	push(lane: GlyphMarginLane, range: Range, persist?: boolean): cognidream;
}
...
export interface IModelDecorationsChangeAccessor {
	 ...
	 */
	changeDecorationOptions(id: string, newOptions: IModelDecorationOptions): cognidream;
	/**
...
export class TextModelResolvedOptions {
	_textModelResolvedOptionsBrand: cognidream = undefined;
...
export class FindMatch {
	_findMatchBrand: cognidream = undefined;
...
export interface ITextModel {
	 ...
	 * @internal
	 */
	removeUnusualLineTerminators(selections?: Selection[]): cognidream;
	 ...
	 */
	setValue(newValue: string | ITextSnapshot): cognidream;
	 ...
	 * @internal
	 */
	setLanguage(languageId: string, source?: string): cognidream;
	 ...
	 * @internal
	 */
	setLanguage(languageSelection: ILanguageSelection, source?: string): cognidream;
	 ...
	 * @internal
	 */
	removeAllDecorationsWithOwnerId(ownerId: number): cognidream;
	 ...
	 */
	updateOptions(newOpts: ITextModelUpdateOptions): cognidream;

	/**
	 * Detect the indentation options for this model from its content.
	 */
	detectIndentation(defaultInsertSpaces: boolean, defaultTabSize: number): cognidream;
	 ...
	 */
	pushEOL(eol: EndOfLineSequence): cognidream;
	 ...
	 */
	applyEdits(operations: IIdentifiedSingleEditOperation[]): cognidream;
	applyEdits(operations: IIdentifiedSingleEditOperation[], computeUndoEdits: false): cognidream;
	 ...
	 */
	setEOL(eol: EndOfLineSequence): cognidream;

	/**
	 * @internal
	 */
	_applyUndo(changes: TextChange[], eol: EndOfLineSequence, resultingAlternativeVersionId: number, resultingSelection: Selection[] | null): cognidream;

	/**
	 * @internal
	 */
	_applyRedo(changes: TextChange[], eol: EndOfLineSequence, resultingAlternativeVersionId: number, resultingSelection: Selection[] | null): cognidream;
	 ...
	 * @internal
	 */
	undo(): cognidream | Promise<cognidream>;
	 ...
	 * @internal
	 */
	redo(): cognidream | Promise<cognidream>;
	 ...
	 * @event
	 */
	onDidChangeContent(listener: (e: IModelContentChangedEvent) => cognidream): IDisposable;
	/**
	 ...
	 * @event
	 */
	readonly onDidChangeAttached: Event<cognidream>;
	/**
	 * An event emitted right before disposing the model.
	 * @event
	 */
	readonly onWillDispose: Event<cognidream>;
	 ...
	 * @internal
	 */
	onBeforeDetached(view: IAttachedView): cognidream;
...
export interface ITextBufferBuilder {
	acceptChunk(chunk: string): cognidream;
...
export interface IReadonlyTextBuffer {
	onDidChangeContent: Event<cognidream>;
	equals(other: ITextBuffer): boolean;
	mightContainRTL(): boolean;
	mightContainUnusualLineTerminators(): boolean;
	resetMightContainUnusualLineTerminators(): cognidream;
	mightContainNonBasicASCII(): boolean;
	getBOM(): string;
	getEOL(): string;
