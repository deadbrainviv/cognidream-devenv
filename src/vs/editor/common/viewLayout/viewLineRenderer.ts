...
export class CharacterMapping {
	...
	public setColumnInfo(column: number, partIndex: number, charIndex: number, horizontalOffset: number): cognidream {
		const partData = (
...
export class RenderLineOutput {
	_renderLineOutputBrand: cognidream = undefined;
 ...
 * So here we try to acognidream that.
 */
