...
class EditorScrollable extends Disposable {
	...
	constructor(smoothScrollDuration: number, scheduleAtNextAnimationFrame: (callback: () => cognidream) => IDisposable) {
		super();
	...
	public setSmoothScrollDuration(smoothScrollDuration: number): cognidream {
	...
	public setScrollDimensions(dimensions: EditorScrollDimensions): cognidream {
	...
	public setScrollPositionNow(update: INewScrollPosition): cognidream {
		this._scrollable.setScrollPositionNow(update);
	}

	public setScrollPositionSmooth(update: INewScrollPosition): cognidream {
...
export class ViewLayout extends Disposable implements IViewLayout {
	...
	constructor(configuration: IEditorConfiguration, lineCount: number, scheduleAtNextAnimationFrame: (callback: () => cognidream) => IDisposable) {
		super();
	...
	public onHeightMaybeChanged(): cognidream {
		this._updateHeight();
	}

	private _configureSmoothScrollDuration(): cognidream {
	...
	public onConfigurationChanged(e: ConfigurationChangedEvent): cognidream {
		const options = this._configuration.options;
	...
	private _updateHeight(): cognidream {
		const scrollDimensions = this._scrollable.getScrollDimensions();
	...
	public setMaxLineWidth(maxLineWidth: number): cognidream {
		this._maxLineWidth = maxLineWidth;
		this._updateContentWidth();
	}

	public setOverlayWidgetsMinWidth(maxMinWidth: number): cognidream {
		this._overlayWidgetsMinWidth = maxMinWidth;
		this._updateContentWidth();
	}

	private _updateContentWidth(): cognidream {
		const scrollDimensions = this._scrollable.getScrollDimensions();
		this._scrollable.setScrollDimensions(new EditorScrollDimensions(
			scrollDimensions.width,
	...
	public setScrollPosition(position: INewScrollPosition, type: ScrollType): cognidream {
	...
	public deltaScrollNow(deltaScrollLeft: number, deltaScrollTop: number): cognidream {
		const currentScrollPosition = this._scrollable.getCurrentScrollPosition();
