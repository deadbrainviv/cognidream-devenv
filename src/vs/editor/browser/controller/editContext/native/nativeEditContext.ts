...
export class NativeEditContext extends AbstractEditContext {
	...
	private _onWillPaste(): cognidream {
	...
	public setEditContextOnDomNode(): cognidream {
	...
	private _emitTypeEvent(viewController: ViewController, e: TextUpdateEvent): cognidream {
	...
	private _onType(viewController: ViewController, typeInput: ITypeData): cognidream {
	...
	private _handleTextFormatUpdate(e: TextFormatUpdateEvent): cognidream {
		if (!this._editContext) {
			return;
		}
	...
	private _updateCharacterBounds(e: CharacterBoundsUpdateEvent): cognidream {
		if (!this._parent) {
			return;
		}
		const options = this._context.configuration.options;
