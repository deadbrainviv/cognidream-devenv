...
export class ScreenReaderSupport {
	...
	public onConfigurationChanged(e: ViewConfigurationChangedEvent): cognidream {
		this._updateConfigurationSettings();
		this._updateDomAttributes();
	...
	private _updateConfigurationSettings(): cognidream {
	...
	private _updateDomAttributes(): cognidream {
		const options = this._context.configuration.options;
	...
	public onCursorStateChanged(e: ViewCursorStateChangedEvent): cognidream {
	...
	private _doRender(scrollTop: number, top: number, left: number, width: number, height: number): cognidream {
	...
	public writeScreenReaderContent(): cognidream {
	...
	private _setSelectionOfScreenReaderContent(selectionOffsetStart: number, selectionOffsetEnd: number): cognidream {
