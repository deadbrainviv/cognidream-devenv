...
export class PointerEventHandler extends MouseHandler {
	...
	private onTap(event: GestureEvent): cognidream {
	...
	private onChange(event: GestureEvent): cognidream {
	...
	private _dispatchGesture(event: GestureEvent, inSelectionMode: boolean): cognidream {
	...
	protected override _onMouseDown(e: EditorMouseEvent, pointerId: number): cognidream {
...
class TouchHandler extends MouseHandler {
	...
	private onChange(e: GestureEvent): cognidream {
