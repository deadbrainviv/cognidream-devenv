...
class MinimapLayout {
	...
	public static create(
		...
		if (minimapLinesFitting >= extraLinesAtTheTop + lineCount + extraLinesAtTheBottom) {
			...
			// Acognidream flickering caused by a partial viewport start line
...
class RenderData {
	...
	public onLinesDeleted(deleteFromLineNumber: number, deleteToLineNumber: number): cognidream {
		this._renderedLines.onLinesDeleted(deleteFromLineNumber, deleteToLineNumber);
	}
	public onLinesInserted(insertFromLineNumber: number, insertToLineNumber: number): cognidream {
...
export interface IMinimapModel {
	...
	revealLineNumber(lineNumber: number): cognidream;
	setScrollTop(scrollTop: number): cognidream;
}
...
class MinimapSamplingState {
	...
	public static compute(options: MinimapOptions, viewLineCount: number, oldSamplingState: MinimapSamplingState | null): [MinimapSamplingState | null, SamplingStateEvent[]] {
		...
		// ratio is intentionally not part of the layout to acognidream the layout changing all the time
	...
	public onLinesInserted(e: viewEvents.ViewLinesInsertedEvent): cognidream {
		// have the mapping be sticky
...
export class Minimap extends ViewPart implements IMinimapModel {
	...
	private _recreateLineSampling(): cognidream {
		this._minimapSelections = null;
	...
	public revealLineNumber(lineNumber: number): cognidream {
		if (this._samplingState) {
	...
	public setScrollTop(scrollTop: number): cognidream {
...
class InnerMinimap extends Disposable {
	...
	private _startSliderDragging(e: PointerEvent, initialPosY: number, initialSliderState: MinimapLayout): cognidream {
	...
	public onDidChangeOptions(): cognidream {
		this._lastRenderData = null;
		this._buffers = null;
		this._applyLayout();
		this._domNode.setClassName(this._getMinimapDomNodeClassName());
	...
	public render(renderingCtx: IMinimapRenderingContext): cognidream {
		const renderMinimap = this._model.options.renderMinimap;
		if (renderMinimap === RenderMinimap.None) {
			this._shadow.setClassName('minimap-shadow-hidden');
...
class ContiguousLineMap<T> {
	...
	public set(lineNumber: number, value: T): cognidream {
