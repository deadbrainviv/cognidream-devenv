...
export class OverviewRuler extends ViewEventHandler implements IOverviewRuler {
	...
	public setLayout(position: OverviewRulerPosition): cognidream {
	...
	public setZones(zones: OverviewRulerZone[]): cognidream {
	...
	private _renderOneLane(ctx: CanvasRenderingContext2D, colorZones: ColorZone[], id2Color: string[], width: number): cognidream {
