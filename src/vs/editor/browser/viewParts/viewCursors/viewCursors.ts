...
export class ViewCursors extends ViewPart {
	...
	private _onCursorPositionChanged(position: Position, secondaryPositions: Position[], reason: CursorChangeReason): cognidream {
	...
	private _updateBlinking(): cognidream {
	...
	private _updateDomClassName(): cognidream {
