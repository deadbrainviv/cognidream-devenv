...
export class ViewLinesGpu extends ViewPart implements IViewLines {
	...
	private _rebuildBindGroup?: () => cognidream;
	...
	public override render(ctx: RestrictedRenderingContext): cognidream {
		throw new BugIndicatingError('Should not be called');
	}
	...
	private _renderText(viewportData: ViewportData): cognidream {
