...
export class ViewOverlayWidgets extends ViewPart {
	...
	public addWidget(widget: IOverlayWidget): cognidream {
	...
	public removeWidget(widget: IOverlayWidget): cognidream {
	...
	private _updateMaxMinWidth(): cognidream {
		let maxMinWidth = 0;
	...
	private _renderWidget(widgetData: IWidgetData, stackCoordinates: number[]): cognidream {
