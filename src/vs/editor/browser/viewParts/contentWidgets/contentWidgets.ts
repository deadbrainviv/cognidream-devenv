...
export class ViewContentWidgets extends ViewPart {
	...
	private _updateAnchorsViewPositions(): cognidream {
		const keys = Object.keys(this._widgets);
		for (const widgetId of keys) {
	...
	public addWidget(_widget: IContentWidget): cognidream {
	...
	public setWidgetPosition(widget: IContentWidget, primaryAnchor: IPosition | null, secondaryAnchor: IPosition | null, preference: ContentWidgetPositionPreference[] | null, affinity: PositionAffinity | null): cognidream {
	...
	public removeWidget(widget: IContentWidget): cognidream {
	...
	public onBeforeRender(viewportData: ViewportData): cognidream {
		const keys = Object.keys(this._widgets);
		for (const widgetId of keys) {
...
class Widget {
	...
	public onConfigurationChanged(e: viewEvents.ViewConfigurationChangedEvent): cognidream {
		const options = this._context.configuration.options;
		this._lineHeight = options.get(EditorOption.lineHeight);
	...
	public updateAnchorViewPosition(): cognidream {
		this._setPosition(this._affinity, this._primaryAnchor.modelPosition, this._secondaryAnchor.modelPosition);
	}

	private _setPosition(affinity: PositionAffinity | null, primaryAnchor: IPosition | null, secondaryAnchor: IPosition | null): cognidream {
	...
	public setPosition(primaryAnchor: IPosition | null, secondaryAnchor: IPosition | null, preference: ContentWidgetPositionPreference[] | null, affinity: PositionAffinity | null): cognidream {
...
class Coordinate implements IContentWidgetRenderedCoordinate {
	_coordinateBrand: cognidream = undefined;
...
class AnchorCoordinate {
	_anchorCoordinateBrand: cognidream = undefined;
