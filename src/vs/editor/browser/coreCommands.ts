...
export abstract class CoreEditorCommand<T> extends EditorCommand {
	public runEditorCommand(accessor: ServicesAccessor | null, editor: ICodeEditor, args?: Partial<T> | null): cognidream {
	...
	public abstract runCoreEditorCommand(viewModel: IViewModel, args: Partial<T>): cognidream;
}
...
abstract class EditorOrNativeTextInputCommand {
	...
	public _runEditorCommand(accessor: ServicesAccessor | null, editor: ICodeEditor, args: unknown): boolean | Promise<cognidream> {
	...
	public abstract runDOMCommand(activeElement: Element): cognidream;
	public abstract runEditorCommand(accessor: ServicesAccessor | null, editor: ICodeEditor, args: unknown): cognidream | Promise<cognidream>;
}
...
export namespace CoreNavigationCommands {
	...
	class BaseMoveToCommand extends CoreEditorCommand<MoveCommandOptions> {
		...
		public runCoreEditorCommand(viewModel: IViewModel, args: Partial<MoveCommandOptions>): cognidream {
			if (!args.position) {
				return;
			}
	...
	abstract class ColumnSelectCommand<T extends BaseCommandOptions = BaseCommandOptions> extends CoreEditorCommand<T> {
		public runCoreEditorCommand(viewModel: IViewModel, args: Partial<T>): cognidream {
			viewModel.model.pushStackElement();
	...
	export class CursorMoveImpl extends CoreEditorCommand<CursorMove_.RawArguments> {
		...
		public runCoreEditorCommand(viewModel: IViewModel, args: Partial<BaseCommandOptions & CursorMove_.RawArguments>): cognidream {
		...
		private _runCursorMove(viewModel: IViewModel, source: string | null | undefined, args: CursorMove_.ParsedArguments): cognidream {
			viewModel.model.pushStackElement();
	...
	class CursorMoveBasedCommand extends CoreEditorCommand<CursorMoveCommandOptions> {
		...
		public runCoreEditorCommand(viewModel: IViewModel, dynamicArgs: Partial<CursorMoveCommandOptions>): cognidream {
	...
	export const CreateCursor: CoreEditorCommand<CreateCursorCommandOptions> = registerEditorCommand(new class extends CoreEditorCommand<CreateCursorCommandOptions> {
		...
		public runCoreEditorCommand(viewModel: IViewModel, args: Partial<CreateCursorCommandOptions>): cognidream {
			if (!args.position) {
				return;
			}
	...
	class HomeCommand extends CoreEditorCommand<BaseCommandOptions> {
		...
		public runCoreEditorCommand(viewModel: IViewModel, args: Partial<BaseCommandOptions>): cognidream {
			viewModel.model.pushStackElement();
			viewModel.setCursorStates(
				args.source,
				CursorChangeReason.Explicit,
	...
	class EndCommand extends CoreEditorCommand<EndCommandOptions> {
		...
		public runCoreEditorCommand(viewModel: IViewModel, args: Partial<EndCommandOptions>): cognidream {
			viewModel.model.pushStackElement();
			viewModel.setCursorStates(
				args.source,
				CursorChangeReason.Explicit,
	...
	export class EditorScrollImpl extends CoreEditorCommand<EditorScrollCommandOptions> {
		...
		public runCoreEditorCommand(viewModel: IViewModel, args: Partial<EditorScrollCommandOptions>): cognidream {
		...
		_runVerticalEditorScroll(viewModel: IViewModel, source: string | null | undefined, args: EditorScroll_.ParsedArguments): cognidream {
		...
		_runHorizontalEditorScroll(viewModel: IViewModel, source: string | null | undefined, args: EditorScroll_.ParsedArguments): cognidream {
	...
	export const ScrollLineUp: CoreEditorCommand<BaseCommandOptions> = registerEditorCommand(new class extends CoreEditorCommand<BaseCommandOptions> {
		...
		runCoreEditorCommand(viewModel: IViewModel, args: Partial<BaseCommandOptions>): cognidream {
	...
	export const RevealLine: CoreEditorCommand<RevealLineCommandOptions> = registerEditorCommand(new class extends CoreEditorCommand<RevealLineCommandOptions> {
		...
		public runCoreEditorCommand(viewModel: IViewModel, args: Partial<RevealLineCommandOptions>): cognidream {
	...
	export const SelectAll = new class extends EditorOrNativeTextInputCommand {
		...
		public runDOMCommand(activeElement: Element): cognidream {
			if (isFirefox) {
		...
		public runEditorCommand(accessor: ServicesAccessor, editor: ICodeEditor, args: unknown): cognidream {
			const viewModel = editor._getViewModel();
			if (!viewModel) {
				// the editor has no view => has no cursors
				return;
		...
		public runCoreEditorCommand(viewModel: IViewModel, args: unknown): cognidream {
			viewModel.model.pushStackElement();
			viewModel.setCursorStates(
				'keyboard',
				CursorChangeReason.Explicit,
	...
	export const SetSelection: CoreEditorCommand<SetSelectionCommandOptions> = registerEditorCommand(new class extends CoreEditorCommand<SetSelectionCommandOptions> {
		...
		public runCoreEditorCommand(viewModel: IViewModel, args: Partial<SetSelectionCommandOptions>): cognidream {
			if (!args.selection) {
				return;
			}
			viewModel.model.pushStackElement();
...
function registerColumnSelection(id: string, keybinding: number): cognidream {
...
export namespace CoreEditingCommands {
	...
	export abstract class CoreEditingCommand extends EditorCommand {
		...
		public abstract runCoreEditingCommand(editor: ICodeEditor, viewModel: IViewModel, args: unknown): cognidream;
	}
	...
	export const LineBreakInsert: EditorCommand = registerEditorCommand(new class extends CoreEditingCommand {
		...
		public runCoreEditingCommand(editor: ICodeEditor, viewModel: IViewModel, args: unknown): cognidream {
			editor.pushUndoStop();
	...
	export const Undo = new class extends EditorOrNativeTextInputCommand {
		...
		public runEditorCommand(accessor: ServicesAccessor | null, editor: ICodeEditor, args: unknown): cognidream | Promise<cognidream> {
...
class EditorHandlerCommand extends Command {
	...
	public runCommand(accessor: ServicesAccessor, args: unknown): cognidream {
...
function registerOverwritableCommand(handlerId: string, metadata?: ICommandMetadata): cognidream {
