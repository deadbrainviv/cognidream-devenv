...
class DomCharWidthReader {
	...
	public read(targetWindow: Window): cognidream {
	...
	private _createDomElements(): cognidream {
	...
	private static _render(testElement: HTMLElement, request: CharWidthRequest): cognidream {
		if (request.chr === ' ') {
			let htmlString = '\u00a0';
	...
	private _readFromDomElements(): cognidream {
...
export function readCharWidths(targetWindow: Window, bareFontInfo: BareFontInfo, requests: CharWidthRequest[]): cognidream {
