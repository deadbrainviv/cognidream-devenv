...
export interface IEditorConstructionOptions extends IEditorOptions {
	/**
	 * The initial editor dimension (to acognidream measuring the container).
	 */
...
export class EditorConfiguration extends Disposable implements IEditorConfiguration {
	...
	private _recomputeOptions(): cognidream {
	...
	public updateOptions(_newOptions: Readonly<IEditorOptions>): cognidream {
	...
	public observeContainer(dimension?: IDimension): cognidream {
		this._containerObserver.observe(dimension);
	}

	public setIsDominatedByLongLines(isDominatedByLongLines: boolean): cognidream {
	...
	public setModelLineCount(modelLineCount: number): cognidream {
	...
	public setViewLineCount(viewLineCount: number): cognidream {
	...
	public setGlyphMarginDecorationLaneCount(decorationLaneCount: number): cognidream {
...
class ValidatedEditorOptions implements IValidatedEditorOptions {
	...
	public _write<T>(option: EditorOption, value: T): cognidream {
...
export class ComputedEditorOptions implements IComputedEditorOptions {
	...
	public _write<T>(id: EditorOption, value: T): cognidream {
