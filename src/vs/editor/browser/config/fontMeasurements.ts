...
export class FontMeasurementsImpl extends Disposable {
	 ...
	 */
	public clearAllFontInfos(): cognidream {
		this._cache.clear();
	...
	private _writeToCache(targetWindow: Window, item: BareFontInfo, value: FontInfo): cognidream {
	...
	private _evictUntrustedReadings(targetWindow: Window): cognidream {
		const cache = this._ensureCache(targetWindow);
	 ...
	 */
	public restoreFontInfo(targetWindow: Window, savedFontInfos: ISerializedFontInfo[]): cognidream {
...
class FontMeasurementsCache {
	...
	public put(item: BareFontInfo, value: FontInfo): cognidream {
		const itemId = item.getId();
		this._keys[itemId] = item;
		this._values[itemId] = value;
	}

	public remove(item: BareFontInfo): cognidream {
		const itemId = item.getId();
