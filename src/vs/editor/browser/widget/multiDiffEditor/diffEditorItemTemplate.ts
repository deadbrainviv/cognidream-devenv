...
export class TemplateData implements IObjectData {
	constructor(
		...
		public readonly deltaScrollVertical: (delta: number) => cognidream,
	) { }
...
export class DiffEditorItemTemplate extends Disposable implements IPooledObject<TemplateData> {
	...
	public setScrollLeft(left: number): cognidream {
	...
	public setData(data: TemplateData | undefined): cognidream {
		this._data = data;
	...
	public render(verticalRange: OffsetRange, width: number, editorScroll: number, viewPort: OffsetRange): cognidream {
