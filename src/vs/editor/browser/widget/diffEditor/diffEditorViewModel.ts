...
export class DiffEditorViewModel extends Disposable implements IDiffEditorViewModel {
	...
	public setActiveMovedText(movedText: MovedText | undefined): cognidream {
		this._activeMovedText.set(movedText, undefined);
	}

	public setHoveredMovedText(movedText: MovedText | undefined): cognidream {
	...
	public ensureModifiedLineIsVisible(lineNumber: number, preference: RevealPreference, tx: ITransaction | undefined): cognidream {
	...
	public ensureOriginalLineIsVisible(lineNumber: number, preference: RevealPreference, tx: ITransaction | undefined): cognidream {
		if (this.diff.get()?.mappings.length === 0) {
			return;
		}
		const unchangedRegions = this._unchangedRegions.get()?.regions || [];
	...
	public async waitForDiff(): Promise<cognidream> {
	...
	public restoreSerializedState(state: SerializedState): cognidream {
...
export class UnchangedRegion {
	...
	public showMoreAbove(count = 10, tx: ITransaction | undefined): cognidream {
		const maxVisibleLineCountTop = this.getMaxVisibleLineCountTop();
		this._visibleLineCountTop.set(Math.min(this._visibleLineCountTop.get() + count, maxVisibleLineCountTop), tx);
	}

	public showMoreBelow(count = 10, tx: ITransaction | undefined): cognidream {
		const maxVisibleLineCountBottom = this.lineCount - this._visibleLineCountTop.get();
		this._visibleLineCountBottom.set(Math.min(this._visibleLineCountBottom.get() + count, maxVisibleLineCountBottom), tx);
	}

	public showAll(tx: ITransaction | undefined): cognidream {
		this._visibleLineCountBottom.set(this.lineCount - this._visibleLineCountTop.get(), tx);
	}

	public showModifiedLine(lineNumber: number, preference: RevealPreference, tx: ITransaction | undefined): cognidream {
	...
	public showOriginalLine(lineNumber: number, preference: RevealPreference, tx: ITransaction | undefined): cognidream {
	...
	public collapseAll(tx: ITransaction | undefined): cognidream {
		this._visibleLineCountTop.set(0, tx);
		this._visibleLineCountBottom.set(0, tx);
	}

	public setState(visibleLineCountTop: number, visibleLineCountBottom: number, tx: ITransaction | undefined): cognidream {
