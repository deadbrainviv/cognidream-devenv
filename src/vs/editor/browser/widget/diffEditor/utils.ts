...
export class ObservableElementSizeObserver extends Disposable {
	...
	public setAutomaticLayout(automaticLayout: boolean): cognidream {
...
export interface IObservableViewZone extends IViewZone {
	...
	setZoneId?(zoneId: string): cognidream;
}
...
export function applyViewZones(editor: ICodeEditor, viewZones: IObservable<IObservableViewZone[]>, setIsUpdating?: (isUpdatingViewZones: boolean) => cognidream, zoneIds?: Set<string>): IDisposable {
...
export abstract class RefCounted<T> implements IDisposable, IReference<T> {
	...
	public abstract dispose(): cognidream;
...
class BaseRefCounted<T> extends RefCounted<T> {
	...
	public _decreaseRefCount(debugOwner?: object | undefined): cognidream {
		this._refCount--;
		if (this._refCount === 0) {
