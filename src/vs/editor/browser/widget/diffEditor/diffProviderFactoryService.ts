...
export class WorkerBasedDocumentDiffProvider implements IDocumentDiffProvider, IDisposable {
	private onDidChangeEventEmitter = new Emitter<cognidream>();
	public readonly onDidChange: Event<cognidream> = this.onDidChangeEventEmitter.event;
	...
	public setOptions(newOptions: IWorkerBasedDocumentDiffProviderOptions): cognidream {
		let didChange = false;
