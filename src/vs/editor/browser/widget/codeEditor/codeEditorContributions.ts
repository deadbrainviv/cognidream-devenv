...
export class CodeEditorContributions extends Disposable {
	...
	public restoreViewState(contributionsState: { [key: string]: any }): cognidream {
		for (const [id, contribution] of this._instances) {
	...
	public onBeforeInteractionEvent(): cognidream {
	...
	private _instantiateSome(instantiation: EditorContributionInstantiation): cognidream {
	...
	private _instantiateById(id: string): cognidream {
