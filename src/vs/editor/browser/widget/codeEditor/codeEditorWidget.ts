...
export class CodeEditorWidget extends Disposable implements editorBrowser.ICodeEditor {
	...
	private readonly _onDidDispose: Emitter<cognidream> = this._register(new Emitter<cognidream>());
	public readonly onDidDispose: Event<cognidream> = this._onDidDispose.event;
	...
	private readonly _onDidAttemptReadOnlyEdit: Emitter<cognidream> = this._register(new InteractionEmitter<cognidream>(this._contributions, this._deliveryQueue));
	public readonly onDidAttemptReadOnlyEdit: Event<cognidream> = this._onDidAttemptReadOnlyEdit.event;
	...
	public readonly onDidFocusEditorText: Event<cognidream> = this._editorTextFocus.onDidChangeToTrue;
	public readonly onDidBlurEditorText: Event<cognidream> = this._editorTextFocus.onDidChangeToFalse;
	...
	public readonly onDidFocusEditorWidget: Event<cognidream> = this._editorWidgetFocus.onDidChangeToTrue;
	public readonly onDidBlurEditorWidget: Event<cognidream> = this._editorWidgetFocus.onDidChangeToFalse;
	...
	private readonly _onDidCompositionStart: Emitter<cognidream> = this._register(new InteractionEmitter<cognidream>(this._contributions, this._deliveryQueue));
	public readonly onDidCompositionStart = this._onDidCompositionStart.event;

	private readonly _onDidCompositionEnd: Emitter<cognidream> = this._register(new InteractionEmitter<cognidream>(this._contributions, this._deliveryQueue));
	...
	private readonly _onMouseDropCanceled: Emitter<cognidream> = this._register(new InteractionEmitter<cognidream>(this._contributions, this._deliveryQueue));
	public readonly onMouseDropCanceled: Event<cognidream> = this._onMouseDropCanceled.event;
	...
	private readonly _onDidChangeViewZones: Emitter<cognidream> = this._register(new Emitter<cognidream>({ deliveryQueue: this._deliveryQueue }));
	public readonly onDidChangeViewZones: Event<cognidream> = this._onDidChangeViewZones.event;

	private readonly _onDidChangeHiddenAreas: Emitter<cognidream> = this._register(new Emitter<cognidream>({ deliveryQueue: this._deliveryQueue }));
	public readonly onDidChangeHiddenAreas: Event<cognidream> = this._onDidChangeHiddenAreas.event;
	...
	private readonly _onBeginUpdate: Emitter<cognidream> = this._register(new Emitter<cognidream>());
	public readonly onBeginUpdate: Event<cognidream> = this._onBeginUpdate.event;

	private readonly _onEndUpdate: Emitter<cognidream> = this._register(new Emitter<cognidream>());
	public readonly onEndUpdate: Event<cognidream> = this._onEndUpdate.event;
	...
	constructor(
		...
		for (const action of EditorExtensionsRegistry.getEditorActions()) {
			...
			const internalAction = new InternalEditorAction(
				...
				(args: unknown): Promise<cognidream> => {
	...
	public updateOptions(newOptions: Readonly<IEditorOptions> | undefined): cognidream {
	...
	public setValue(newValue: string): cognidream {
		try {
			this._beginUpdate();
			if (!this._modelData) {
				return;
	...
	public setModel(_model: ITextModel | editorCommon.IDiffEditorModel | editorCommon.IDiffEditorViewModel | null = null): cognidream {
		try {
			this._beginUpdate();
	...
	private _removeDecorationTypes(): cognidream {
		this._decorationTypeKeysToIds = {};
	...
	public setHiddenAreas(ranges: IRange[], source?: unknown, forceUpdate?: boolean): cognidream {
	...
	public setPosition(position: IPosition, source: string = 'api'): cognidream {
		if (!this._modelData) {
			return;
		}
	...
	private _sendRevealRange(modelRange: Range, verticalType: VerticalRevealType, revealHorizontal: boolean, scrollType: editorCommon.ScrollType): cognidream {
		if (!this._modelData) {
			return;
		}
	...
	public revealLine(lineNumber: number, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealLine(lineNumber, VerticalRevealType.Simple, scrollType);
	}

	public revealLineInCenter(lineNumber: number, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealLine(lineNumber, VerticalRevealType.Center, scrollType);
	}

	public revealLineInCenterIfOutsideViewport(lineNumber: number, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealLine(lineNumber, VerticalRevealType.CenterIfOutsideViewport, scrollType);
	}

	public revealLineNearTop(lineNumber: number, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealLine(lineNumber, VerticalRevealType.NearTop, scrollType);
	}

	private _revealLine(lineNumber: number, revealType: VerticalRevealType, scrollType: editorCommon.ScrollType): cognidream {
	...
	public revealPosition(position: IPosition, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
	...
	public revealPositionInCenter(position: IPosition, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealPosition(
			position,
	...
	public revealPositionInCenterIfOutsideViewport(position: IPosition, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealPosition(
			position,
	...
	public revealPositionNearTop(position: IPosition, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealPosition(
			position,
	...
	private _revealPosition(position: IPosition, verticalType: VerticalRevealType, revealHorizontal: boolean, scrollType: editorCommon.ScrollType): cognidream {
		if (!Position.isIPosition(position)) {
			throw new Error('Invalid arguments');
		}
	...
	public setSelection(range: IRange, source?: string): cognidream;
	public setSelection(editorRange: Range, source?: string): cognidream;
	public setSelection(selection: ISelection, source?: string): cognidream;
	public setSelection(editorSelection: Selection, source?: string): cognidream;
	public setSelection(something: any, source: string = 'api'): cognidream {
	...
	private _setSelectionImpl(sel: ISelection, source: string): cognidream {
		if (!this._modelData) {
			return;
		}
	...
	public revealLines(startLineNumber: number, endLineNumber: number, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealLines(
			startLineNumber,
			endLineNumber,
			VerticalRevealType.Simple,
	...
	public revealLinesInCenter(startLineNumber: number, endLineNumber: number, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealLines(
			startLineNumber,
			endLineNumber,
			VerticalRevealType.Center,
	...
	public revealLinesInCenterIfOutsideViewport(startLineNumber: number, endLineNumber: number, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealLines(
			startLineNumber,
			endLineNumber,
			VerticalRevealType.CenterIfOutsideViewport,
	...
	public revealLinesNearTop(startLineNumber: number, endLineNumber: number, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealLines(
			startLineNumber,
			endLineNumber,
			VerticalRevealType.NearTop,
	...
	private _revealLines(startLineNumber: number, endLineNumber: number, verticalType: VerticalRevealType, scrollType: editorCommon.ScrollType): cognidream {
	...
	public revealRange(range: IRange, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth, revealVerticalInCenter: boolean = false, revealHorizontal: boolean = true): cognidream {
		this._revealRange(
			range,
	...
	public revealRangeInCenter(range: IRange, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealRange(
			range,
			VerticalRevealType.Center,
			true,
	...
	public revealRangeInCenterIfOutsideViewport(range: IRange, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealRange(
			range,
			VerticalRevealType.CenterIfOutsideViewport,
			true,
	...
	public revealRangeNearTop(range: IRange, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealRange(
			range,
			VerticalRevealType.NearTop,
			true,
	...
	public revealRangeNearTopIfOutsideViewport(range: IRange, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealRange(
			range,
	...
	public revealRangeAtTop(range: IRange, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Smooth): cognidream {
		this._revealRange(
			range,
	...
	private _revealRange(range: IRange, verticalType: VerticalRevealType, revealHorizontal: boolean, scrollType: editorCommon.ScrollType): cognidream {
	...
	public setSelections(ranges: readonly ISelection[], source: string = 'api', reason = CursorChangeReason.NotSet): cognidream {
		if (!this._modelData) {
			return;
		}
	...
	public setScrollLeft(newScrollLeft: number, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Immediate): cognidream {
		if (!this._modelData) {
			return;
		}
	...
	public setScrollTop(newScrollTop: number, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Immediate): cognidream {
		if (!this._modelData) {
			return;
		}
	...
	public setScrollPosition(position: editorCommon.INewScrollPosition, scrollType: editorCommon.ScrollType = editorCommon.ScrollType.Immediate): cognidream {
		if (!this._modelData) {
			return;
		}
	...
	public restoreViewState(s: editorCommon.IEditorViewState | null): cognidream {
	...
	public handleInitialized(): cognidream {
		this._getViewModel()?.visibleLinesStabilized();
	}

	public onVisible(): cognidream {
		this._modelData?.view.refreshFocusState();
	}

	public onHide(): cognidream {
		this._modelData?.view.refreshFocusState();
	}
	...
	public trigger(source: string | null | undefined, handlerId: string, payload: any): cognidream {
		payload = payload || {};
	...
	protected _triggerCommand(handlerId: string, payload: any): cognidream {
		this._commandService.executeCommand(handlerId, payload);
	}

	private _startComposition(): cognidream {
		if (!this._modelData) {
			return;
		}
	...
	private _endComposition(source: string | null | undefined): cognidream {
		if (!this._modelData) {
			return;
		}
	...
	private _type(source: string | null | undefined, text: string): cognidream {
	...
	private _compositionType(source: string | null | undefined, text: string, replacePrevCharCnt: number, replaceNextCharCnt: number, positionDelta: number): cognidream {
		if (!this._modelData) {
			return;
		}
	...
	private _paste(source: string | null | undefined, text: string, pasteOnNewLine: boolean, multicursorText: string[] | null, mode: string | null, clipboardEvent?: ClipboardEvent): cognidream {
		if (!this._modelData) {
			return;
		}
	...
	private _cut(source: string | null | undefined): cognidream {
		if (!this._modelData) {
			return;
		}
	...
	public executeCommand(source: string | null | undefined, command: editorCommon.ICommand): cognidream {
		if (!this._modelData) {
			return;
		}
	...
	public executeCommands(source: string | null | undefined, commands: editorCommon.ICommand[]): cognidream {
		if (!this._modelData) {
			return;
		}
	...
	public removeDecorations(decorationIds: string[]): cognidream {
	...
	public setDecorationsByType(description: string, decorationTypeKey: string, decorationOptions: editorCommon.IDecorationOptions[]): cognidream {
	...
	public setDecorationsByTypeFast(decorationTypeKey: string, ranges: IRange[]): cognidream {
	...
	public removeDecorationsByType(decorationTypeKey: string): cognidream {
	...
	public layout(dimension?: IDimension, postponeRendering: boolean = false): cognidream {
	...
	public addContentWidget(widget: editorBrowser.IContentWidget): cognidream {
	...
	public layoutContentWidget(widget: editorBrowser.IContentWidget): cognidream {
	...
	public removeContentWidget(widget: editorBrowser.IContentWidget): cognidream {
		const widgetId = widget.getId();
		if (this._contentWidgets.hasOwnProperty(widgetId)) {
			const widgetData = this._contentWidgets[widgetId];
	...
	public addOverlayWidget(widget: editorBrowser.IOverlayWidget): cognidream {
	...
	public layoutOverlayWidget(widget: editorBrowser.IOverlayWidget): cognidream {
		const widgetId = widget.getId();
	...
	public removeOverlayWidget(widget: editorBrowser.IOverlayWidget): cognidream {
		const widgetId = widget.getId();
		if (this._overlayWidgets.hasOwnProperty(widgetId)) {
			const widgetData = this._overlayWidgets[widgetId];
	...
	public addGlyphMarginWidget(widget: editorBrowser.IGlyphMarginWidget): cognidream {
	...
	public layoutGlyphMarginWidget(widget: editorBrowser.IGlyphMarginWidget): cognidream {
		const widgetId = widget.getId();
	...
	public removeGlyphMarginWidget(widget: editorBrowser.IGlyphMarginWidget): cognidream {
		const widgetId = widget.getId();
		if (this._glyphMarginWidgets.hasOwnProperty(widgetId)) {
			const widgetData = this._glyphMarginWidgets[widgetId];
	...
	public changeViewZones(callback: (accessor: editorBrowser.IViewZoneChangeAccessor) => cognidream): cognidream {
		if (!this._modelData || !this._modelData.hasRealView) {
			return;
		}
	...
	public render(forceRedraw: boolean = false): cognidream {
		if (!this._modelData || !this._modelData.hasRealView) {
			return;
		}
	...
	public setAriaOptions(options: editorBrowser.IEditorAriaOptions): cognidream {
		if (!this._modelData || !this._modelData.hasRealView) {
			return;
		}
	...
	public applyFontInfo(target: HTMLElement): cognidream {
		applyFontInfo(target, this._configuration.options.get(EditorOption.fontInfo));
	}

	public setBanner(domNode: HTMLElement | null, domNodeHeight: number): cognidream {
	...
	protected _attachModel(model: ITextModel | null): cognidream {
		if (!model) {
			this._modelData = null;
			return;
		}
	...
	protected _postDetachModelCleanup(detachedModel: ITextModel | null): cognidream {
	...
	private _registerDecorationType(description: string, key: string, options: editorCommon.IDecorationRenderOptions, parentTypeKey?: string): cognidream {
		this._codeEditorService.registerDecorationType(description, key, options, parentTypeKey, this);
	}

	private _removeDecorationType(key: string): cognidream {
	...
	private showDropIndicatorAt(position: Position): cognidream {
	...
	private removeDropIndicator(): cognidream {
		this._dropIntoEditorDecorations.clear();
	}

	public setContextValue(key: string, value: ContextKeyValue): cognidream {
		this._contextKeyService.createKey(key, value);
	}

	private _beginUpdate(): cognidream {
		this._updateCounter++;
...
export class BooleanEventEmitter extends Disposable {
	private readonly _onDidChangeToTrue: Emitter<cognidream>;
	public readonly onDidChangeToTrue: Event<cognidream>;

	private readonly _onDidChangeToFalse: Emitter<cognidream>;
	public readonly onDidChangeToFalse: Event<cognidream>;
	...
	constructor(
		...
		super();
		this._onDidChangeToTrue = this._register(new Emitter<cognidream>(this._emitterOptions));
		this.onDidChangeToTrue = this._onDidChangeToTrue.event;
		this._onDidChangeToFalse = this._register(new Emitter<cognidream>(this._emitterOptions));
...
class InteractionEmitter<T> extends Emitter<T> {
	...
	override fire(event: T): cognidream {
...
class EditorContextKeysManager extends Disposable {
	...
	private _updateFromConfig(): cognidream {
	...
	private _updateFromSelection(): cognidream {
	...
	private _updateFromFocus(): cognidream {
		this._editorFocus.set(this._editor.hasWidgetFocus() && !this._editor.isSimpleWidget);
		this._editorTextFocus.set(this._editor.hasTextFocus() && !this._editor.isSimpleWidget);
		this._textInputFocus.set(this._editor.hasTextFocus());
	}

	private _updateFromModel(): cognidream {
