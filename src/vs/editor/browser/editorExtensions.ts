...
export abstract class Command {
	...
	private _registerMenuItem(item: ICommandMenuOptions): cognidream {
	...
	public abstract runCommand(accessor: ServicesAccessor, args: any): cognidream | Promise<cognidream>;
}
 ...
 */
export type CommandImplementation = (accessor: ServicesAccessor, args: unknown) => boolean | Promise<cognidream>;
...
export class MultiCommand extends Command {
	...
	public runCommand(accessor: ServicesAccessor, args: any): cognidream | Promise<cognidream> {
...
export interface IContributionCommandOptions<T> extends ICommandOptions {
	handler: (controller: T, args: any) => cognidream;
}
...
export abstract class EditorCommand extends Command {
	...
	public static bindToContribution<T extends IEditorContribution>(controllerGetter: (editor: ICodeEditor) => T | null): EditorControllerCommand<T> {
		return class EditorControllerCommandImpl extends EditorCommand {
			private readonly _callback: (controller: T, args: any) => cognidream;
			...
			public runEditorCommand(accessor: ServicesAccessor, editor: ICodeEditor, args: any): cognidream {
	...
	public static runEditorCommand(
		...
		args: any,
		precondition: ContextKeyExpression | undefined,
		runner: (accessor: ServicesAccessor | null, editor: ICodeEditor, args: any) => cognidream | Promise<cognidream>
	): cognidream | Promise<cognidream> {
	...
	public abstract runEditorCommand(accessor: ServicesAccessor | null, editor: ICodeEditor, args: any): cognidream | Promise<cognidream>;
}
...
export abstract class EditorAction extends EditorCommand {
	...
	public runEditorCommand(accessor: ServicesAccessor, editor: ICodeEditor, args: any): cognidream | Promise<cognidream> {
	...
	public abstract run(accessor: ServicesAccessor, editor: ICodeEditor, args: any): cognidream | Promise<cognidream>;
}

export type EditorActionImplementation = (accessor: ServicesAccessor, editor: ICodeEditor, args: any) => boolean | Promise<cognidream>;
...
export class MultiEditorAction extends EditorAction {
	...
	public run(accessor: ServicesAccessor, editor: ICodeEditor, args: any): cognidream | Promise<cognidream> {
		for (const impl of this._implementations) {
...
export function registerInstantiatedEditorAction(editorAction: EditorAction): cognidream {
 ...
 */
export function registerEditorContribution<Services extends BrandedService[]>(id: string, ctor: { new(editor: ICodeEditor, ...services: Services): IEditorContribution }, instantiation: EditorContributionInstantiation): cognidream {
 ...
 */
export function registerDiffEditorContribution<Services extends BrandedService[]>(id: string, ctor: { new(editor: IDiffEditor, ...services: Services): IEditorContribution }): cognidream {
...
class EditorContributionRegistry {
	...
	public registerEditorContribution<Services extends BrandedService[]>(id: string, ctor: { new(editor: ICodeEditor, ...services: Services): IEditorContribution }, instantiation: EditorContributionInstantiation): cognidream {
	...
	public registerDiffEditorContribution<Services extends BrandedService[]>(id: string, ctor: { new(editor: IDiffEditor, ...services: Services): IEditorContribution }): cognidream {
