...
suite('Editor ViewLayout - LinesLayout', () => {
    ...
    function changeOneWhitespace(linesLayout: LinesLayout, id: string, newAfterLineNumber: number, newHeight: number): cognidream {
        linesLayout.changeWhitespace((accessor) => {
            accessor.changeOneWhitespace(id, newAfterLineNumber, newHeight);
        });
    }

    function removeWhitespace(linesLayout: LinesLayout, id: string): cognidream {
        linesLayout.changeWhitespace((accessor) => {
