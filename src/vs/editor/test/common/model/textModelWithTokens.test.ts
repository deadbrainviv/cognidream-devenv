...
suite('TextModelWithTokens', () => {
    ...
    function testBrackets(contents: string[], brackets: CharacterPair[]): cognidream {
...
function assertIsBracket(model: TextModel, testPosition: Position, expected: [Range, Range]): cognidream {
...
suite('TextModelWithTokens regression tests', () => {
    ...
    test('microsoft/monaco-editor#122: Unhandled Exception: TypeError: Unable to get property \'replace\' of undefined or null reference', () => {
        function assertViewLineTokens(model: TextModel, lineNumber: number, forceTokenization: boolean, expected: TestLineToken[]): cognidream {
...
suite('TextModel.getLineIndentGuide', () => {
    ...
    function assertIndentGuides(lines: [number, number, number, number, string][], indentSize: number): cognidream {
    ...
    test('issue #49173', () => {
        const model = createTextModel([
            'class A {',
            '	public m1(): cognidream {',
            '	}',
            '	public m2(): cognidream {',
            '	}',
            '	public m3(): cognidream {',
            '	}',
            '	public m4(): cognidream {',
            '	}',
            '	public m5(): cognidream {',
            '	}',
            '}',
        ].join('\n'));
