...
suite('PieceTreeTextBuffer._getInverseEdits', () => {
    ...
    function assertInverseEdits(ops: IValidatedEditOperation[], expected: Range[]): cognidream {
...
suite('PieceTreeTextBuffer._toSingleEditOperation', () => {
    ...
    function testToSingleEditOperation(original: string[], edits: IValidatedEditOperation[], expected: IValidatedEditOperation): cognidream {
