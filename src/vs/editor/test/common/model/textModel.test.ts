...
function testGuessIndentation(defaultInsertSpaces: boolean, defaultTabSize: number, expectedInsertSpaces: boolean, expectedTabSize: number, text: string[], msg?: string): cognidream {
...
function assertGuess(expectedInsertSpaces: boolean | undefined, expectedTabSize: number | undefined | [number], text: string[], msg?: string): cognidream {
...
suite('TextModelData.fromString', () => {
    ...
    function testTextModelDataFromString(text: string, expected: ITextBufferData): cognidream {
...
suite('Editor Model - TextModel', () => {
    ...
    test('TextModel does not use events internally', () => {
        ...
        // to acognidream that by any chance an outside listener receives events before
