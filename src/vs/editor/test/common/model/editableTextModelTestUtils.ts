...
export function testApplyEditsWithSyncedModels(original: string[], edits: ISingleEditOperation[], expected: string[], inputEditsAreInvalid: boolean = false): cognidream {
...
function assertOneDirectionLineMapping(model: TextModel, direction: AssertDocumentLineMappingDirection, msg: string): cognidream {
...
function assertLineMapping(model: TextModel, msg: string): cognidream {
...
export function assertSyncedModels(text: string, callback: (model: TextModel, assertMirrorModels: () => cognidream) => cognidream, setup: ((model: TextModel) => cognidream) | null = null): cognidream {
