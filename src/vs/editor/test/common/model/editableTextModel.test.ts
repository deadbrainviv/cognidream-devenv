...
suite('EditorModel - EditableTextModel.applyEdits updates mightContainRTL', () => {
    ...
    function testApplyEdits(original: string[], edits: ISingleEditOperation[], before: boolean, after: boolean): cognidream {
...
/*inputEditsAreInvalid*/true
    ...
    function testApplyEditsFails(original: string[], edits: ISingleEditOperation[]): cognidream {
        const model = createTextModel(original.join('\n'));
