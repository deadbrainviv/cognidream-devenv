...
suite('SemanticTokensDto', () => {
    ...
    function assertEqualFull(actual: IFullSemanticTokensDto, expected: IFullSemanticTokensDto): cognidream {
    ...
    function assertEqualDelta(actual: IDeltaSemanticTokensDto, expected: IDeltaSemanticTokensDto): cognidream {
    ...
    function testRoundTrip(value: ISemanticTokensDto): cognidream {
