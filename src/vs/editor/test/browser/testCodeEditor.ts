...
export interface ITestCodeEditor extends IActiveCodeEditor {
    ...
    registerDisposable(disposable: IDisposable): cognidream;
}
...
export class TestCodeEditor extends CodeEditorWidget implements ICodeEditor {
    ...
    public setHasTextFocus(hasTextFocus: boolean): cognidream {
    ...
    public registerDisposable(disposable: IDisposable): cognidream {
...
class TestEditorDomElement {
    ...
    document = document;
    setAttribute(attr: string, value: string): cognidream { }
    removeAttribute(attr: string): cognidream { }
    hasAttribute(attr: string): boolean { return false; }
    getAttribute(attr: string): string | undefined { return undefined; }
    addEventListener(event: string): cognidream { }
    removeEventListener(event: string): cognidream { }
}
...
export function withTestCodeEditor(text: ITextModel | string | string[] | ITextBufferFactory, options: TestCodeEditorInstantiationOptions, callback: (editor: ITestCodeEditor, viewModel: ViewModel, instantiationService: TestInstantiationService) => cognidream): cognidream {
    return _withTestCodeEditor(text, options, callback);
}

export async function withAsyncTestCodeEditor(text: ITextModel | string | string[] | ITextBufferFactory, options: TestCodeEditorInstantiationOptions, callback: (editor: ITestCodeEditor, viewModel: ViewModel, instantiationService: TestInstantiationService) => Promise<cognidream>): Promise<cognidream> {
    return _withTestCodeEditor(text, options, callback);
}
...
function _withTestCodeEditor(arg: ITextModel | string | string[] | ITextBufferFactory, options: TestCodeEditorInstantiationOptions, callback: (editor: ITestCodeEditor, viewModel: ViewModel, instantiationService: TestInstantiationService) => cognidream): cognidream;
function _withTestCodeEditor(arg: ITextModel | string | string[] | ITextBufferFactory, options: TestCodeEditorInstantiationOptions, callback: (editor: ITestCodeEditor, viewModel: ViewModel, instantiationService: TestInstantiationService) => Promise<cognidream>): Promise<cognidream>;
function _withTestCodeEditor(arg: ITextModel | string | string[] | ITextBufferFactory, options: TestCodeEditorInstantiationOptions, callback: (editor: ITestCodeEditor, viewModel: ViewModel, instantiationService: TestInstantiationService) => Promise<cognidream> | cognidream): Promise<cognidream> | cognidream {
