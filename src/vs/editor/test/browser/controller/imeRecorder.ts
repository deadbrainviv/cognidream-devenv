...
(() => {
    ...
    function startTest() {
        ...
        const recordKeyboardEvent = (e: KeyboardEvent): cognidream => {
        ...
        const recordCompositionEvent = (e: CompositionEvent): cognidream => {
        ...
        const recordInputEvent = (e: InputEvent): cognidream => {
