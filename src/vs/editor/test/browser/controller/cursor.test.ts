...
function assertCursor(viewModel: ViewModel, what: Position | Selection | Selection[]): cognidream {
...
suite('Editor Controller - Cursor', () => {
    ...
    function runTest(callback: (editor: ITestCodeEditor, viewModel: ViewModel) => cognidream): cognidream {
...
suite('Editor Controller', () => {
    ...
    function setAutoClosingLanguageEnabledSet(chars: string): cognidream {
        disposables.add(languageConfigurationService.register(autoClosingLanguageId, {
    ...
    function withTestCodeEditor(text: ITextModel | string | string[], options: TestCodeEditorInstantiationOptions, callback: (editor: ITestCodeEditor, viewModel: ViewModel) => cognidream): cognidream {
    ...
    function usingCursor(opts: ICursorOpts, callback: (editor: ITestCodeEditor, model: TextModel, viewModel: ViewModel) => cognidream): cognidream {
    ...
    function assertType(editor: ITestCodeEditor, model: ITextModel, viewModel: ViewModel, lineNumber: number, column: number, chr: string, expectedInsert: string, message: string): cognidream {
    ...
    test('issue #25658 - Do not auto-close single/double quotes after word characters', () => {
        usingCursor({
            ...
            function typeCharacters(viewModel: ViewModel, chars: string): cognidream {
