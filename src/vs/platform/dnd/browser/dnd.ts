...
export interface IDragAndDropContributionRegistry {
	 ...
	 */
	register(contribution: IDragAndDropContribution): cognidream;
...
interface IDragAndDropContribution {
	...
	setData(resources: IResourceStat[], event: DragMouseEvent | DragEvent): cognidream;
}
...
export class LocalSelectionTransfer<T> {
	...
	setData(data: T[], proto: T): cognidream {
		if (proto) {
			this.data = data;
			this.proto = proto;
		}
...
export function fillInSymbolsDragData(symbolsData: readonly DocumentSymbolTransferData[], e: DragEvent): cognidream {
...
export function fillInMarkersDragData(markerData: MarkerTransferData[], e: DragEvent): cognidream {
