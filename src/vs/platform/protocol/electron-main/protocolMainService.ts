...
type ProtocolCallback = { (result: string | Electron.FilePathWithHeaders | { error: number }): cognidream };
...
export class ProtocolMainService extends Disposable implements IProtocolMainService {
	...
	private handleProtocols(): cognidream {
	...
	private handleResourceRequest(request: Electron.ProtocolRequest, callback: ProtocolCallback): cognidream {
