...
export class PtyHostService extends Disposable implements IPtyHostService {
	...
	private readonly _onPtyHostStart = this._register(new Emitter<cognidream>());
	readonly onPtyHostStart = this._onPtyHostStart.event;
	private readonly _onPtyHostUnresponsive = this._register(new Emitter<cognidream>());
	readonly onPtyHostUnresponsive = this._onPtyHostUnresponsive.event;
	private readonly _onPtyHostResponsive = this._register(new Emitter<cognidream>());
	...
	private async _refreshIgnoreProcessNames(): Promise<cognidream> {
	...
	async updateProperty<T extends ProcessPropertyType>(id: number, property: T, value: IProcessPropertyMap[T]): Promise<cognidream> {
		return this._proxy.updateProperty(id, property, value);
	}

	async restartPtyHost(): Promise<cognidream> {
		this._disposePtyHost();
		this._isResponsive = true;
		this._startPtyHost();
	}

	private _disposePtyHost(): cognidream {
