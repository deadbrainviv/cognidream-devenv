...
export class ShellIntegrationAddon extends Disposable implements IShellIntegration, ITerminalAddon {
	...
	private _disposeCommonProtocol(): cognidream {
	...
	private async _ensureCapabilitiesOrAddFailureTelemetry(): Promise<cognidream> {
	...
	private _clearActivationTimeout(): cognidream {
