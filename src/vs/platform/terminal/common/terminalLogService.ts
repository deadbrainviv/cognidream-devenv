...
export class TerminalLogService extends Disposable implements ITerminalLogService {
	...
	setLevel(level: LogLevel): cognidream { this._logger.setLevel(level); }
	flush(): cognidream { this._logger.flush(); }

	trace(message: string, ...args: any[]): cognidream { this._logger.trace(this._formatMessage(message), args); }
	debug(message: string, ...args: any[]): cognidream { this._logger.debug(this._formatMessage(message), args); }
	info(message: string, ...args: any[]): cognidream { this._logger.info(this._formatMessage(message), args); }
	warn(message: string, ...args: any[]): cognidream { this._logger.warn(this._formatMessage(message), args); }
	error(message: string | Error, ...args: any[]): cognidream {
