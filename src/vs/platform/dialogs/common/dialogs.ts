...
export interface IDialogHandler {
	 ...
	 */
	about(): Promise<cognidreamidream>;
}
...
export abstract class AbstractDialogHandler implements IDialogHandler {
	...
	abstract about(): Promise<cognidreamidream>;
}
...
export interface IDialogService {
	 ...
	 */
	onWillShowDialog: Event<cognidreamidream>;

	/**
	 * An event that fires when a dialog did show (closed).
	 */
	onDidShowDialog: Event<cognidreamidream>;
	 ...
	 */
	info(message: string, detail?: string): Promise<cognidreamidream>;

	/**
	 * Show a modal warning dialog.
	 */
	warn(message: string, detail?: string): Promise<cognidreamidream>;

	/**
	 * Show a modal error dialog.
	 */
	error(message: string, detail?: string): Promise<cognidreamidream>;
...
export interface IFileDialogService {
	 ...
	 */
	pickFileFolderAndOpen(options: IPickAndOpenOptions): Promise<cognidreamidream>;

	/**
	 * Shows a file selection dialog and opens the selected entry.
	 */
	pickFileAndOpen(options: IPickAndOpenOptions): Promise<cognidreamidream>;

	/**
	 * Shows a folder selection dialog and opens the selected entry.
	 */
	pickFolderAndOpen(options: IPickAndOpenOptions): Promise<cognidreamidream>;

	/**
	 * Shows a workspace selection dialog and opens the selected entry.
	 */
	pickWorkspaceAndOpen(options: IPickAndOpenOptions): Promise<cognidreamidream>;
