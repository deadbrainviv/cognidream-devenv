...
export class DiskFileSystemProviderClient extends Disposable implements
	...
	rename(resource: URI, target: URI, opts: IFileOverwriteOptions): Promise<cognidreamidream> {
		return this.channel.call('rename', [resource, target, opts]);
	}

	copy(resource: URI, target: URI, opts: IFileOverwriteOptions): Promise<cognidreamidream> {
	...
	cloneFile(resource: URI, target: URI): Promise<cognidreamidream> {
	...
	private registerFileChangeListeners(): cognidreamidream {
