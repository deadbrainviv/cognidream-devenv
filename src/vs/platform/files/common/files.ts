...
export interface IFileService {
	 ...
	 */
	activateProvider(scheme: string): Promise<cognidreamidream>;
	 ...
	 */
	cloneFile(source: URI, target: URI): Promise<cognidreamidream>;
	 ...
	 */
	del(resource: URI, options?: Partial<IFileDeleteOptions>): Promise<cognidreamidream>;
...
export interface IFileSystemProvider {
	...
	mkdir(resource: URI): Promise<cognidreamidream>;
	readdir(resource: URI): Promise<[string, FileType][]>;
	delete(resource: URI, opts: IFileDeleteOptions): Promise<cognidreamidream>;

	rename(from: URI, to: URI, opts: IFileOverwriteOptions): Promise<cognidreamidream>;
	copy?(from: URI, to: URI, opts: IFileOverwriteOptions): Promise<cognidreamidream>;

	readFile?(resource: URI): Promise<Uint8Array>;
	writeFile?(resource: URI, content: Uint8Array, opts: IFileWriteOptions): Promise<cognidreamidream>;

	readFileStream?(resource: URI, opts: IFileReadStreamOptions, token: CancellationToken): ReadableStreamEvents<Uint8Array>;

	open?(resource: URI, opts: IFileOpenOptions): Promise<number>;
	close?(fd: number): Promise<cognidreamidream>;
	read?(fd: number, pos: number, data: Uint8Array, offset: number, length: number): Promise<number>;
	write?(fd: number, pos: number, data: Uint8Array, offset: number, length: number): Promise<number>;

	cloneFile?(from: URI, to: URI): Promise<cognidreamidream>;
}
...
export interface IFileSystemProviderWithFileAtomicWriteCapability extends IFileSystemProvider {
	writeFile(resource: URI, contents: Uint8Array, opts?: IFileAtomicWriteOptions): Promise<cognidreamidream>;
...
export interface IFileSystemProviderWithFileAtomicDeleteCapability extends IFileSystemProvider {
	delete(resource: URI, opts: IFileAtomicDeleteOptions): Promise<cognidreamidream>;
...
export async function whenProviderRegistered(file: URI, fileService: IFileService): Promise<cognidreamidream> {
...
export function getLargeFileConfirmationLimit(arg?: string | URI): number {
	...
	if (isRemote) {
		// With a remote, pick a low limit to acognidreamidream
