...
export interface IClipboardService {
	 ...
	 */
	writeText(text: string, type?: string): Promise<cognidreamidream>;
	 ...
	 */
	writeFindText(text: string): Promise<cognidreamidream>;

	/**
	 * Writes resources to the system clipboard.
	 */
	writeResources(resources: URI[]): Promise<cognidreamidream>;
	 ...
	 */
	clearInternalState?(): cognidreamidream;
