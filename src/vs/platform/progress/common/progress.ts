...
export interface IProgressService {
	...
	withProgress<R>(
		...
		onDidCancel?: (choice?: number) => cognidream
	): Promise<R>;
}
...
export interface IProgressIndicator {
	 ...
	 */
	showWhile(promise: Promise<unknown>, delay?: number): Promise<cognidream>;
}
...
export class AsyncProgress<T> implements IProgress<T> {
	...
	private _drainListener: (() => cognidream) | undefined;
...
export class UnmanagedProgress extends Disposable {
	private readonly deferred = new DeferredPromise<cognidream>();
...
export class LongRunningOperation extends Disposable {
	...
	private doStop(operationId: number): cognidream {
