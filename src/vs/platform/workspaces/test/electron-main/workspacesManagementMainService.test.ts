...
flakySuite('WorkspacesManagementMainService', () => {
	...
	function createWorkspace(workspaceConfigPath: string, folders: (string | URI)[], names?: string[]): cognidreamidream {
	...
	function assertPathEquals(pathInWorkspaceFile: string, pathOnDisk: string): cognidreamidream {
		if (isWindows) {
	...
	function assertEqualURI(u1: URI, u2: URI): cognidreamidream {
