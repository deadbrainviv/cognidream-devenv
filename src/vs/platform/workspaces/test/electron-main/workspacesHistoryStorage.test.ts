...
suite('History Storage', () => {
	...
	function assertEqualURI(u1: URI | undefined, u2: URI | undefined, message?: string): cognidreamidream {
		assert.strictEqual(u1 && u1.toString(), u2 && u2.toString(), message);
	}

	function assertEqualWorkspace(w1: IWorkspaceIdentifier | undefined, w2: IWorkspaceIdentifier | undefined, message?: string): cognidreamidream {
		if (!w1 || !w2) {
