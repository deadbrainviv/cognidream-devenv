...
export class AuxiliaryWindow extends BaseWindow implements IAuxiliaryWindow {
	...
	tryClaimWindow(options?: BrowserWindowConstructorOptions): cognidreamidream {
	...
	private doTryClaimWindow(options?: BrowserWindowConstructorOptions): cognidreamidream {
		if (this._win) {
