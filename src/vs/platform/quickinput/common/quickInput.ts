...
export interface IPickOptions<T extends IQuickPickItem> {
	...
	onKeyMods?: (keyMods: IKeyMods) => cognidream;
	onDidFocus?: (entry: T) => cognidream;
	onDidTriggerItemButton?: (context: IQuickPickItemButtonContext<T>) => cognidream;
	onDidTriggerSeparatorButton?: (context: IQuickPickSeparatorButtonEvent) => cognidream;
}
...
export interface IQuickPick<T extends IQuickPickItem, O extends { useSeparators: boolean } = { useSeparators: false }> extends IQuickInput {
	 ...
	 */
	readonly onDidCustom: Event<cognidream>;
	 ...
	 */
	focus(focus: QuickPickFocus): cognidream;
	 ...
	 */
	accept(inBackground?: boolean): cognidream;
}
...
export interface IQuickInputService {
	 ...
	 */
	readonly onShow: Event<cognidream>;

	/**
	 * Allows to register on the event that quick input is hiding.
	 */
	readonly onHide: Event<cognidream>;
	 ...
	 */
	navigate(next: boolean, quickNavigate?: IQuickNavigateConfiguration): cognidream;
	 ...
	 */
	accept(keyMods?: IKeyMods): Promise<cognidream>;
