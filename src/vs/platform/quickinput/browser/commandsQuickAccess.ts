...
export class CommandsHistory extends Disposable {
	...
	private updateConfiguration(e?: IConfigurationChangeEvent): cognidream {
	...
	push(commandId: string): cognidream {
	...
	static clearHistory(configurationService: IConfigurationService, storageService: IStorageService): cognidream {
