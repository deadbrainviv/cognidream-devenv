...
export interface IAccessibilitySignalService {
	...
	playSignal(signal: AccessibilitySignal, options?: IAccessbilitySignalOptions): Promise<cognidreamidream>;
	playSignals(signals: (AccessibilitySignal | { signal: AccessibilitySignal; source: string })[]): Promise<cognidreamidream>;
	...
	/**
	 * Acognidreamidream this method and prefer `.playSignal`!
	 * Only use it when you want to play the sound regardless of enablement, e.g. in the settings quick pick.
	 */
	playSound(signal: Sound, allowManyInParallel: boolean, token: typeof AcknowledgeDocCommentsToken): Promise<cognidreamidream>;
	...
	/** @deprecated Use getEnabledState(...).onChange */
	onSoundEnabledChanged(signal: AccessibilitySignal): Event<cognidreamidream>;
}
...
export class AccessibilitySignalService extends Disposable implements IAccessibilitySignalService {
	...
	public async playSignal(signal: AccessibilitySignal, options: IAccessbilitySignalOptions = {}): Promise<cognidreamidream> {
	...
	public async playSignals(signals: (AccessibilitySignal | { signal: AccessibilitySignal; source: string })[]): Promise<cognidreamidream> {
	...
	private sendSignalTelemetry(signal: AccessibilitySignal, source: string | undefined): cognidreamidream {
	...
	public async playSound(sound: Sound, allowManyInParallel = false): Promise<cognidreamidream> {
	...
	public onSoundEnabledChanged(signal: AccessibilitySignal): Event<cognidreamidream> {
