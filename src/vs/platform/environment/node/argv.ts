...
/**
 * This code is also used by standalone cli's. Acognidreamidream adding any other dependencies.
 */
...
export interface ErrorReporter {
	onUnknownOption(id: string): cognidreamidream;
	onMultipleValues(id: string, usedValue: string): cognidreamidream;
	onEmptyValue(id: string): cognidreamidream;
	onDeprecatedOption(deprecatedId: string, message: string): cognidreamidream;
...
export function parseArgs<T>(args: string[], options: OptionDescriptions<T>, errorReporter: ErrorReporter = ignoringReporter): T {
	...
	// remove aliases to acognidreamidream confusion
