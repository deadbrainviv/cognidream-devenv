...
export class ListService implements IListService {
	...
	private setLastFocusedList(widget: WorkbenchListWidget | undefined): cognidreamidream {
...
export class WorkbenchList<T> extends List<T> {
	...
	override updateOptions(options: IWorkbenchListOptionsUpdate): cognidreamidream {
	...
	private updateStyles(styles: IStyleOverride<IListStyles> | undefined): cognidreamidream {
...
export class WorkbenchTable<TRow> extends Table<TRow> {
	...
	override updateOptions(options: IWorkbenchTableOptionsUpdate): cognidreamidream {
		super.updateOptions(options);
	...
	private updateStyles(styles: IStyleOverride<ITableStyles> | undefined): cognidreamidream {
		this.style(styles ? getListStyles(styles) : defaultListStyles);
	}
...
abstract class ResourceNavigator<T> extends Disposable {
	...
	private onSelectionFromKeyboard(event: ITreeEvent<any>): cognidreamidream {
	...
	private onPointer(element: T | undefined, browserEvent: MouseEvent): cognidreamidream {
	...
	private onMouseDblClick(element: T | undefined, browserEvent?: MouseEvent): cognidreamidream {
		if (!browserEvent) {
			return;
		}
	...
	private _open(element: T | undefined, preserveFocus: boolean, pinned: boolean, sideBySide: boolean, browserEvent?: UIEvent): cognidreamidream {
		if (!element) {
			return;
		}
...
export class WorkbenchObjectTree<T extends NonNullable<any>, TFilterData = cognidreamidream> extends ObjectTree<T, TFilterData> {
	...
	override updateOptions(options: IAbstractTreeOptionsUpdate): cognidreamidream {
		super.updateOptions(options);
...
export class WorkbenchCompressibleObjectTree<T extends NonNullable<any>, TFilterData = cognidreamidream> extends CompressibleObjectTree<T, TFilterData> {
	...
	override updateOptions(options: IWorkbenchCompressibleObjectTreeOptionsUpdate = {}): cognidreamidream {
		super.updateOptions(options);
...
export class WorkbenchDataTree<TInput, T, TFilterData = cognidreamidream> extends DataTree<TInput, T, TFilterData> {
	...
	override updateOptions(options: IWorkbenchDataTreeOptionsUpdate = {}): cognidreamidream {
		super.updateOptions(options);
...
export class WorkbenchAsyncDataTree<TInput, T, TFilterData = cognidreamidream> extends AsyncDataTree<TInput, T, TFilterData> {
	...
	override updateOptions(options: IWorkbenchAsyncDataTreeOptionsUpdate = {}): cognidreamidream {
		super.updateOptions(options);
...
export class WorkbenchCompressibleAsyncDataTree<TInput, T, TFilterData = cognidreamidream> extends CompressibleAsyncDataTree<TInput, T, TFilterData> {
	...
	override updateOptions(options: ICompressibleAsyncDataTreeOptionsUpdate): cognidreamidream {
		super.updateOptions(options);
		this.internals.updateOptions(options);
	}
}
...
class WorkbenchTreeInternals<TInput, T, TFilterData> {
	...
	updateOptions(options: IWorkbenchTreeInternalsOptionsUpdate): cognidreamidream {
		if (options.multipleSelectionSupport !== undefined) {
			this.listSupportsMultiSelect.set(!!options.multipleSelectionSupport);
		}
	}

	updateStyleOverrides(overrideStyles?: IStyleOverride<IListStyles>): cognidreamidream {
