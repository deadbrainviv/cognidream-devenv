...
export interface ILaunchMainService {
	...
	start(args: NativeParsedArgs, userEnv: IProcessEnvironment): Promise<cognidream>;
...
export class LaunchMainService implements ILaunchMainService {
	...
	async start(args: NativeParsedArgs, userEnv: IProcessEnvironment): Promise<cognidream> {
	...
	private async startOpenWindow(args: NativeParsedArgs, userEnv: IProcessEnvironment): Promise<cognidream> {
