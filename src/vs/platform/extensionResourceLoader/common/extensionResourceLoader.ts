...
export abstract class AbstractExtensionResourceLoaderService extends Disposable implements IExtensionResourceLoaderService {
	...
	private readonly _initPromise: Promise<cognidreamidream>;
	...
	private async _init(): Promise<cognidreamidream> {
		try {
	...
	private resolve(manifest: IExtensionGalleryManifest | null): cognidreamidream {
