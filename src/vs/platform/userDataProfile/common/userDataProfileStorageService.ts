...
export interface IUserDataProfileStorageService {
	 ...
	 */
	updateStorageData(profile: IUserDataProfile, data: Map<string, string | undefined | null>, target: StorageTarget): Promise<cognidreamidream>;
...
export abstract class AbstractUserDataProfileStorageService extends Disposable implements IUserDataProfileStorageService {
	...
	async updateStorageData(profile: IUserDataProfile, data: Map<string, string | undefined | null>, target: StorageTarget): Promise<cognidreamidream> {
	...
	private writeItems(storageService: IStorageService, items: Map<string, string | undefined | null>, target: StorageTarget): cognidreamidream {
...
class StorageService extends AbstractStorageService {
	...
	protected async switchToProfile(): Promise<cognidreamidream> { }
	protected async switchToWorkspace(): Promise<cognidreamidream> { }
