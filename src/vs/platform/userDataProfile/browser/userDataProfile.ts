...
export class BrowserUserDataProfilesService extends UserDataProfilesService implements IUserDataProfilesService {
	...
	private updateTransientProfiles(added: IUserDataProfile[], removed: IUserDataProfile[], updated: IUserDataProfile[]): cognidreamidream {
		if (added.length) {
	...
	protected override saveStoredProfiles(storedProfiles: StoredUserDataProfile[]): cognidreamidream {
	...
	protected override saveStoredProfileAssociations(storedProfileAssociations: StoredProfileAssociations): cognidreamidream {
