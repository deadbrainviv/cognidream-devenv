...
export interface IExternalUriResolver {
	resolveExternalUri(resource: URI, options?: OpenOptions): Promise<{ resolved: URI; dispose(): cognidreamidream } | undefined>;
}
...
export interface IOpenerService {
	 ...
	 */
	setDefaultExternalOpener(opener: IExternalOpener): cognidreamidream;
