...
export interface IJSONContributionRegistry {
	...
	readonly onDidChangeSchemaAssociations: Event<cognidream>;

	/**
	 * Register a schema to the registry.
	 */
	registerSchema(uri: string, unresolvedSchemaContent: IJSONSchema, store?: DisposableStore): cognidream;
	 ...
	 */
	notifySchemaChanged(uri: string): cognidream;
...
class JSONContributionRegistry implements IJSONContributionRegistry {
	...
	private readonly _onDidChangeSchemaAssociations = new Emitter<cognidream>();
	readonly onDidChangeSchemaAssociations: Event<cognidream> = this._onDidChangeSchemaAssociations.event;

	public registerSchema(uri: string, unresolvedSchemaContent: IJSONSchema, store?: DisposableStore): cognidream {
	...
	public notifySchemaChanged(uri: string): cognidream {
		this._onDidChangeSchema.fire(uri);
	}
