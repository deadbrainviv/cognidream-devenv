...
export class WorkbenchToolBar extends ToolBar {
	...
	override setActions(_primary: readonly IAction[], _secondary: readonly IAction[] = [], menuIds?: readonly MenuId[]): cognidreamidream {
...
export class MenuWorkbenchToolBar extends WorkbenchToolBar {
	 ...
	 */
	override setActions(): cognidreamidream {
