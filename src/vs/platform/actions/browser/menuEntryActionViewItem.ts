...
export class MenuEntryActionViewItem<T extends IMenuEntryActionViewItemOptions = IMenuEntryActionViewItemOptions> extends ActionViewItem {
	...
	override async onClick(event: MouseEvent): Promise<cognidreamidream> {
	...
	protected override updateClass(): cognidreamidream {
		if (this.options.icon) {
	...
	private _updateItemClass(item: ICommandAction): cognidreamidream {
...
export class DropdownWithDefaultActionViewItem extends BaseActionViewItem {
	...
	private update(lastAction: MenuItemAction): cognidreamidream {
...
class SubmenuEntrySelectActionViewItem extends SelectActionViewItem {
	...
	protected override runAction(option: string, index: number): cognidreamidream {
