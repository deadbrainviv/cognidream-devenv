...
export interface IMenuService {
	 ...
	 */
	resetHiddenStates(menuIds: readonly MenuId[] | undefined): cognidreamidream;
}
...
export class MenuItemAction implements IAction {
	...
	run(...args: any[]): Promise<cognidreamidream> {
		let runArgs: any[] = [];
...
export abstract class Action2 {
	...
	abstract run(accessor: ServicesAccessor, ...args: any[]): cognidreamidream;
}
