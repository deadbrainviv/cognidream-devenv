...
export class ContextMenuService extends Disposable implements IContextMenuService {
	...
	private readonly _onDidShowContextMenu = this._store.add(new Emitter<cognidreamidream>());
	readonly onDidShowContextMenu = this._onDidShowContextMenu.event;

	private readonly _onDidHideContextMenu = this._store.add(new Emitter<cognidreamidream>());
