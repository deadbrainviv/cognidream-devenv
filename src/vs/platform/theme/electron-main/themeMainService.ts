...
export interface IThemeMainService {
	...
	saveWindowSplash(windowId: number | undefined, workspace: IBaseWorkspaceIdentifier | undefined, splash: IPartsSplash): cognidreamidream;
...
export class ThemeMainService extends Disposable implements IThemeMainService {
	...
	private updateSystemColorTheme(): cognidreamidream {
	...
	private updateBackgroundColor(windowId: number, splash: IPartsSplash): cognidreamidream {
