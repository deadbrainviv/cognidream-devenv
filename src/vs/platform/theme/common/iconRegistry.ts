...
export interface IIconRegistry {
	 ...
	 */
	deregisterIcon(id: IconIdentifier): cognidreamidream;
	 ...
	 */
	deregisterIconFont(id: string): cognidreamidream;
...
class IconRegistry implements IIconRegistry {
	...
	public deregisterIcon(id: string): cognidreamidream {
	...
	public deregisterIconFont(id: string): cognidreamidream {
