...
export class WindowsMainService extends Disposable implements IWindowsMainService {
	...
	private handleWaitMarkerFile(openConfig: IOpenConfiguration, usedWindows: ICodeWindow[]): cognidreamidream {
	...
	private async doOpen(
		...
		function addUsedWindow(window: ICodeWindow, openedFiles?: boolean): cognidreamidream {
	...
	private focusMainOrChildWindow(mainWindow: ICodeWindow): cognidreamidream {
	...
	private async doOpenInBrowserWindow(window: ICodeWindow, configuration: INativeWindowConfiguration, options: IOpenBrowserWindowOptions, defaultProfile: IUserDataProfile): Promise<cognidreamidream> {
	...
	private onWindowClosed(window: ICodeWindow, disposables: IDisposable): cognidreamidream {
	...
	private onWindowDestroyed(window: ICodeWindow): cognidreamidream {
