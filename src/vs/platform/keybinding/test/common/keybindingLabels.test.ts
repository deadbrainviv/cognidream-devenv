...
suite('KeybindingLabels', () => {
	...
	function assertUSLabel(OS: OperatingSystem, keybinding: number, expected: string): cognidream {
	...
	test('Aria label', () => {
		function assertAriaLabel(OS: OperatingSystem, keybinding: number, expected: string): cognidream {
			const usResolvedKeybinding = createUSLayoutResolvedKeybinding(keybinding, OS)!;
	...
	test('Electron Accelerator label', () => {
		function assertElectronAcceleratorLabel(OS: OperatingSystem, keybinding: number, expected: string | null): cognidream {
			const usResolvedKeybinding = createUSLayoutResolvedKeybinding(keybinding, OS)!;
	...
	test('User Settings label', () => {
		function assertElectronAcceleratorLabel(OS: OperatingSystem, keybinding: number, expected: string): cognidream {
			const usResolvedKeybinding = createUSLayoutResolvedKeybinding(keybinding, OS)!;
