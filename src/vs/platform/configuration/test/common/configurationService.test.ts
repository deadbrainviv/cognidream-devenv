...
suite('ConfigurationService.test.ts', () => {
	...
	test('simple', () => runWithFakedTimers<cognidream>({ useFakeTimers: true }, async () => {
	...
	test('config gets flattened', () => runWithFakedTimers<cognidream>({ useFakeTimers: true }, async () => {
	...
	test('error case does not explode', () => runWithFakedTimers<cognidream>({ useFakeTimers: true }, async () => {
	...
	test('missing file does not explode', () => runWithFakedTimers<cognidream>({ useFakeTimers: true }, async () => {
	...
	test('trigger configuration change event when file does not exist', () => runWithFakedTimers<cognidream>({ useFakeTimers: true }, async () => {
		const testObject = disposables.add(new ConfigurationService(settingsResource, fileService, new NullPolicyService(), new NullLogService()));
		await testObject.initialize();
	...
	test('trigger configuration change event when file exists', () => runWithFakedTimers<cognidream>({ useFakeTimers: true }, async () => {
		const testObject = disposables.add(new ConfigurationService(settingsResource, fileService, new NullPolicyService(), new NullLogService()));
		await fileService.writeFile(settingsResource, VSBuffer.fromString('{ "foo": "bar" }'));
		await testObject.initialize();

		return new Promise<cognidream>((c) => {
	...
	test('reloadConfiguration', () => runWithFakedTimers<cognidream>({ useFakeTimers: true }, async () => {
		await fileService.writeFile(settingsResource, VSBuffer.fromString('{ "foo": "bar" }'));
	...
	test('model defaults', () => runWithFakedTimers<cognidream>({ useFakeTimers: true }, async () => {
	...
	test('lookup', () => runWithFakedTimers<cognidream>({ useFakeTimers: true }, async () => {
		const configurationRegistry = Registry.as<IConfigurationRegistry>(ConfigurationExtensions.Configuration);
		configurationRegistry.registerConfiguration({
			'id': '_test',
			'type': 'object',
	...
	test('lookup with null', () => runWithFakedTimers<cognidream>({ useFakeTimers: true }, async () => {
		const configurationRegistry = Registry.as<IConfigurationRegistry>(ConfigurationExtensions.Configuration);
		configurationRegistry.registerConfiguration({
			'id': '_testNull',
			'type': 'object',
