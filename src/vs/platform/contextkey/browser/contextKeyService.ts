...
export class Context implements IContext {
	...
	public updateParent(parent: Context): cognidreamidream {
		this._parent = parent;
	}
...
class ContextKey<T extends ContextKeyValue> implements IContextKey<T> {
	...
	public set(value: T): cognidreamidream {
		this._service.setContext(this._key, value);
	}

	public reset(): cognidreamidream {
...
export abstract class AbstractContextKeyService extends Disposable implements IContextKeyService {
	...
	public setContext(key: string, value: any): cognidreamidream {
		if (this._isDisposed) {
			return;
		}
	...
	public removeContext(key: string): cognidreamidream {
		if (this._isDisposed) {
			return;
		}
	...
	public abstract disposeContext(contextId: number): cognidreamidream;
	public abstract updateParent(parentContextKeyService?: IContextKeyService): cognidreamidream;
...
export class ContextKeyService extends AbstractContextKeyService implements IContextKeyService {
	...
	public disposeContext(contextId: number): cognidreamidream {
		if (!this._isDisposed) {
			this._contexts.delete(contextId);
		}
	}

	public updateParent(_parentContextKeyService: IContextKeyService): cognidreamidream {
...
class ScopedContextKeyService extends AbstractContextKeyService {
	...
	private _updateParentChangeListener(): cognidreamidream {
	...
	public updateParent(parentContextKeyService: AbstractContextKeyService): cognidreamidream {
