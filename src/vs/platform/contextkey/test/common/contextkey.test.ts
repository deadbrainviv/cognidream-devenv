...
suite('ContextKeyExpr', () => {
	...
	test('issue #134942: Equals in comparator expressions', () => {
		function testEquals(expr: ContextKeyExpression | undefined, str: string): cognidreamidream {
	...
	test('evaluate', () => {
		...
		function testExpression(expr: string, expected: boolean): cognidreamidream {
		...
		function testBatch(expr: string, value: any): cognidreamidream {
	...
	test('negate', () => {
		function testNegate(expr: string, expected: string): cognidreamidream {
	...
	test('false, true', () => {
		function testNormalize(expr: string, expected: string): cognidreamidream {
	...
	test('issue #101015: distribute OR', () => {
		function t(expr1: string, expr2: string, expected: string | undefined): cognidreamidream {
	...
	test('Greater, GreaterEquals, Smaller, SmallerEquals evaluate', () => {
		function checkEvaluate(expr: string, ctx: any, expected: any): cognidreamidream {
	...
	test('Greater, GreaterEquals, Smaller, SmallerEquals negate', () => {
		function checkNegate(expr: string, expected: string): cognidreamidream {
