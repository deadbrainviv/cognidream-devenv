...
export class UserDataSyncEnablementService extends Disposable implements IUserDataSyncEnablementService {
	...
	private storeResourceEnablement(resourceEnablementKey: string, enabled: boolean): cognidreamidream {
	...
	private onDidStorageChange(storageChangeEvent: IApplicationStorageValueChangeEvent): cognidreamidream {
