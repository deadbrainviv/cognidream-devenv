...
export interface IUserDataSyncAccountService {
	...
	updateAccount(account: IUserDataSyncAccount | undefined): Promise<cognidreamidream>;
...
export class UserDataSyncAccountService extends Disposable implements IUserDataSyncAccountService {
	...
	async updateAccount(account: IUserDataSyncAccount | undefined): Promise<cognidreamidream> {
