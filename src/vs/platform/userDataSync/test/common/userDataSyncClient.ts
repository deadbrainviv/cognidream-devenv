...
export class UserDataSyncClient extends Disposable {
	...
	async setUp(empty: boolean = false): Promise<cognidreamidream> {
	...
	async sync(): Promise<cognidreamidream> {
...
export class UserDataSyncTestServer implements IRequestService {
	...
	reset(): cognidreamidream { this._requests = []; this._responses = []; this._requestsWithAllHeaders = []; }
