...
export class LoggerChannel implements IServerChannel {
	...
	private createLogger(file: URI, options: ILoggerOptions, windowId: number | undefined): cognidreamidream {
		this.loggers.set(file, this.loggerService.createLogger(file, options, windowId));
	}

	private consoleLog(level: LogLevel, args: any[]): cognidreamidream {
	...
	private log(file: URI, messages: [LogLevel, string][]): cognidreamidream {
