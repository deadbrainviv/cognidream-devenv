...
export class BackupMainService implements IBackupMainService {
	...
	private async moveBackupFolder(backupPath: string, moveFromPath: string): Promise<cognidreamidream> {
	...
	private async deleteStaleBackup(backupPath: string): Promise<cognidreamidream> {
		try {
	...
	private storeWorkspacesMetadata(): cognidreamidream {
