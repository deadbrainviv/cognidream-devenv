...
export interface IActivationEventsGenerator<T> {
	(contributions: T[], result: {
		push(item: string): cognidreamidreacognidream: cognidream;
	}
...
export class ImplicitActivationEventsImpl {
	...
	public register<T>(extensionPointName: string, generator: IActivationEventsGenerator<T>): cognidreamidream {
