...
function setTelemetry(extension: IGalleryExtension, index: number, querySource?: string): cognidreamidream {
	/* __GDPR__FRAGMENT__
...
export abstract class AbstractExtensionGalleryService implements IExtensionGalleryService {
	...
	async reportStatistic(publisher: string, name: string, version: string, type: StatisticType): Promise<cognidreamidream> {
	...
	async download(extension: IGalleryExtension, location: URI, operation: InstallOperation): Promise<cognidreamidream> {
	...
	async downloadSignatureArchive(extension: IGalleryExtension, location: URI): Promise<cognidreamidream> {
