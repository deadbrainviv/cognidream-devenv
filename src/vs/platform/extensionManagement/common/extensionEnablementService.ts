...
export class GlobalExtensionEnablementService extends Disposable implements IGlobalExtensionEnablementService {
	...
	private _setDisabledExtensions(disabledExtensions: IExtensionIdentifier[]): cognidreamidream {
	...
	private _setExtensions(storageId: string, extensions: IExtensionIdentifier[]): cognidreamidream {
...
export class StorageManager extends Disposable {
	...
	set(key: string, value: IExtensionIdentifier[], scope: StorageScope): cognidreamidream {
	...
	private onDidStorageChange(storageChangeEvent: IProfileStorageValueChangeEvent): cognidreamidream {
	...
	private _set(key: string, value: string | undefined, scope: StorageScope): cognidreamidream {
		if (value) {
