...
export class ExtensionManagementCLI {
	...
	public async listExtensions(showVersions: boolean, category?: string, profileLocation?: URI): Promise<cognidreamidream> {
	...
	public async installExtensions(extensions: (string | URI)[], builtinExtensions: (string | URI)[], installOptions: InstallOptions, force: boolean): Promise<cognidreamidream> {
		const failed: string[] = [];
	...
	public async updateExtensions(profileLocation?: URI): Promise<cognidreamidream> {
	...
	private async installVSIX(vsix: URI, installOptions: InstallOptions, force: boolean, installedExtensions: ILocalExtension[]): Promise<cognidreamidream> {
	...
	public async uninstallExtensions(extensions: (string | URI)[], force: boolean, profileLocation?: URI): Promise<cognidreamidream> {
	...
	public async locateExtension(extensions: string[]): Promise<cognidreamidream> {
