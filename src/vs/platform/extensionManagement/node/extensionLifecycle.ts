...
export class ExtensionsLifecycle extends Disposable {
	...
	private processesLimiter: Limiter<cognidreamidream> = new Limiter(5); // Run max 5 processes in parallel
	...
	async postUninstall(extension: ILocalExtension): Promise<cognidreamidream> {
	...
	private runLifecycleHook(lifecycleHook: string, lifecycleType: string, args: string[], timeout: boolean, extension: ILocalExtension): Promise<cognidreamidream> {
		return new Promise<cognidreamidream>((c, e) => {
