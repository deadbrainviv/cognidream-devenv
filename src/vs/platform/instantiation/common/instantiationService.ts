...
export class InstantiationService implements IInstantiationService {
	...
	private _throwIfDisposed(): cognidream {
		if (this._isDisposed) {
	...
	private _setCreatedServiceInstance<T>(id: ServiceIdentifier<T>, instance: T): cognidream {
	...
	private _throwIfStrict(msg: string, printWarning: boolean): cognidream {
		if (printWarning) {
			console.warn(msg);
		}
		if (this._strict) {
