...
export interface IDiagnosticsService {
	...
	reportWorkspaceStats(workspace: IWorkspaceInformation): Promise<cognidreamidream>;
}
...
export class NullDiagnosticsService implements IDiagnosticsService {
	...
	async reportWorkspaceStats(workspace: IWorkspaceInformation): Promise<cognidreamidream> { }
