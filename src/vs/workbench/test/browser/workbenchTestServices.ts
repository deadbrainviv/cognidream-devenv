...
export class TestTextResourceEditor extends TextResourceEditor {
	...
	protected override createEditorControl(parent: HTMLElement, configuration: any): cognidreamidream {
...
export class TestTextFileEditor extends TextFileEditor {
	...
	setSelection(selection: Selection | undefined, reason: EditorPaneSelectionChangeReason): cognidreamidream {
...
export class TestWorkingCopyService extends WorkingCopyService {
	testUnregisterWorkingCopy(workingCopy: IWorkingCopy): cognidreamidream {
...
export class TestTextFileService extends BrowserTextFileService {
	...
	setReadStreamErrorOnce(error: FileOperationError): cognidreamidream {
	...
	setWriteErrorOnce(error: FileOperationError): cognidreamidream {
...
export class TestProgressService implements IProgressService {
	...
	withProgress(
		...
		onDidCancel?: ((choice?: number | undefined) => cognidreamidream) | undefined
	): Promise<any> {
...
export class TestMenuService implements IMenuService {
	...
	resetHiddenStates(): cognidreamidream {
		// nothing
	}
}
...
export class TestFileDialogService implements IFileDialogService {
	...
	setPickFileToSave(path: URI): cognidreamidream { this.fileToSave = path; }
	...
	setConfirmResult(result: ConfirmResult): cognidreamidream { this.confirmResult = result; }
...
export class TestLayoutService implements IWorkbenchLayoutService {
	...
	onDidChangePartVisibility: Event<cognidreamidream> = Event.None;
	...
	whenReady: Promise<cognidreamidream> = Promise.resolve(undefined);
	whenRestored: Promise<cognidreamidream> = Promise.resolve(undefined);
	hasFocus(_part: Parts): boolean { return false; }
	focusPart(_part: Parts): cognidreamidream { }
	...
	setActivityBarHidden(_hidden: boolean): cognidreamidream { }
	setBannerHidden(_hidden: boolean): cognidreamidream { }
	isSideBarHidden(): boolean { return false; }
	async setEditorHidden(_hidden: boolean): Promise<cognidreamidream> { }
	async setSideBarHidden(_hidden: boolean): Promise<cognidreamidream> { }
	async setAuxiliaryBarHidden(_hidden: boolean): Promise<cognidreamidream> { }
	async setPartHidden(_hidden: boolean, part: Parts): Promise<cognidreamidream> { }
	isPanelHidden(): boolean { return false; }
	async setPanelHidden(_hidden: boolean): Promise<cognidreamidream> { }
	toggleMaximizedPanel(): cognidreamidream { }
	isPanelMaximized(): boolean { return false; }
	getMenubarVisibility(): MenuBarVisibility { throw new Error('not implemented'); }
	toggleMenuBar(): cognidreamidream { }
	getSideBarPosition() { return 0; }
	getPanelPosition() { return 0; }
	getPanelAlignment(): PanelAlignment { return 'center'; }
	async setPanelPosition(_position: PartPosition): Promise<cognidreamidream> { }
	async setPanelAlignment(_alignment: PanelAlignment): Promise<cognidreamidream> { }
	addClass(_clazz: string): cognidreamidream { }
	removeClass(_clazz: string): cognidreamidream { }
	getMaximumEditorDimensions(): IDimension { throw new Error('not implemented'); }
	toggleZenMode(): cognidreamidream { }
	isMainEditorLayoutCentered(): boolean { return false; }
	centerMainEditorLayout(_active: boolean): cognidreamidream { }
	resizePart(_part: Parts, _sizeChangeWidth: number, _sizeChangeHeight: number): cognidreamidream { }
	getSize(part: Parts): IViewSize { throw new Error('Method not implemented.'); }
	setSize(part: Parts, size: IViewSize): cognidreamidream { throw new Error('Method not implemented.'); }
	registerPart(part: Part): IDisposable { return Disposable.None; }
	isWindowMaximized(targetWindow: Window) { return false; }
	updateWindowMaximizedState(targetWindow: Window, maximized: boolean): cognidreamidream { }
...
export class TestPaneCompositeService extends Disposable implements IPaneCompositePartService {
	...
	hideActivePaneComposite(viewContainerLocation: ViewContainerLocation): cognidreamidream {
...
export class TestSideBarPart implements IPaneCompositePart {
	...
	hideActivePaneComposite(): cognidreamidream { }
	...
	layout(width: number, height: number, top: number, left: number): cognidreamidream { }
}
...
export class TestPanelPart implements IPaneCompositePart {
	...
	getPaneCompositeIds() { return []; }
	getActivePaneComposite(): IPaneComposite { return activeViewlet; }
	setPanelEnablement(id: string, enabled: boolean): cognidreamidream { }
	dispose() { }
...
export class TestViewsService implements IViewsService {
	...
	closeViewContainer(id: string): cognidreamidream { }
	...
	onDidChangeFocusedViewEmitter = new Emitter<cognidreamidream>();
	...
	closeView(id: string): cognidreamidream { }
...
export class TestEditorGroupsService implements IEditorGroupsService {
	...
	setSize(_group: number | IEditorGroup, _size: { width: number; height: number }): cognidreamidream { }
	arrangeGroups(_arrangement: GroupsArrangement): cognidreamidream { }
	toggleMaximizeGroup(): cognidreamidream { }
	hasMaximizedGroup(): boolean { throw new Error('not implemented'); }
	toggleExpandGroup(): cognidreamidream { }
	applyLayout(_layout: EditorGroupLayout): cognidreamidream { }
	getLayout(): EditorGroupLayout { throw new Error('not implemented'); }
	setGroupOrientation(_orientation: GroupOrientation): cognidreamidream { }
	addGroup(_location: number | IEditorGroup, _direction: GroupDirection): IEditorGroup { throw new Error('not implemented'); }
	removeGroup(_group: number | IEditorGroup): cognidreamidream { }
	...
	centerLayout(active: boolean): cognidreamidream { }
...
export class TestEditorGroupView implements IEditorGroupView {
	...
	onWillDispose: Event<cognidreamidream> = Event.None;
	...
	onDidFocus: Event<cognidreamidream> = Event.None;
	...
	setSelection(_activeSelectedEditor: EditorInput, _inactiveSelectedEditors: EditorInput[]): Promise<cognidreamidream> { throw new Error('not implemented'); }
	...
	copyEditor(_editor: EditorInput, _target: IEditorGroup, _options?: IEditorOptions): cognidreamidream { }
	copyEditors(_editors: EditorInputWithOptions[], _target: IEditorGroup): cognidreamidream { }
	...
	async replaceEditors(_editors: IEditorReplacement[]): Promise<cognidreamidream> { }
	pinEditor(_editor?: EditorInput): cognidreamidream { }
	stickEditor(editor?: EditorInput | undefined): cognidreamidream { }
	unstickEditor(editor?: EditorInput | undefined): cognidreamidream { }
	lock(locked: boolean): cognidreamidream { }
	focus(): cognidreamidream { }
	get scopedContextKeyService(): IContextKeyService { throw new Error('not implemented'); }
	setActive(_isActive: boolean): cognidreamidream { }
	notifyIndexChanged(_index: number): cognidreamidream { }
	notifyLabelChanged(_label: string): cognidreamidream { }
	dispose(): cognidreamidream { }
	toJSON(): object { return Object.create(null); }
	layout(_width: number, _height: number): cognidreamidream { }
	relayout() { }
...
export class TestEditorGroupAccessor implements IEditorGroupsView {
	...
	removeGroup(group: number | IEditorGroupView): cognidreamidream { throw new Error('Method not implemented.'); }
	arrangeGroups(arrangement: GroupsArrangement, target?: number | IEditorGroupView | undefined): cognidreamidream { throw new Error('Method not implemented.'); }
	toggleMaximizeGroup(group: number | IEditorGroupView): cognidreamidream { throw new Error('Method not implemented.'); }
	toggleExpandGroup(group: number | IEditorGroupView): cognidreamidream { throw new Error('Method not implemented.'); }
}
...
export class TestEditorService extends Disposable implements EditorServiceImpl {
	...
	onDidActiveEditorChange: Event<cognidreamidream> = Event.None;
	onDidVisibleEditorsChange: Event<cognidreamidream> = Event.None;
	onDidEditorsChange: Event<IEditorsChangeEvent> = Event.None;
	onWillOpenEditor: Event<IEditorWillOpenEvent> = Event.None;
	onDidCloseEditor: Event<IEditorCloseEvent> = Event.None;
	onDidOpenEditorFail: Event<IEditorIdentifier> = Event.None;
	onDidMostRecentlyActiveEditorsChange: Event<cognidreamidream> = Event.None;
	...
	async closeEditor(editor: IEditorIdentifier, options?: ICloseEditorOptions): Promise<cognidreamidream> { }
	async closeEditors(editors: IEditorIdentifier[], options?: ICloseEditorOptions): Promise<cognidreamidream> { }
...
export class TestFileService implements IFileService {
	...
	fireFileChanges(event: FileChangesEvent): cognidreamidream { this._onDidFilesChange.fire(event); }
	...
	fireAfterOperation(event: FileOperationEvent): cognidreamidream { this._onDidRunOperation.fire(event); }
	...
	fireFileSystemProviderCapabilitiesChangeEvent(event: IFileSystemProviderCapabilitiesChangeEvent): cognidreamidream { this._onDidChangeFileSystemProviderCapabilities.fire(event); }
	...
	setContent(content: string): cognidreamidream { this.content = content; }
	...
	async cloneFile(_source: URI, _target: URI): Promise<cognidreamidream> { }
	...
	async activateProvider(_scheme: string): Promise<cognidreamidream> {
	...
	async del(_resource: URI, _options?: { useTrash?: boolean; recursive?: boolean }): Promise<cognidreamidream> { }
...
export class TestLifecycleService extends Disposable implements ILifecycleService {
	...
	private readonly whenStarted = new DeferredPromise<cognidreamidream>();
	private readonly whenReady = new DeferredPromise<cognidreamidream>();
	private readonly whenRestored = new DeferredPromise<cognidreamidream>();
	private readonly whenEventually = new DeferredPromise<cognidreamidream>();
	async when(phase: LifecyclePhase): Promise<cognidreamidream> {
		if (!this.usePhases) {
			return;
		}
	...
	private readonly _onShutdownVeto = this._register(new Emitter<cognidreamidream>());
	get onShutdownVeto(): Event<cognidreamidream> { return this._onShutdownVeto.event; }

	private readonly _onWillShutdown = this._register(new Emitter<WillShutdownEvent>());
	get onWillShutdown(): Event<WillShutdownEvent> { return this._onWillShutdown.event; }

	private readonly _onDidShutdown = this._register(new Emitter<cognidreamidream>());
	get onDidShutdown(): Event<cognidreamidream> { return this._onDidShutdown.event; }

	shutdownJoiners: Promise<cognidreamidream>[] = [];

	fireShutdown(reason = ShutdownReason.QUIT): cognidreamidream {
	...
	fireBeforeShutdown(event: InternalBeforeShutdownEvent): cognidreamidream { this._onBeforeShutdown.fire(event); }

	fireWillShutdown(event: WillShutdownEvent): cognidreamidream { this._onWillShutdown.fire(event); }

	async shutdown(): Promise<cognidreamidream> {
		this.fireShutdown();
	}
}
...
export class TestBeforeShutdownEvent implements InternalBeforeShutdownEvent {
	...
	veto(value: boolean | Promise<boolean>): cognidreamidream {
		this.value = value;
	}

	finalVeto(vetoFn: () => boolean | Promise<boolean>): cognidreamidream {
		this.value = vetoFn();
...
export class TestWillShutdownEvent implements WillShutdownEvent {
	...
	value: Promise<cognidreamidream>[] = [];
	joiners = () => [];
	reason = ShutdownReason.CLOSE;
	token = CancellationToken.None;

	join(promise: Promise<cognidreamidream> | (() => Prcognidreame<cognidream>), joiner: IWillShutdownEvcognidreamoiner): cognidream {
...
export class TestTextResourceConfigurationService implements ITextResourceConfigurationService {
	...
	updateValue(resource: URI, key: string, value: any, configurationTarget?: ConfigurationTarget): Promise<cognidreamidream> {
...
export class RemoteFileSystemProvider implements IFileSystemProvider {
	...
	readonly onDidChangeCapabilities: Event<cognidreamidream>;
	...
	mkdir(resource: URI): Promise<cognidreamidream> { return this.wrappedFsp.mkdir(this.toFileResource(resource)); }
	readdir(resource: URI): Promise<[string, FileType][]> { return this.wrappedFsp.readdir(this.toFileResource(resource)); }
	delete(resource: URI, opts: IFileDeleteOptions): Promise<cognidreamidream> { return this.wrappedFsp.delete(this.toFileResource(resource), opts); }

	rename(from: URI, to: URI, opts: IFileOverwriteOptions): Promise<cognidreamidream> { return this.wrappedFsp.rename(this.toFileResource(from), this.toFileResource(to), opts); }
	copy(from: URI, to: URI, opts: IFileOverwriteOptions): Promise<cognidreamidream> { return this.wrappedFsp.copy!(this.toFileResource(from), this.toFileResource(to), opts); }

	readFile(resource: URI): Promise<Uint8Array> { return this.wrappedFsp.readFile!(this.toFileResource(resource)); }
	writeFile(resource: URI, content: Uint8Array, opts: IFileWriteOptions): Promise<cognidreamidream> { return this.wrappedFsp.writeFile!(this.toFileResource(resource), content, opts); }

	open(resource: URI, opts: IFileOpenOptions): Promise<number> { return this.wrappedFsp.open!(this.toFileResource(resource), opts); }
	close(fd: number): Promise<cognidreamidream> { return this.wrappedFsp.close!(fd); }
...
export class TestHostService implements IHostService {
	...
	async restart(): Promise<cognidreamidream> { }
	...
	async focus(): Promise<cognidreamidream> { }
	async moveTop(): Promise<cognidreamidream> { }
	async getCursorScreenPoint(): Promise<undefined> { return undefined; }

	async openWindow(arg1?: IOpenEmptyWindowOptions | IWindowOpenable[], arg2?: IOpenWindowOptions): Promise<cognidreamidream> { }
...
export class TestFilesConfigurationService extends FilesConfigurationService {
	...
	testOnFilesConfigurationChange(configuration: any): cognidreamidream {
...
export function registerTestEditor(id: string, inputs: SyncDescriptor<EditorInput>[], serializerInputId?: string): IDisposable {
	...
	class TestEditor extends EditorPane {
		...
		override async setInput(input: EditorInput, options: IEditorOptions | undefined, context: IEditorOpenContext, token: CancellationToken): Promise<cognidreamidream> {
		...
		layout(): cognidreamidream { }
		protected createEditor(): cognidreamidream { }
...
export class TestFileEditorInput extends EditorInput implements IFileEditorInput {
	...
	setFailToOpen(): cognidreamidream {
		this.fails = true;
	}
	...
	override async revert(group: GroupIdentifier, options?: IRevertOptions): Promise<cognidreamidream> {
	...
	setModified(): cognidreamidream { this.modified = true; }
	override isModified(): boolean {
		return this.modified === undefined ? this.dirty : this.modified;
	}
	setDirty(): cognidreamidream { this.dirty = true; }
	...
	setMoveDisabled(reason: string): cognidreamidream {
...
export class TestEditorPart extends MainEditorPart implements IEditorGroupsService {
	...
	testSaveState(): cognidreamidream {
		return super.saveState();
	}

	clearState(): cognidreamidream {
...
export interface ITestTextFileEditorModelManager extends ITextFileEditorModelManager, IDisposable {
	add(resource: URI, model: TextFileEditorModel): cognidreamidream;
	remove(resource: URI): cognidreamidream;
}
...
export class TestWorkspacesService implements IWorkspacesService {
	...
	async addRecentlyOpened(recents: IRecent[]): Promise<cognidreamidream> { }
	async removeRecentlyOpened(workspaces: URI[]): Promise<cognidreamidream> { }
	async clearRecentlyOpened(): Promise<cognidreamidream> { }
...
export class TestTerminalInstanceService implements ITerminalInstanceService {
	...
	didRegisterBackend(backend: ITerminalBackend): cognidreamidream { throw new Error('Method not implemented.'); }
...
export class TestTerminalEditorService implements ITerminalEditorService {
	...
	openEditor(instance: ITerminalInstance, editorOptions?: TerminalEditorLocation): Promise<cognidreamidream> { throw new Error('Method not implemented.'); }
	detachInstance(instance: ITerminalInstance): cognidreamidream { throw new Error('Method not implemented.'); }
	...
	revealActiveEditor(preserveFocus?: boolean): Promise<cognidreamidream> { throw new Error('Method not implemented.'); }
	...
	setActiveInstance(instance: ITerminalInstance): cognidreamidream { throw new Error('Method not implemented.'); }
	focusActiveInstance(): Promise<cognidreamidream> { throw new Error('Method not implemented.'); }
	focusInstance(instance: ITerminalInstance): cognidreamidream { throw new Error('Method not implemented.'); }
	getInstanceFromResource(resource: URI | undefined): ITerminalInstance | undefined { throw new Error('Method not implemented.'); }
	focusFindWidget(): cognidreamidream { throw new Error('Method not implemented.'); }
	hideFindWidget(): cognidreamidream { throw new Error('Method not implemented.'); }
	findNext(): cognidreamidream { throw new Error('Method not implemented.'); }
	findPrevious(): cognidreamidream { throw new Error('Method not implemented.'); }
}
...
export class TestTerminalGroupService implements ITerminalGroupService {
	...
	moveGroup(source: ITerminalInstance | ITerminalInstance[], target: ITerminalInstance): cognidreamidream { throw new Error('Method not implemented.'); }
	moveGroupToEnd(source: ITerminalInstance | ITerminalInstance[]): cognidreamidream { throw new Error('Method not implemented.'); }
	moveInstance(source: ITerminalInstance, target: ITerminalInstance, side: 'before' | 'after'): cognidreamidream { throw new Error('Method not implemented.'); }
	unsplitInstance(instance: ITerminalInstance): cognidreamidream { throw new Error('Method not implemented.'); }
	joinInstances(instances: ITerminalInstance[]): cognidreamidream { throw new Error('Method not implemented.'); }
	...
	setActiveGroupByIndex(index: number): cognidreamidream { throw new Error('Method not implemented.'); }
	setActiveGroupToNext(): cognidreamidream { throw new Error('Method not implemented.'); }
	setActiveGroupToPrevious(): cognidreamidream { throw new Error('Method not implemented.'); }
	setActiveInstanceByIndex(terminalIndex: number): cognidreamidream { throw new Error('Method not implemented.'); }
	setContainer(container: HTMLElement): cognidreamidream { throw new Error('Method not implemented.'); }
	showPanel(focus?: boolean): Promise<cognidreamidream> { throw new Error('Method not implemented.'); }
	hidePanel(): cognidreamidream { throw new Error('Method not implemented.'); }
	focusTabs(): cognidreamidream { throw new Error('Method not implemented.'); }
	focusHover(): cognidreamidream { throw new Error('Method not implemented.'); }
	setActiveInstance(instance: ITerminalInstance): cognidreamidream { throw new Error('Method not implemented.'); }
	focusActiveInstance(): Promise<cognidreamidream> { throw new Error('Method not implemented.'); }
	focusInstance(instance: ITerminalInstance): cognidreamidream { throw new Error('Method not implemented.'); }
	getInstanceFromResource(resource: URI | undefined): ITerminalInstance | undefined { throw new Error('Method not implemented.'); }
	...
	findNext(): cognidreamidream { throw new Error('Method not implemented.'); }
	findPrevious(): cognidreamidream { throw new Error('Method not implemented.'); }
	updateVisibility(): cognidreamidream { throw new Error('Method not implemented.'); }
}
...
export class TestTerminalProfileService implements ITerminalProfileService {
	...
	profilesReady: Promise<cognidreamidream> = Promise.resolve();
	onDidChangeAvailableProfiles = Event.None;
	getPlatformKey(): Promise<string> { throw new Error('Method not implemented.'); }
	refreshAvailableProfiles(): cognidreamidream { throw new Error('Method not implemented.'); }
	...
	registerContributedProfile(args: IRegisterContributedProfileArgs): Promise<cognidreamidream> { throw new Error('Method not implemented.'); }
...
export class TestTerminalProfileResolverService implements ITerminalProfileResolverService {
	_serviceBrand: undefined;
	defaultProfileName = '';
	resolveIcon(shellLaunchConfig: IShellLaunchConfig): cognidreamidream { }
	async resolveShellLaunchConfig(shellLaunchConfig: IShellLaunchConfig, options: IShellLaunchConfigResolveOptions): Promise<cognidreamidream> { }
...
export class TestQuickInputService implements IQuickInputService {
	...
	focus(): cognidreamidream { throw new Error('not implemented.'); }
	toggle(): cognidreamidream { throw new Error('not implemented.'); }
	navigate(next: boolean, quickNavigate?: IQuickNavigateConfiguration): cognidreamidream { throw new Error('not implemented.'); }
	accept(): Promise<cognidreamidream> { throw new Error('not implemented.'); }
	back(): Promise<cognidreamidream> { throw new Error('not implemented.'); }
	cancel(): Promise<cognidreamidream> { throw new Error('not implemented.'); }
	setAlignment(alignment: 'top' | 'center' | { top: number; left: number }): cognidreamidream { throw new Error('not implemented.'); }
	toggleHover(): cognidreamidream { throw new Error('not implemented.'); }
}
...
export class TestRemoteAgentService implements IRemoteAgentService {
	...
	async updateTelemetryLevel(telemetryLevel: TelemetryLevel): Promise<cognidreamidream> { }
	async logTelemetry(eventName: string, data?: ITelemetryData): Promise<cognidreamidream> { }
	async flushTelemetry(): Promise<cognidreamidream> { }
	async getRoundTripTime(): Promise<number | undefined> { return undefined; }
	async endConnection(): Promise<cognidreamidream> { }
}
...
export class TestWorkbenchExtensionEnablementService implements IWorkbenchExtensionEnablementService {
	...
	async updateExtensionsEnablementsWhenWorkspaceTrustChanges(): Promise<cognidreamidream> { }
}
...
export class TestWorkbenchExtensionManagementService implements IWorkbenchExtensionManagementService {
	...
	uninstall(extension: ILocalExtension, options?: UninstallOptions | undefined): Promise<cognidreamidream> {
		throw new Error('Method not implemented.');
	}
	...
	registerParticipant(pariticipant: IExtensionManagementParticipant): cognidreamidream { }
	...
	copyExtensions(): Promise<cognidreamidream> { throw new Error('Not Supported'); }
	...
	whenProfileChanged(from: IUserDataProfile, to: IUserDataProfile): Promise<cognidreamidream> { throw new Error('Not Supported'); }
	...
	resetPinnedStateForAllUserExtensions(pinned: boolean): Promise<cognidreamidream> { throw new Error('Method not implemented.'); }
	...
	trustPublishers(): cognidreamidream { }
	untrustPublishers(): cognidreamidream { }
	async requestPublisherTrust(extensions: InstallExtensionInfo[]): Promise<cognidreamidream> { }
}
...
export class TestUserDataProfileService implements IUserDataProfileService {
	...
	async updateCurrentProfile(): Promise<cognidreamidream> { }
}
...
export class TestWebExtensionsScannerService implements IWebExtensionsScannerService {
	...
	async copyExtensions(): Promise<cognidreamidream> {
		throw new Error('Method not implemented.');
	}
	...
	removeExtension(): Promise<cognidreamidream> {
		throw new Error('Method not implemented.');
	}
...
export async function workbenchTeardown(instantiationService: IInstantiationService): Promise<cognidreamidream> {
