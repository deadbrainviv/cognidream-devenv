...
export class BrowserMain extends Disposable {
	...
	private registerListeners(workbench: Workbench): cognidreamidream {
	...
	private async initServices(): Promise<{ serviceCollection: ServiceCollection; configurationService: IWorkbenchConfigurationService; logService: ILogService }> {
		...
		// This is to acognidreamidream cyclic dependency
	...
	private async registerIndexedDBFileSystemProviders(environmentService: IWorkbenchEnvironmentService, fileService: IFileService, logService: ILogService, loggerService: ILoggerService, logsPath: URI): Promise<cognidreamidream> {
	...
	private registerDeveloperActions(provider: IndexedDBFileSystemProvider): cognidreamidream {
