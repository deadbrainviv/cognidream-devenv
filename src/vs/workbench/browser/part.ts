...
export abstract class Part extends Component implements ISerializableView {
	...
	protected override onThemeChange(theme: IColorTheme): cognidreamidream {
	 ...
	 */
	create(parent: HTMLElement, options?: object): cognidreamidream {
		this.parent = parent;
	 ...
	 */
	protected setHeaderArea(headerContainer: HTMLElement): cognidreamidream {
		if (this.headerArea) {
	 ...
	 */
	protected setFooterArea(footerContainer: HTMLElement): cognidreamidream {
		if (this.footerArea) {
	 ...
	 */
	protected removeHeaderArea(): cognidreamidream {
		if (this.headerArea) {
	 ...
	 */
	protected removeFooterArea(): cognidreamidream {
		if (this.footerArea) {
...
class PartLayout {
	...
	setFooterVisibility(visible: boolean): cognidreamidream {
		this.footerVisible = visible;
	}

	setHeaderVisibility(visible: boolean): cognidreamidream {
...
export abstract class MultiWindowParts<T extends IMultiWindowPart> extends Component {
	...
	protected unregisterPart(part: T): cognidreamidream {
