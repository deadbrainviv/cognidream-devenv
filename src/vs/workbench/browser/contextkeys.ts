...
export class WorkbenchContextKeysHandler extends Disposable {
	...
	private updateVisiblePanesContextKeys(): cognidreamidream {
	...
	private updateActiveEditorGroupContextKeys(): cognidreamidream {
	...
	private updateEditorGroupsContextKeys(): cognidreamidream {
	...
	private updateEditorAreaContextKeys(): cognidreamidream {
		this.editorTabsVisibleContext.set(this.editorGroupService.partOptions.showTabs === 'multiple');
	}

	private updateInputContextKeys(ownerDocument: Document): cognidreamidream {
	...
	private updateWorkbenchStateContextKey(): cognidreamidream {
		this.workbenchStateContext.set(this.getWorkbenchStateString());
	}

	private updateWorkspaceFolderCountContextKey(): cognidreamidream {
		this.workspaceFolderCountContext.set(this.contextService.getWorkspace().folders.length);
	}

	private updateSplitEditorsVerticallyContext(): cognidreamidream {
	...
	private updateSideBarContextKeys(): cognidreamidream {
		this.sideBarVisibleContext.set(this.layoutService.isVisible(Parts.SIDEBAR_PART));
	}

	private updateTitleBarContextKeys(): cognidreamidream {
	...
	private updateWorkspaceContextKeys(): cognidreamidream {
