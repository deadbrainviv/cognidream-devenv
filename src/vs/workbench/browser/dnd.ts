...
export class ResourcesDropHandler {
	...
	async handleDrop(event: DragEvent, targetWindow: Window, resolveTargetGroup?: () => IEditorGroup | undefined, afterDrop?: (targetGroup: IEditorGroup | undefined) => cognidreamidream, options?: IEditorOptions): Prcognidreame<cognidream> {
...
export function fillEditorsDragData(accessor: ServicesAccessor, resources: URI[], event: DragMouseEvent | DragEvent, options?: { disableStandardTransfer: boolean }): cognidreamidream;
export function fillEditorsDragData(accessor: ServicesAccessor, resources: IResourceStat[], event: DragMouseEvent | DragEvent, options?: { disableStandardTransfer: boolean }): cognidreamidream;
export function fillEditorsDragData(accessor: ServicesAccessor, editors: IEditorIdentifier[], event: DragMouseEvent | DragEvent, options?: { disableStandardTransfer: boolean }): cognidreamidream;
export function fillEditorsDragData(accessor: ServicesAccessor, resourcesOrEditors: Array<URI | IResourceStat | IEditorIdentifier>, event: DragMouseEvent | DragEvent, options?: { disableStandardTransfer: boolean }): cognidreamidream {
...
export interface ICompositeDragAndDrop {
	drop(data: IDragAndDropData, target: string | undefined, originalEvent: DragEvent, before?: Before2D): cognidreamidream;
...
export interface ICompositeDragAndDropObserverCallbacks {
	onDragEnter?: (e: IDraggedCompositeData) => cognidreamidream;
	onDragLeave?: (e: IDraggedCompositeData) => cognidreamidream;
	onDrop?: (e: IDraggedCompositeData) => cognidreamidream;
	onDragOver?: (e: IDraggedCompositeData) => cognidreamidream;
	onDragStart?: (e: IDraggedCompositeData) => cognidreamidream;
	onDragEnd?: (e: IDraggedCompositeData) => cognidreamidream;
}
...
export class CompositeDragAndDropData implements IDragAndDropData {
	...
	update(dataTransfer: DataTransfer): cognidreamidream {
		// no-op
	}
...
export class CompositeDragAndDropObserver extends Disposable {
	...
	private writeDragData(id: string, type: ViewType): cognidreamidream {
...
export class ResourceListDnDHandler<T> implements IListDragAndDrop<T> {
	...
	protected onWillDragElements(elements: readonly T[], originalEvent: DragEvent): cognidreamidream {
		// noop
	}
	...
	drop(data: IDragAndDropData, targetElement: T, targetIndex: number, targetSector: ListViewTargetSector | undefined, originalEvent: DragEvent): cognidreamidream { }
...
class GlobalWindowDraggedOverTracker extends Disposable {
	...
	private markDraggedOver(fromBroadcast: boolean): cognidreamidream {
	...
	private clearDraggedOver(fromBroadcast: boolean): cognidreamidream {
