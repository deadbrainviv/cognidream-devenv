...
export class Workbench extends Layout {
	...
	private handleUnexpectedError(error: unknown, logService: ILogService): cognidreamidream {
	...
	private registerListeners(lifecycleService: ILifecycleService, storageService: IStorageService, configurationService: IConfigurationService, hostService: IHostService, dialogService: IDialogService): cognidreamidream {
	...
	private restoreFontInfo(storageService: IStorageService, configurationService: IConfigurationService): cognidreamidream {
	...
	private storeFontInfo(storageService: IStorageService): cognidreamidream {
	...
	private renderWorkbench(instantiationService: IInstantiationService, notificationService: NotificationService, storageService: IStorageService, configurationService: IConfigurationService): cognidreamidream {
	...
	private createNotificationsHandlers(instantiationService: IInstantiationService, notificationService: NotificationService): cognidreamidream {
	...
	private restore(lifecycleService: ILifecycleService): cognidreamidream {
