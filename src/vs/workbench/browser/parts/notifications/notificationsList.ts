...
export class NotificationsList extends Disposable {
	...
	private createNotificationsList(): cognidreamidream {
	...
	updateNotificationHeight(item: INotificationViewItem): cognidreamidream {
	...
	layout(width: number, maxHeight?: number): cognidreamidream {
