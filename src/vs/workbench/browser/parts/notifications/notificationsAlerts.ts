...
export class NotificationsAlerts extends Disposable {
	...
	private triggerAriaAlert(notification: INotificationViewItem): cognidreamidream {
	...
	private doTriggerAriaAlert(notification: INotificationViewItem): cognidreamidream {
