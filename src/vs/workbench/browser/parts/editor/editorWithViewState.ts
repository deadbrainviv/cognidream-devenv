...
export abstract class AbstractEditorWithViewState<T extends object> extends EditorPane {
	...
	private onWillCloseEditor(e: IEditorCloseEvent): cognidreamidream {
	...
	private updateEditorViewState(input: EditorInput | undefined): cognidreamidream {
	...
	private saveEditorViewState(resource: URI): cognidreamidream {
	...
	protected moveEditorViewState(source: URI, target: URI, comparer: IExtUri): cognidreamidream {
		return this.viewState.moveEditorState(source, target, comparer);
	}

	protected clearEditorViewState(resource: URI, group?: IEditorGroup): cognidreamidream {
