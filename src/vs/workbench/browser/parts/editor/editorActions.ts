...
class ExecuteCommandAction extends Action2 {
	...
	override run(accessor: ServicesAccessor): Promise<cognidreamidream> {
...
abstract class AbstractSplitEditorAction extends Action2 {
	...
	override async run(accessor: ServicesAccessor, ...args: unknown[]): Promise<cognidreamidream> {
...
export class JoinTwoGroupsAction extends Action2 {
	...
	override async run(accessor: ServicesAccessor, context?: IEditorIdentifier): Promise<cognidreamidream> {
...
export class CloseEditorAction extends Action {
	...
	override run(context?: IEditorCommandsContext): Promise<cognidreamidream> {
...
export class CloseEditorTabAction extends Action {
	...
	override async run(context?: IEditorCommandsContext): Promise<cognidreamidream> {
...
abstract class AbstractCloseAllAction extends Action2 {
	...
	private revertEditors(editorService: IEditorService, logService: ILogService, progressService: IProgressService, editors: IEditorIdentifier[]): Promise<cognidreamidream> {
	...
	private async doRevertEditors(editorService: IEditorService, logService: ILogService, editors: IEditorIdentifier[]): Promise<cognidreamidream> {
		try {
	...
	private async revealEditorsToConfirm(editors: ReadonlyArray<IEditorIdentifier>, editorGroupService: IEditorGroupsService): Promise<cognidreamidream> {
		try {
	...
	protected async doCloseAll(editorGroupService: IEditorGroupsService): Promise<cognidreamidream> {
...
export class CloseAllEditorGroupsAction extends AbstractCloseAllAction {
	...
	protected override async doCloseAll(editorGroupService: IEditorGroupsService): Promise<cognidreamidream> {
