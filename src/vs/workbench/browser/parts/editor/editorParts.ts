...
export class EditorParts extends MultiWindowParts<EditorPart> implements IEditorGroupsService, IEditorPartsView {
	...
	protected override unregisterPart(part: EditorPart): cognidreamidream {
	...
	private registerEditorPartListeners(part: EditorPart, disposables: DisposableStore): cognidreamidream {
	...
	private doUpdateMostRecentActive(part: EditorPart, makeMostRecentlyActive?: boolean): cognidreamidream {
	...
	private async restoreParts(): Promise<cognidreamidream> {
	...
	private async restoreState(state: IEditorPartsUIState): Promise<cognidreamidream> {
	...
	deleteWorkingSet(workingSet: IEditorWorkingSet): cognidreamidream {
	...
	private saveWorkingSets(): cognidreamidream {
	...
	arrangeGroups(arrangement: GroupsArrangement, group: IEditorGroupView | GroupIdentifier = this.activePart.activeGroup): cognidreamidream {
		this.getPart(group).arrangeGroups(arrangement, group);
	}

	toggleMaximizeGroup(group: IEditorGroupView | GroupIdentifier = this.activePart.activeGroup): cognidreamidream {
		this.getPart(group).toggleMaximizeGroup(group);
	}

	toggleExpandGroup(group: IEditorGroupView | GroupIdentifier = this.activePart.activeGroup): cognidreamidream {
	...
	removeGroup(group: IEditorGroupView | GroupIdentifier): cognidreamidream {
	...
	private registerGroupsContextKeyListeners(): cognidreamidream {
	...
	private updateGlobalContextKeys(): cognidreamidream {
	...
	private registerGroupContextKeyProvidersListeners(group: IEditorGroupView): cognidreamidream {
	...
	private updateRegisteredContextKey<T extends ContextKeyValue>(group: IEditorGroupView, provider: IEditorGroupContextKeyProvider<T>): cognidreamidream {
