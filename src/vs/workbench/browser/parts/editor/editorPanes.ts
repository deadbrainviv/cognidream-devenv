...
export class EditorPanes extends Disposable {
	...
	private readonly mapEditorPaneToPendingSetInput = new Map<EditorPane, Promise<cognidreamidream>>();
	...
	private shouldRestoreFocus(expectedActiveElement: Element | null): boolean {
		...
		if (!isEditableElement(activeElement)) {
			...
			// This is to acognidreamidream regressions from not restoring focus as we used to:
	...
	private doHideActiveEditorPane(): cognidreamidream {
	...
	layout(pagePosition: IDomNodePagePosition): cognidreamidream {
	...
	private safeRun(fn: () => cognidreamidrcognidream: cognidream {
