...
export class SideBySideEditor extends AbstractEditorWithViewState<ISideBySideEditorViewState> implements IEditorPaneWithSelection {
	...
	private recreateSplitview(): cognidreamidream {
	...
	private createSplitView(parent: HTMLElement, ratio?: number): cognidreamidream {
	...
	override async setInput(input: SideBySideEditorInput, options: ISideBySideEditorOptions | undefined, context: IEditorOpenContext, token: CancellationToken): Promise<cognidreamidream> {
	...
	private createEditors(newInput: SideBySideEditorInput): cognidreamidream {
	...
	private onDidFocusChange(side: Side.PRIMARY | Side.SECONDARY): cognidreamidream {
	...
	override setOptions(options: ISideBySideEditorOptions | undefined): cognidreamidream {
	...
	private layoutPane(pane: EditorPane | undefined, size: number): cognidreamidream {
	...
	private disposeEditors(): cognidreamidream {
