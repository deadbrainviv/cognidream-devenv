...
export class MultiEditorTabsControl extends EditorTabsControl {
	...
	private updateTabsScrollbarSizing(): cognidreamidream {
		this.tabsScrollbar?.updateOptions({
			horizontalScrollbarSize: this.getTabsScrollbarSizing()
		});
	}

	private updateTabSizing(fromEvent: boolean): cognidreamidream {
	...
	private updateTabsFixedWidth(fixed: boolean): cognidreamidream {
	...
	private registerTabsContainerListeners(tabsContainer: HTMLElement, tabsScrollbar: ScrollableElement): cognidreamidream {
	...
	private doHandleDecorationsChange(): cognidreamidream {
	...
	protected override updateEditorActionsToolbar(): cognidreamidream {
	...
	moveEditor(editor: EditorInput, fromTabIndex: number, targeTabIndex: number): cognidreamidream {
	...
	private doHandleStickyEditorChange(editor: EditorInput): cognidreamidream {
	...
	setActive(isGroupActive: boolean): cognidreamidream {
	...
	private doUpdateEditorLabels(): cognidreamidream {
	...
	private forEachTab(fn: (editor: EditorInput, tabIndex: number, tabContainer: HTMLElement, tabLabelWidget: IResourceLabel, tabLabel: IEditorInputLabel, tabActionBar: ActionBar) => cognidreamidream, fromTabIndex?: number, toTabIndex?: numcognidream: cognidream {
	...
	private withTab(editor: EditorInput, fn: (editor: EditorInput, tabIndex: number, tabContainer: HTMLElement, tabLabelWidget: IResourceLabel, tabLabel: IEditorInputLabel, tabActionBar: ActionBar) => cognidreamidrcognidream: cognidream {
			this.doWithTab(this.tabsModel.indexOf(editor), editor, fn);
		}

	private doWithTab(tabIndex: number, editor: EditorInput, fn: (editor: EditorInput, tabIndex: number, tabContainer: HTMLElement, tabLabelWidget: IResourceLabel, tabLabel: IEditorInputLabel, tabActionBar: ActionBar) => cognidreamidrcognidream: cognidream {
			const tabsContainer = assertIsDefined(this.tabsContainer);
	...
	const handleClickOrTouch = async (e: MouseEvent | GestureEvent, preserveFocus: boolean): Promise<cognidreamidream> => {
	...
	private updateDropFeedback(element: HTMLElement, isDND: boolean, e: DragEvent, tabIndex ?: number): cognidreamidream {
	...
	private updateDropTarget(newTarget: { leftElement: HTMLElement | undefined; rightElement: HTMLElement | undefined } | undefined): cognidreamidream {
	...
	private async selectEditor(editor: EditorInput): Promise < cognidreamidream > {
...
await this.groupView.setSelection(editor, this.groupView.selectedEditors);
	...
	private async selectEditorsBetween(target: EditorInput, anchor: EditorInput): Promise < cognidreamidream > {
...
await this.groupView.setSelection(target, inactiveSelectedEditors);
	...
	private async unselectEditor(editor: EditorInput): Promise < cognidreamidream > {
...
await this.groupView.setSelection(newActiveEditor, inactiveSelectedEditors);
	...
	private async unselectAllEditors(): Promise < cognidreamidream > {
	...
	private computeTabLabels(): cognidreamidream {
	...
	private shortenTabLabels(labels: IEditorInputLabel[]): cognidreamidream {
	...
	private redraw(options ?: IMultiEditorTabsControlLayoutOptions): cognidreamidream {
	...
	private redrawTab(editor: EditorInput, tabIndex: number, tabContainer: HTMLElement, tabLabelWidget: IResourceLabel, tabLabel: IEditorInputLabel, tabActionBar: ActionBar): cognidreamidream {
	...
	private redrawTabLabel(editor: EditorInput, tabIndex: number, tabContainer: HTMLElement, tabLabelWidget: IResourceLabel, tabLabel: IEditorInputLabel): cognidreamidream {
	const options = this.groupsView.partOptions;
	...
	private redrawTabSelectedActiveAndDirty(isGroupActive: boolean, editor: EditorInput, tabContainer: HTMLElement, tabActionBar: ActionBar): cognidreamidream {
	...
	private doRedrawTabActive(isGroupActive: boolean, allowBorderTop: boolean, editor: EditorInput, tabContainer: HTMLElement, tabActionBar: ActionBar): cognidreamidream {
	...
	private redrawTabBorders(tabIndex: number, tabContainer: HTMLElement): cognidreamidream {
	const isTabSticky = this.tabsModel.isSticky(tabIndex);
...
layout(dimensions: IEditorTitleControlDimensions, options ?: IMultiEditorTabsControlLayoutOptions): Dimension {
	...
	private doLayout(dimensions: IEditorTitleControlDimensions, options ?: IMultiEditorTabsControlLayoutOptions): cognidreamidream {
	...
	private doLayoutTabs(dimensions: IEditorTitleControlDimensions, options ?: IMultiEditorTabsControlLayoutOptions): cognidreamidream {
	...
	function updateTabsWrapping(enabled: boolean): cognidreamidream {
		...
		// be the width of the editor actions container to acognidreamidream screen cheese.
	...
	private doLayoutTabsNonWrapping(options ?: IMultiEditorTabsControlLayoutOptions): cognidreamidream {
	const [tabsContainer, tabsScrollbar] = assertAllDefined(this.tabsContainer, this.tabsScrollbar);
	...
	private updateTabsControlVisibility(): cognidreamidream {
	...
	private blockRevealActiveTabOnce(): cognidreamidream {
	...
	private async onDrop(e: DragEvent, targetTabIndex: number, tabsContainer: HTMLElement): Promise < cognidreamidream > {
	EventHelper.stop(e, true);
