...
export interface IStatusbarEntryContainer extends IDisposable {
	 ...
	 */
	updateEntryVisibility(id: string, visible: boolean): cognidreamidream;
	 ...
	 */
	focus(preserveEntryFocus?: boolean): cognidreamidream;
...
class StatusbarPart extends Part implements IStatusbarEntryContainer {
	...
	focus(preserveEntryFocus = true): cognidreamidream {
	...
	private createInitialStatusbarEntries(): cognidreamidream {
	...
	private appendStatusbarEntries(): cognidreamidream {
	...
	private appendStatusbarEntry(entry: IStatusbarViewModelEntry): cognidreamidream {
	...
	private updateCompactEntries(): cognidreamidream {
	...
	private showContextMenu(e: MouseEvent | GestureEvent): cognidreamidream {
...
export class StatusbarService extends MultiWindowParts<StatusbarPart> implements IStatusbarService {
	...
	private doAddEntryToAllWindows(originalEntry: IStatusbarEntry, id: string, alignment: StatusbarAlignment, priorityOrLocation: number | IStatusbarEntryLocation | IStatusbarEntryPriority = 0): IStatusbarEntryAccessor {
		...
		function addEntry(part: StatusbarPart | AuxiliaryStatusbarPart): cognidreamidream {
