...
export class WindowTitle extends Disposable {
	...
	private readonly onDidChangeEmitter = new Emitter<cognidreamidream>();
	...
	private onConfigurationChanged(event: IConfigurationChangeEvent): cognidreamidream {
	...
	private checkTitleVariables(): cognidreamidream {
	...
	private onActiveEditorChange(): cognidreamidream {
	...
	private doUpdateTitle(): cognidreamidream {
