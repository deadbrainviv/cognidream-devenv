...
export abstract class MenubarControl extends Disposable {
	...
	protected abstract doUpdateMenubar(firstTime: boolean): cognidreamidream;

	protected registerListeners(): cognidreamidream {
	...
	protected setupMainMenu(): cognidreamidream {
	...
	protected updateMenubar(): cognidreamidream {
	...
	protected onUpdateStateChange(): cognidreamidream {
		this.updateMenubar();
	}

	protected onUpdateKeybindings(): cognidreamidream {
		this.updateMenubar();
	}
	...
	protected onDidChangeWindowFocus(hasFocus: boolean): cognidreamidream {
	...
	protected onDidChangeRecentlyOpened(): cognidreamidream {
	...
	private notifyUserOfCustomMenubarAccessibility(): cognidreamidream {
...
let focusMenuBarEmitter: Emitter<cognidreamidream> | undefined = undefined;
function enableFocusMenuBarAction(): Emitter<cognidreamidream> {
	if (!focusMenuBarEmitter) {
		focusMenuBarEmitter = new Emitter<cognidreamidream>();
...
export class CustomMenubarControl extends MenubarControl {
	...
	protected doUpdateMenubar(firstTime: boolean): cognidreamidream {
	...
	private insertActionsBefore(nextAction: IAction, target: IAction[]): cognidreamidream {
	...
	private setupCustomMenubar(firstTime: boolean): cognidreamidream {
	...
	protected override onDidChangeWindowFocus(hasFocus: boolean): cognidreamidream {
		if (!this.visible) {
			return;
		}
	...
	protected override onUpdateStateChange(): cognidreamidream {
		if (!this.visible) {
			return;
		}
	...
	protected override onDidChangeRecentlyOpened(): cognidreamidream {
		if (!this.visible) {
			return;
		}
	...
	protected override onUpdateKeybindings(): cognidreamidream {
		if (!this.visible) {
			return;
		}
	...
	protected override registerListeners(): cognidreamidream {
