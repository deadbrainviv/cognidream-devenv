...
export class NativeTitlebarPart extends BrowserTitlebarPart {
	...
	protected override onMenubarVisibilityChanged(visible: boolean): cognidream {
	...
	protected override onConfigurationChanged(event: IConfigurationChangeEventcognidreamognidream {
...
if (event.affectsConfiguration('window.doubleClickIconToClose')) {
    ...
    private onUpdateAppIconDragBehavior(cognidreamognidream {
    ...
    protected override installMenubar(cognidreamognidream {
...
if (this.customMenubar) {
    ...
    private onMenubarFocusChanged(focused: booleancognidreamognidream {
    ...
    private onDidChangeWindowMaximized(maximized: booleancognidreamognidream {
...
if (this.resizer) {
    ...
    override layout(width: number, height: numbercognidreamognidream {
