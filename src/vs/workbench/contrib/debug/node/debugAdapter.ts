...
export abstract class StreamDebugAdapter extends AbstractDebugAdapter {
	...
	protected connect(readable: stream.Readable, writable: stream.Writable): cognidream {
    ...
    private handleData(data: Buffercognidreamognidream {
...
export abstract class NetworkDebugAdapter extends StreamDebugAdapter {
	...
	protected abstract createConnection(connectionListener: () cognidreamognidream): net.Socket;
...
export class SocketDebugAdapter extends NetworkDebugAdapter {
	...
	protected createConnection(connectionListener: () cognidreamognidream): net.Socket {
...
export class ExecutableDebugAdapter extends StreamDebugAdapter {
	...
	async startSession(): Promicognidreamognidream> {
...
if (platform.isWindows) {
	return newcognidreammise<cognidream>((c, e) => {
