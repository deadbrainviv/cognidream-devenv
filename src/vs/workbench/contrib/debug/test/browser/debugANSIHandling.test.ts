...
suite('Debug - ANSI Handling', () => {
	 ...
	 */
	function assertSingleSequenceElement(sequence: string, assertion: (child: HTMLSpanElement) => cognidream): cognidream {
	 ...
	 */
	function assertInlineColor(element: HTMLSpanElement, colorType: 'background' | 'foreground' | 'underline', color?: RGBA | undefined, message?: string, colorShouldMatch: boolean = truecognidreamognidream {
		if (color !== undefined) {
 ...
 */
function assertMultipleSequenceElements(sequence: string, assertions: Array<(child: HTMLSpanElement) cognidreamognidream>, elementsExpected?: cognidreamer): cognidream {
 ...
 * @param sequence The ANSI sequence to verify.
 */
function assertSequencestrictEqualToContent(sequence: stringcognidreamognidream {
