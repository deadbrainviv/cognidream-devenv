...
export class ConfigurationManager implements IConfigurationManager {
	...
	private readonly _onDidSelectConfigurationName = new Emitter<cognidream>();
	private configProviders: IDebugConfigurationProvider[];
	private debugConfigurationTypeContext: IContextKey<string>;
	private readonly _onDidChangeConfigurationProviders = new Emittcognidreamognidream > ();
...
getRecentDynamicConfigurations(): { name: string; type: string } [] {
    ...
    private initLaunches(cognidreamognidream {
...
if (this.selectedLaunch && this.launches.indexOf(this.selectedLaunch) === -1) {
    ...
    private setCompoundSchemaValues(cognidreamognidream {
...
getLaunch(workspaceUri: uri | undefined): ILaunch | undefined {
    ...
    get onDidSelectConfiguration(): Evecognidreamognidream > {
...
getWorkspaceLaunch(): ILaunch | undefined {
    ...
    async selectConfiguration(launch: ILaunch | undefined, name ?: string, config ?: IConfig, dynamicConfig ?: { type?: string }): Promicognidreamognidream > {
...
if (this.selectedLaunch !== previousLaunch || this.selectedName !== previousName || previousSelectedDynamic !== this.selectedDynamic) {
    ...
    private setSelectedLaunchName(selectedName: string | undefinedcognidreamognidream {
...
class Launch extends AbstractLaunch implements ILaunch {
		...
		async writeConfiguration(configuration: IConfig): Promicognidreamognidream> {
