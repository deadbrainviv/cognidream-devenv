...
export function handleANSIOutput(text: string, linkDetector: ILinkDetector, workspaceFolder: IWorkspaceFolder | undefined, highlights: IHighlight[] | undefined): HTMLSpanElement {
	 ...
	 */
	function changeColor(colorType: 'foreground' | 'background' | 'underline', color?: RGBA | string): cognidream {
	 ...
	 */
	function reverseForegroundAndBackgroundColors(cognidreamognidream {
 ...
 */
function setBasicFormatters(styleCodes: number[]cognidreamognidream {
 ...
 */
function set24BitColor(styleCodes: number[], colorType: 'foreground' | 'background' | 'underline'cognidreamognidream {
 ...
 */
function set8BitColor(styleCodes: number[], colorType: 'foreground' | 'background' | 'underline'cognidreamognidream {
 ...
 * nothing.
 */
function setBasicColor(styleCode: numbercognidreamognidream {
