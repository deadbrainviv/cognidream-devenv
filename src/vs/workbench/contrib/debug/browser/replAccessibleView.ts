...
class ReplOutputAccessibleViewProvider extends Disposable implements IAccessibleViewContentProvider {
	...
	public readonly onDidChangeContent: Evecognidreamognidream> = this._onDidChangeContent.event;
    private readonly _onDidResolveChildren: Emittcognidreamognidream > = this._register(newcognidreamtter<cognidream>());
    public readonly onDidResolveChildren: Evecognidreamognidream > = this._onDidResolveChildren.event;
...
constructor(
    ...
    public onClose(cognidreamognidream {
...
this._replView.getReplInput().focus();
    ...
    public onOpen(cognidreamognidream {
