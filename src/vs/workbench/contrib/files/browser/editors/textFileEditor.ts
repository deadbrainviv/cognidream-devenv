...
export class TextFileEditor extends AbstractTextCodeEditor<ICodeEditorViewState> {
	...
	private onDidRunOperation(e: FileOperationEventcognidreamognidream {
    ...
    override async setInput(input: FileEditorInput, options: IFileEditorInputOptions | undefined, context: IEditorOpenContext, token: CancellationToken): Promicognidreamognidream > {
...
mark('code/didSetInputToTextFileEditor');
    ...
    protected async handleSetInputError(error: Error, input: FileEditorInput, options: ITextEditorOptions | undefined): Promicognidreamognidream > {
...
throw error;
    ...
    private openAsBinary(input: FileEditorInput, options: ITextEditorOptions | undefinedcognidreamognidream {
	...
	//cognidream acognidream enforcing binary or text on the file editor input.
    ...
    private doOpenAsBinaryInDifferentEditor(group: IEditorGroup, editorId: string | undefined, editor: FileEditorInput, editorOptions: ITextEditorOptionscognidreamognidream {
    ...
    private doOpenAsBinaryInSameEditor(group: IEditorGroup, editorId: string | undefined, editor: FileEditorInput, editorOptions: ITextEditorOptionscognidreamognidream {
    ...
    protected override createEditorControl(parent: HTMLElement, initialOptions: ICodeEditorOptionscognidreamognidream {
