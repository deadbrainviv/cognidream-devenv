...
export class FileEditorInput extends AbstractTextResourceEditorInput implements IFileEditorInput {
	...
	private onDidCreateTextFileModel(model: ITextFileEditorModel): cognidream {
	...
	private registerModelListeners(model: ITextFileEditorModelcognidreamognidream {
...
getPreferredEncoding(): string | undefined {
    ...
    async setEncoding(encoding: string, mode: EncodingMode): Promicognidreamognidream > {
...
setLanguageId(languageId: string, source ?: stringcognidreamognidream {
    ...
    setForceOpenAsText(cognidreamognidream {
...
isResolved(): boolean {
    ...
    private disposeModelReference(cognidreamognidream {
