...
export class WorkspaceWatcher extends Disposable {
	...
	private onDidChangeWorkspaceFolders(e: IWorkspaceFoldersChangeEventcognidreamognidream {
...
for (const added of e.added) {
    ...
    private onDidChangeConfiguration(e: IConfigurationChangeEventcognidreamognidream {
	if(e.affectsConfiguration('files.watcherExclude') || e.affectsConfiguration('files.watcherInclude')) {
	this.refresh();
}
    }

	private onDidWatchError(error: Errorcognidreamognidream {
...
if (reason) {
    ...
    private watchWorkspace(workspace: IWorkspaceFoldercognidreamognidream {
...
this.watchedWorkspaces.set(workspace.uri, disposables);
    ...
    private unwatchWorkspace(workspace: IWorkspaceFoldercognidreamognidream {
    ...
    private unwatchWorkspaces(cognidreamognidream {
