...
export class LanguageStatusContribution extends Disposable implements IWorkbenchContribution {
	...
	private createLanguageStatus(part: IEditorPart): cognidreamidream {
...
class LanguageStatus {
	...
	private _restoreState(): cognidreamidream {
	...
	private _storeState(): cognidreamidream {
	...
	private _renderTextPlus(target: HTMLElement, text: string, store: DisposableStore): cognidreamidream {
