...
export class SessionWholeRange {
	...
	fixup(changes: readonly DetailedLineRangeMapping[]): cognidream {
...
this._store.dispose();
	...
	type HunkRangePair = { rangeN: Range; range0: Range; markAccepted: cognidream> cognidream
};
...
export interface HunkInformation {
	...
	discardChanges(cognidreamognidream;

		/**
		 * Accept the hunk. Applies the corresponding edits into textModel0
		 */
		acceptChanges(cognidreamognidream;
