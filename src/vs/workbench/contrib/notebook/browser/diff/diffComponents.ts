...
class PropertyHeader extends Disposable {
	...
	constructor(
		...
		readonly accessor: {
			updateInfoRendering: (renderOutput: boolean) => cognidream;
			checkIfModified: () => false | { reason: string | undefined };
			getFoldingState: () => PropertyFoldingState;
			updateFoldingState: (newState: PropertyFoldingScognidream) => cognidream;
	...
	buildHeader(cognidreamognidream {
...
updateSourceEditor(cognidreamognidream {
...
abstract class AbstractElementRenderer extends Disposable {
	...
	abstract init(cognidreamognidream;
		abstract styleContainer(container: HTMLElementcognidreamognidream;
			abstract _buildOutput(cognidreamognidream;
    abstract _disposeOutput(cognidreamognidream;
    abstract _buildMetadata(cognidreamognidream;
    abstract _disposeMetadata(cognidreamognidream;
...
updateOutputRendering(renderRichOutput: boolean) {
    ...
    abstract _buildOutputRendererContainer(cognidreamognidream;
    abstract _hideOutputsRenderer(cognidreamognidream;
    abstract _showOutputsRenderer(cognidreamognidream;
...
updateBorders() {
    ...
    abstract updateSourceEditor(cognidreamognidream;
    abstract layout(state: IDiffElementLayoutStatecognidreamognidream;
}
...
abstract class SingleSideDiffElement extends AbstractElementRenderer {
	...
	override updateSourceEditor(cognidreamognidream {
		this._cellHeaderContainer = this.templateData.cellHeaderContainer;
		this._cellHeaderContainer.style.display = 'flex';
		this._cellHeaderContainer.innerText = '';
		this._editorContainer = this.templateData.editorContainer;
...
export class InsertElement extends SingleSideDiffElement {
	...
	styleContainer(container: HTMLElementcognidreamognidream {
...
export class ModifiedElement extends AbstractElementRenderer {
    ...
    override buildBody(cognidreamognidream {
			super.buildBody();
...
export class CollapsedCellOverlayWidget extends Disposable implements IDiffCellMarginOverlay {
	...
	private readonly _action = this._register(new Emittcognidreamognidream > ());
