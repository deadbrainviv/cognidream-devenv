...
export class NotebookMultiTextDiffEditor extends EditorPane {
	...
	override layout(dimension: DOM.Dimension, position?: DOM.IDomPosition): cognidream {
    ...
    override async setInput(input: NotebookMultiDiffEditorInput, options: IMultiDiffEditorOptions | undefined, context: IEditorOpenContext, token: CancellationToken): Promicognidreamognidream > {
