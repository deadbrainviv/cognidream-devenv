...
export class FoldingModel implements IDisposable {
	...
	private readonly _onDidFoldingRegionChanges = new Emitter<cognidream>();
	readonly onDidFoldingRegionChanged: Evecognidreamognidream> = this._onDidFoldingRegionChanges.event;
