...
export class NotebookFindContrib extends Disposable implements INotebookEditorContribution {
	...
	show(initialInput?: string, options?: IShowNotebookFindWidgetOptions): Promise<cognidream> {
...
class NotebookFindWidget extends SimpleFindReplaceWidget implements INotebookEditorContribution {
	...
	private _onFindInputKeyDown(e: IKeyboardEventcognidreamognidream {
    ...
    private _onReplaceInputKeyDown(e: IKeyboardEventcognidreamognidream {
	if(e.equals(KeyCode.Enter)) {
	this.replaceOne();
	e.preventDefault();
	return;
    ...
    private findIndex(index: numbercognidreamognidream {
	this._findModel.find({ index });
}

    protected find(previous: booleancognidreamognidream {
...
if (currentMatch.isModelMatch) {
    ...
    protected findFirst(cognidreamognidream {}
    ...
    protected onReplaceInputFocusTrackerFocus(cognidreamognidream {
	// throw new Error('Method not implemented.');
}
    protected onReplaceInputFocusTrackerBlur(cognidreamognidream {
	// throw new Error('Method not implemented.');
}

    protected onFindInputFocusTrackerFocus(cognidreamognidream {}
    protected onFindInputFocusTrackerBlur(cognidreamognidream {}

    override async show(initialInput ?: string, options ?: IShowNotebookFindWidgetOptions): Promicognidreamognidream > {
...
replace(initialFindInput ?: string, initialReplaceInput ?: string) {
    ...
    protected override _updateMatchesCount(cognidreamognidream {
