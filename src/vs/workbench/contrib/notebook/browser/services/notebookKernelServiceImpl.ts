...
class SourceAction extends Disposable implements ISourceAction {
	execution: Promise<cognidream> | undefined;
	private readonly _onDidChangeState = this._register(new Emittcognidreamognidream > ());
	...
	private async _runAction(): Promicognidreamognidream> {
		try {
...
export class NotebookKernelService extends Disposable implements INotebookKernelService {
	...
	private readonly _onDidChangeNotebookAffinity = this._register(new Emittcognidreamognidream > ());
	...
	readonly onDidChangeNotebookAffinity: Evecognidreamognidream> = this._onDidChangeNotebookAffinity.event;
...
constructor(
    ...
    private _tryAutoBindNotebook(notebook: INotebookTextModel, onlyThisKernel ?: INotebookKernelcognidreamognidream {
...
// notebook <-1----N-> kernel
selectKernelForNotebook(kernel: INotebookKernel | undefined, notebook: INotebookTextModelLikecognidreamognidream {
