...
class NotebookEditorModelManager extends Disposable {
	...
	public ensureSyncedResources(resources: URI[]): cognidream {
	...
	private _beginModelSync(resource: URIcognidreamognidream {
...
this._syncedModels[modelUrl] = toDispose;
    ...
    private _stopModelSync(modelUrl: stringcognidreamognidream {
