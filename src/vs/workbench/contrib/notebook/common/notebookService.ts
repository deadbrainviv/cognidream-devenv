...
export interface INotebookService {
	...
	readonly onDidChangeOutputRenderers: Event<cognidream>;
	...
	updateMimePreferredRenderer(viewType: string, mimeType: string, rendererId: string, otherMimetypes: readonly string[]cognidreamognidream;
		saveMimeDisplayOrder(target: ConfigurationTargetcognidreamognidream;
	...
	setToCopy(items: NotebookCellTextModel[], isCopy: booleancognidreamognidream;
