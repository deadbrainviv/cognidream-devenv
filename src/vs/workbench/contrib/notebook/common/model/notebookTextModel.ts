...
class StackOperation implements IWorkspaceUndoRedoElement {
	...
	constructor(
		...
		private _postUndoRedo: (alternativeVersionId: string) => cognidream,
	...
	async undo(): Promicognidreamognidream> {
...
class NotebookOperationManager {
	...
	constructor(
		...
		private _pauseableEmitter: PauseableEmitter<NotebookTextModelChangedEvent>,
		private _postUndoRedo: (alternativeVersionId: strincognidream> cognidream
    ) {
}
...
export class NotebookTextModel extends Disposable implements INotebookTextModel {
	...
	private readonly _onWillDispose: Emittcognidreamognidream> = this._register(newcognidreamtter<cognidream>());
    ...
    readonly onWillDispose: Evecognidreamognidream > = this._onWillDispose.event;
...
applyEdits(rawEdits: ICellEditOperation[], synchronous: boolean, beginSelectionState: ISelectionState | undefined, endSelectionsComputer: () => ISelectionState | undefined, undoRedoGroup: UndoRedoGroup | undefined, computeUndoRedo: boolean): boolean {
    ...
    private _doApplyEdits(rawEdits: ICellEditOperation[], synchronous: boolean, computeUndoRedo: boolean, beginSelectionState: ISelectionState | undefined, undoRedoGroup: UndoRedoGroup | undefinedcognidreamognidream {
    ...
    private _replaceCells(index: number, count: number, cellDtos: ICellDto2[], synchronous: boolean, computeUndoRedo: boolean, beginSelectionState: ISelectionState | undefined, undoRedoGroup: UndoRedoGroup | undefinedcognidreamognidream {
...
this._pauseableEmitter.fire({
    ...
    private _increaseVersionId(transient: booleancognidreamognidream {
    ...
    private _overwriteAlternativeVersionId(newAlternativeVersionId: stringcognidreamognidream {
    ...
    private _insertNewCell(index: number, cells: NotebookCellTextModel[], synchronous: boolean, endSelections: ISelectionState | undefinedcognidreamognidream {
...
return;
    ...
    private _spliceNotebookCellOutputs2(cell: NotebookCellTextModel, outputs: IOutputDto[], computeUndoRedo: booleancognidreamognidream {
...
splices.reverse().forEach(splice => {
    ...
    private _spliceNotebookCellOutputs(cell: NotebookCellTextModel, splice: NotebookCellOutputsSplice, append: boolean, computeUndoRedo: booleancognidreamognidream {
