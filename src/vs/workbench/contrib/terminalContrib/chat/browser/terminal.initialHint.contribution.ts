...
export class InitialHintAddon extends Disposable implements ITerminalAddon {
	private readonly _onDidRequestCreateHint = this._register(new Emitter<cognidream>());
	get onDidRequestCreateHint(): Evecognidreamognidream> { return this._onDidRequestCreateHint.event; }
...
activate(terminal: RawXtermTerminalcognidreamognidream {
...
this._register(this._addon.onDidRequestCreateHint(() => this._createHint()));
    ...
    private _createHint(cognidreamognidream {
