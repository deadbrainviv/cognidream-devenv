...
export class TerminalQuickFixService implements ITerminalQuickFixService {
	...
	registerCommandSelector(selector: ITerminalCommandSelector): cognidream {
...
const quickFixExtensionPoint = ExtensionsRegistry.registerExtensionPoint<ITerminalCommandSelector[]>({
	...
	activationEventsGenerator: (terminalQuickFixes: ITerminalCommandSelector[], result: { push(item: stringcognidreamognidream }) => {
