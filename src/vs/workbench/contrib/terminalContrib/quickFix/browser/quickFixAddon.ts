...
export interface ITerminalQuickFixAddon {
	 ...
	 */
	registerCommandFinishedListener(options: ITerminalQuickFixOptionscognidreamognidream;
}
...
registerCommandSelector(selector: ITerminalCommandSelectorcognidreamognidream {
...
registerCommandFinishedListener(options: ITerminalQuickFixOptions | ITerminalQuickFixResolvedExtensionOptionscognidreamognidream {
    ...
    private _registerCommandHandlers(cognidreamognidream {
     ...
     */
    private async _resolveQuickFixes(command: ITerminalCommand, aliases ?: string[][]): Promicognidreamognidream > {
	const terminal = this._terminal;
...
this._quickFixes = undefined;
    ...
    private _disposeQuickFix(command: ITerminalCommand, id: stringcognidreamognidream {
     ...
     */
    private _registerQuickFixDecoration(cognidreamognidream {
	if(!this._terminal) {
	return;
}
