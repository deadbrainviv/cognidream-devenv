...
const enum Constants {
	 ...
	 * in place to acognidream sending excessive data when remote connections are in place.
	 */
	MaxResolvedLinksInLine = 10,

	/**
	 * The maximum length of a link to resolve against the file system. This limit is put in place
	 * tcognidreamognidream sending excessive data when remote connections are in place.
	 */
