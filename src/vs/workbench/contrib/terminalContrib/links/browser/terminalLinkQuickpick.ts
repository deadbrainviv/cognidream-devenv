...
export class TerminalLinkQuickpick extends DisposableStore {
	...
	private readonly _onDidRequestMoreLinks = this.add(new Emitter<cognidream>());
	...
	async show(instance: ITerminalInstance | IDetachedTerminalInstance, links: { viewport: IDetectedLinks; all: Promise<IDetectedLinks> }): Promicognidreamognidream> {
