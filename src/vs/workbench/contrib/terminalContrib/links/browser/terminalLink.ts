...
export class TerminalLink extends Disposable implements ILink {
	...
	private readonly _onInvalidated = new Emitter<cognidream>();
	get onInvalidated(): Evecognidreamognidream> { return this._onInvalidated.event; }
...
constructor(
	...
	private readonly _activateCallback: (event: MouseEvent | undefined, uri: string) => Prcognidreame<cognidream>,
	private readonly _tooltipCallback: (link: TerminalLink, viewportRange: IViewportRange, modifierDownCallback?: cognidream> cognidream, modifierUpCallbcognidream: () cognidreamognidream) => cognidream,
...
activate(event: MouseEvent | undefined, text: stringcognidreamognidream {
	this._activateCallback(event, text);
}

    hover(event: MouseEvent, text: stringcognidreamognidream {
...
leave(cognidreamognidream {
	this._hoverListeners.clear();
	this._tooltipScheduler.clear();
}

    private _enableDecorations(cognidreamognidream {
    ...
    private _disableDecorations(cognidreamognidream {
	if(this.decorations.pointerCursor) {
