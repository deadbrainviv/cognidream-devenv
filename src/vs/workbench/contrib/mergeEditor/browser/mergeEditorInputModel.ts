...
export interface IMergeEditorInputModel extends IDisposable {
	...
	save(options?: ITextFileSaveOptions): Promise<cognidream>;
...
*/
accept(): Promicognidreamognidream >;
}
...
super.dispose();
    ...
    async accept(): Promicognidreamognidream > {
    ...
    private async _discard(): Promicognidreamognidream > {
...
return choice;
    ...
    public async save(options ?: ITextFileSaveOptions): Promicognidreamognidream > {
	if(this.finished) {
	return;
}
...
(async () => {
    ...
    public async revert(options ?: IRevertOptions): Promicognidreamognidream > {
	// no op
}
}
...
this.reportClose(false);
    ...
    private reportClose(accepted: booleancognidreamognidream {
	if(!this.reported) {
    ...
    async save(options ?: ITextFileSaveOptions): Promicognidreamognidream > {
