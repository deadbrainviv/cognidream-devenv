...
export namespace ShellQuoting {
	export function from(this: cognidream, value: string): ShellQuoting {
		if (!value) {
...
export namespace RevealKind {
	export function fromString(thicognidreamognidream, value: string): RevealKind {
		switch (value.toLowerCase()) {
			case 'always':
...
export namespace RevealProblemKind {
	export function fromString(thicognidreamognidream, value: string): RevealProblemKind {
		switch (value.toLowerCase()) {
			case 'always':
...
export namespace TaskDefinition {
	export function createTaskIdentifier(external: ITaskIdentifier, reporter: { error(message: stringcognidreamognidream }): KeyedTaskIdentifier | undefined {
