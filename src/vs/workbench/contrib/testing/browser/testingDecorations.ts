...
export class TestingDecorationService extends Disposable implements ITestingDecorationsService {
	...
	private readonly changeEmitter = new Emitter<cognidream>();
...
class TestErrorContentWidget extends Disposable implements IContentWidget {
	...
	afterRender(_position: ContentWidgetPositionPreference | null, coordinate: IContentWidgetRenderedCoordinate | nullcognidreamognidream {
		if (coordinate) {
