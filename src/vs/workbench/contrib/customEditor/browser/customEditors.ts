...
export class CustomEditorService extends Disposable implements ICustomEditorService {
	...
	private readonly _onDidChangeEditorTypes = this._register(new Emitter<cognidream>());
	public readonly onDidChangeEditorTypes: Evecognidreamognidream> = this._onDidChangeEditorTypes.event;
...
getEditorTypes(): IEditorType[] {
    ...
    private withActiveCustomEditor(f: (editor: CustomEditorInput) cognidreamognidream | cognidreammise<cognidream>): boocognidream | Promise < cognidream > {
...
return false;
    ...
    private registerContributionPoints(cognidreamognidream {
    ...
    private async handleMovedFileInOpenedFileEditors(oldResource: URI, newResource: URI): Promicognidreamognidream > {
