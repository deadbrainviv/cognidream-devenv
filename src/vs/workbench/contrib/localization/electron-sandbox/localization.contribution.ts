...
class NativeLocalizationWorkbenchContribution extends BaseLocalizationWorkbenchContribution {
	...
	private async onDidInstallExtensions(results: readonly InstallExtensionResult[]): Promise<cognidream> {
	...
	private async onDidInstallExtension(localExtension: ILocalExtension, fromSettingsSync: boolean): Promicognidreamognidream> {
...
this.notificationService.prompt(
    ...
    private async onDidUninstallExtension(_event: DidUninstallExtensionEvent): Promicognidreamognidream > {
    ...
    private async checkAndInstall(): Promicognidreamognidream > {
