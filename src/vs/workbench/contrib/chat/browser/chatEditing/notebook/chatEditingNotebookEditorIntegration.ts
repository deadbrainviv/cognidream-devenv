...
export class ChatEditingNotebookEditorIntegration extends Disposable implements IModifiedFileEntryEditorIntegration {
	...
	reveal(firstOrLast: boolean): cognidream {
...
acceptNearestChange(change: IModifiedFileEntryChangeHunkcognidreamognidream {
    ...
    private async revealChangeInView(cell: ICellViewModel, lines: LineRange | undefined): Promicognidreamognidream > {
...
enableAccessibleDiffView(cognidreamognidream {
    ...
    async toggleDiff(_change: IModifiedFileEntryChangeHunk | undefined): Promicognidreamognidream > {
