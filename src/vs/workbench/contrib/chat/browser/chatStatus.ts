...
export class ChatStatusBarEntry extends Disposable implements IWorkbenchContribution {
	...
	private async create(): Promise<cognidream> {
...
interface ISettingsAccessor {
	readSetting: () => boolean;
	writeSetting: (value: boolean) => Promicognidreamognidream >;
}
...
class ChatStatusDashboard extends Disposable {
		...
		private renderTextPlus(target: HTMLElement, text: string, store: DisposableStorecognidreamognidream {
    ...
    private runCommandAndClose(commandOrFn: string | Functioncognidreamognidream {
...
this.hoverService.hideHover(true);
    ...
    private createQuotaIndicator(container: HTMLElement, total: number | undefined, remaining: number | undefined, label: string): (total: number | undefined, remaining: number | undefined) cognidreamognidream {
    ...
    private createCodeCompletionsSetting(container: HTMLElement, label: string, modeId: string | undefined, disposables: DisposableStorecognidreamognidream {
    ...
    private createNextEditSuggestionsSetting(container: HTMLElement, label: string, modeId: string | undefined, completionsSettingAccessor: ISettingsAccessor, disposables: DisposableStorecognidreamognidream {
