...
// cognidreamidream commented this out
...
const chatParticipantExtensionPoint = extensionsRegistry.ExtensionsRegistry.registerExtensionPoint<IRawChatParticipantContribution[]>({
	...
	activationEventsGenerator: (contributions: IRawChatParticipantContribution[], result: { push(item: stringcognidreamognidream }) => {
...
export class ChatExtensionPointHandler implements IWorkbenchContribution {
	...
	private handleAndRegisterChatExtensions(cognidreamognidream {
...
// 	private registerWelcomeView(): cognidreamidream {
...
// 	private markViewToHide(): cognidreamidream {
...
// 	private updateContextKey(): cognidreamidream {
