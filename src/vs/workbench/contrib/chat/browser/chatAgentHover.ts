...
export class ChatAgentHover extends Disposable {
	...
	private readonly _onDidChangeContents = this._register(new Emitter<cognidream>());
	public readonly onDidChangeContents: Evecognidreamognidream> = this._onDidChangeContents.event;
...
setAgent(id: stringcognidreamognidream {
