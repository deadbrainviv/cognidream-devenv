...
export class QuickChatService extends Disposable implements IQuickChatService {
	...
	private readonly _onDidClose = this._register(new Emitter<cognidream>());
...
focus(cognidreamognidream {
    ...
    async openInChatView(): Promicognidreamognidream > {
	...
	class QuickChat extends Disposable {
		...
		focus(selection?: Selectioncognidreamognidream {
			if (this.widget) {
...
this.registerListeners(parent);
    ...
    private registerListeners(parent: HTMLElementcognidreamognidream {
    ...
    async openChatView(): Promicognidreamognidream > {
...
setValue(value: string, selection ?: Selectioncognidreamognidream {
	this.widget.inputEditor.setValue(value);
	this.focus(selection);
}

    clearValue(cognidreamognidream {
	this.widget.inputEditor.setValue('');
}

    private updateModel(cognidreamognidream {
