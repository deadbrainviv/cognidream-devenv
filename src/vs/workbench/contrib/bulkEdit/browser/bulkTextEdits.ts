...
class ModelEditTask implements IDisposable {
	...
	addEdit(resourceEdit: ResourceTextEdit): cognidream {
...
class EditorEditTask extends ModelEditTask {
	...
	override apply(cognidreamognidream {
...
export class BulkTextEdits {
	...
	private _validateBeforePrepare(cognidreamognidream {
