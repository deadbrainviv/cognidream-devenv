...
export class TerminalProfileService extends Disposable implements ITerminalProfileService {
	...
	private _profilesReadyPromise: Promise<cognidream>;
	...
	get profilesReady(): Promicognidreamognidream> { return this._profilesReadyPromise; }
...
constructor(
    ...
    private async _setupConfigListener(): Promicognidreamognidream > {
...
getDefaultProfile(os ?: OperatingSystem): ITerminalProfile | undefined {
	...
	if (!defaultProfileName) {
        ...
        /cognidream acognidream unsafe path profiles being picked up.
...
refreshAvailableProfiles(cognidreamognidream {
    ...
    protected async _refreshAvailableProfilesNow(): Promicognidreamognidream > {
	// Profiles
...
getContributedProfileProvider(extensionIdentifier: string, id: string): ITerminalProfileProvider | undefined {
    ...
    private _updateWebContextKey(cognidreamognidream {
...
registerTerminalProfileProvider(extensionIdentifier: string, id: string, profileProvider: ITerminalProfileProvider): IDisposable {
    ...
    async registerContributedProfile(args: IRegisterContributedProfileArgs): Promicognidreamognidream > {
	const platformKey = await this.getPlatformKey();
