...
class SplitPaneContainer extends Disposable {
	...
	private _createSplitView(): cognidream {
	...
	split(instance: ITerminalInstance, index: numbercognidreamognidream {
		this._addChild(instance, index);
    }

resizePane(index: number, direction: Direction, amount: numbercognidreamognidream {
...
getPaneSize(instance: ITerminalInstance): number {
    ...
    private _addChild(instance: ITerminalInstance, index: numbercognidreamognidream {
...
remove(instance: ITerminalInstancecognidreamognidream {
...
setOrientation(orientation: Orientationcognidreamognidream {
...
this._withDisabledLayout(() => {
    ...
    private _withDisabledLayout(innerFunction: () cognidreamogncognidreamam): cognidream {
...
class SplitPane implements IView {
	...
	layout(size: numbercognidreamognidream {
...
orthogonalLayout(size: numbercognidreamognidream {
...
export class TerminalGroup extends Disposable implements ITerminalGroup {
	...
	private readonly _onInstancesChanged: Emittcognidreamognidream> = this._register(newcognidreamtter<cognidream>());
...
addInstance(shellLaunchConfigOrInstance: IShellLaunchConfig | ITerminalInstance, parentTerminalId ?: numbercognidreamognidream {
