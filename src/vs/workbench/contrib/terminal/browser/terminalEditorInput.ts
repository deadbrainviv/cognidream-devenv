...
export class TerminalEditorInput extends EditorInput implements IEditorCloseHandler {
	...
	setTerminalInstance(instance: ITerminalInstance): cognidream {
...
constructor(
    ...
    private _setupInstanceListeners(cognidreamognidream {
	...
	// Don't dispose editor when instance is torn down on shutdowcognidream acognidream extra work and so
