...
export class TerminalConfigurationService extends Disposable implements ITerminalConfigurationService {
	...
	private readonly _onConfigChanged = new Emitter<cognidream>();
	get onConfigChanged(): Evecognidreamognidream> { return this._onConfigChanged.event; }
...
setPanelContainer(panelContainer: HTMLElementcognidreamognidream { return this._fontMetrics.setPanelContainer(panelContainer); }
    ...
    private _updateConfig(cognidreamognidream {
