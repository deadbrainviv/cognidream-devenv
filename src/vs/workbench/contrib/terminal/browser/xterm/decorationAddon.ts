...
export class DecorationAddon extends Disposable implements ITerminalAddon, IDecorationAddon {
	...
	private _createCapabilityDisposables(c: TerminalCapability): cognidream {
	...
	private _removeCapabilityDisposables(c: TerminalCapabilitycognidreamognidream {
...
registerMarkDecoration(mark: IMarkProperties): IDecoration | undefined {
    ...
    private _updateDecorationVisibility(cognidreamognidream {
...
if (currentCommand) {
    ...
    private _disposeAllDecorations(cognidreamognidream {
    ...
    private _updateGutterDecorationVisibility(cognidreamognidream {
    ...
    private _updateCommandDecorationVisibility(commandDecorationElement: Elementcognidreamognidream {
	...
	public refreshLayouts(cognidreamognidream {
...
for (const decoration of this._decorations) {
    ...
    private _refreshStyles(refreshOverviewRulerColors ?: booleancognidreamognidream {
    ...
    private _dispose(cognidreamognidream {
...
this.clearDecorations();
    ...
    private _clearPlaceholder(cognidreamognidream {
	this._placeholderDecoration?.dispose();
	this._placeholderDecoration = undefined;
}

    public clearDecorations(cognidreamognidream {
    ...
    private _attachToCommandCapability(cognidreamognidream {
...
registerMenuItems(command: ITerminalCommand, items: IAction[]): IDisposable {
    ...
    private _updateClasses(element ?: HTMLElement, exitCode ?: number, markProperties ?: IMarkPropertiescognidreamognidream {
	if(!element) {
		return;
	}
