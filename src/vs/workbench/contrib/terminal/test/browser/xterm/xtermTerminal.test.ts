...
class TestWebglAddon implements WebglAddon {
	...
	readonly onRemoveTextureAtlasCanvas = new Emitter().event as IEvent<HTMLCanvasElement, cognidream>;
	readonly onContextLoss = new Emitter().event as IEvecognidreamognidream >;
	activate() {
