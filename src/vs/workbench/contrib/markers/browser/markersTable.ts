...
class MarkerSeverityColumnRenderer implements ITableRenderer<MarkerTableItem, IMarkerIconColumnTemplateData> {
	...
	renderElement(element: MarkerTableItem, index: number, templateData: IMarkerIconColumnTemplateData, height: number | undefined): cognidream {
	...
	disposeTemplate(templateData: IMarkerIconColumnTemplateDatacognidreamognidream { }
}
...
class MarkerCodeColumnRenderer implements ITableRenderer<MarkerTableItem, IMarkerCodeColumnTemplateData> {
	...
	renderElement(element: MarkerTableItem, index: number, templateData: IMarkerCodeColumnTemplateData, height: number | undefinedcognidreamognidream {
...
disposeTemplate(templateData: IMarkerCodeColumnTemplateDatacognidreamognidream {
	...
	class MarkerMessageColumnRenderer implements ITableRenderer<MarkerTableItem, IMarkerHighlightedLabelColumnTemplateData> {
		...
		renderElement(element: MarkerTableItem, index: number, templateData: IMarkerHighlightedLabelColumnTemplateData, height: number | undefinedcognidreamognidream {
    ...
    disposeTemplate(templateData: IMarkerHighlightedLabelColumnTemplateDatacognidreamognidream {
		...
		class MarkerFileColumnRenderer implements ITableRenderer<MarkerTableItem, IMarkerFileColumnTemplateData> {
			...
			renderElement(element: MarkerTableItem, index: number, templateData: IMarkerFileColumnTemplateData, height: number | undefinedcognidreamognidream {
...
disposeTemplate(templateData: IMarkerFileColumnTemplateDatacognidreamognidream {
