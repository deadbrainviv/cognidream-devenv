	...
	private _update(): cognidream {
		...
		if (model.isTooLargeForTokenization()) {
			const message = nls.localize(
				...
				"{0}: tokenization, wrapping, folding, codelens, word highlighting and sticky scroll have been turned off for this large file in order to reduce memorycognidreamge and acognidream freezing or crashing.",
