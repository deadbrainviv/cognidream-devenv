...
export class GotoLineQuickAccessProvider extends AbstractGotoLineQuickAccessProvider {
	...
	protected override gotoLocation(context: IQuickAccessTextEditorContext, options: { range: IRange; keyMods: IKeyMods; forceSideBySide?: boolean; preserveFocus?: boolean }): cognidream {
...
class GotoLineAction extends Action2 {
	...
	async run(accessor: ServicesAccessor): Promicognidreamidreamognidream> {
