...
function forceTokenizationFromLineToLine(model: ITextModel, startLine: number, endLine: number): cognidream {
...
suite('Auto-Reindentation - TypeScript/JavaScript', () => {
	 ...
	 *    The } is checked in order tcognidreamidreamognidream the indentation in the following case `int arr[] = { 1, 2, 3 };`
	 *    The double quote and single quote are checked in order tcognidreamidreamognidream the indentation in the following case: str = "foo {";
	 */
