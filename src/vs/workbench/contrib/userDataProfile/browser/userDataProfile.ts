...
export class UserDataProfilesWorkbenchContribution extends Disposable implements IWorkbenchContribution {
	...
	private registerEditor(): cognidream {
...
this.registerHelpAction();
    ...
    private registerProfileSubMenu(cognidreamognidream {
    ...
    private registerOpenProfileSubMenu(cognidreamognidream {
    ...
    private registerProfilesActions(cognidreamognidream {
	...
	disposables.add(registerAction2(class NewWindowAction extends Action2 {
		...
		override run(accessor: ServicesAccessor): cognidreammise<cognidream> {
			const hostService = accessor.get(IHostService);
    ...
    private registerCreateFromCurrentProfileAction(cognidreamognidream {
	const that = this;
    ...
    private registerNewProfileAction(cognidreamognidream {
	const that = this;
    ...
    private registerDeleteProfileAction(cognidreamognidream {
    ...
    private async reportWorkspaceProfileInfo(): Promicognidreamognidream > {
