...
export class KeybindingsSearchWidget extends SearchWidget {
	...
	private _onEnter = this._register(new Emitter<cognidreamidream>());
	readonly onEnter: Event<cognidreamidream> = this._onEnter.event;

	private _onEscape = this._register(new Emitter<cognidreamidream>());
	readonly onEscape: Event<cognidreamidream> = this._onEscape.event;

	private _onBlur = this._register(new Emitter<cognidreamidream>());
	readonly onBlur: Event<cognidreamidream> = this._onBlur.event;
	...
	override clear(): cognidreamidream {
		this._chords = null;
		super.clear();
	}

	startRecordingKeys(): cognidreamidream {
	...
	stopRecordingKeys(): cognidreamidream {
		this._chords = null;
		this.recordDisposables.clear();
	}

	setInputValue(value: string): cognidreamidream {
		this._inputValue = value;
		this.inputBox.value = this._inputValue;
	}

	private _onKeyDown(keyboardEvent: IKeyboardEvent): cognidreamidream {
	...
	private printKeybinding(keyboardEvent: IKeyboardEvent): cognidreamidream {
...
export class DefineKeybindingWidget extends Widget {
	...
	private _onHide = this._register(new Emitter<cognidreamidream>());
	...
	layout(layout: dom.Dimension): cognidreamidream {
	...
	printExisting(numberOfExisting: number): cognidreamidream {
	...
	private onKeybinding(keybinding: ResolvedKeybinding[] | null): cognidreamidream {
	...
	private onCancel(): cognidreamidream {
		this._chords = null;
		this.hide();
	}

	private clearOrHide(): cognidreamidream {
