...
suite('SmartSnippetInserter', () => {
	...
	function testSmartSnippetInserter(text: string[], runner: (assert: (desiredPos: Position, pos: Position, prepend: string, append: string) => cognidreamidreacognidream> ccognidreamdream): cognidream {
