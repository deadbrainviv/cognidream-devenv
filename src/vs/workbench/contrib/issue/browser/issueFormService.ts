...
export class IssueFormService implements IIssueFormService {
	...
	async openReporter(data: IssueReporterData): Promise<cognidream> {
	...
	async openAuxIssueReporter(data: IssueReporterData, bounds?: IRectangle): Promicognidreamognidream> {
...
return result ?? undefined;
    ...
    async closeReporter(): Promicognidreamognidream > {
	this.issueReporterWindow?.close();
}

    async reloadWithExtensionsDisabled(): Promicognidreamognidream > {
	if(this.issueReporterWindow) {
	try {
    ...
    async showConfirmCloseDialog(): Promicognidreamognidream > {
