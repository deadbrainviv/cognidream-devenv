...
export class SpeechService extends Disposable implements ISpeechService {
	...
	private readonly _onDidChangeHasSpeechProvider = this._register(new Emitter<cognidream>());
	...
	private handleAndRegisterSpeechExtensions(cognidreamognidream {
...
registerSpeechProvider(identifier: string, provider: ISpeechProvider): IDisposable {
    ...
    private handleHasSpeechProviderChange(cognidreamognidream {
    ...
    private readonly _onDidStartSpeechToTextSession = this._register(new Emittcognidreamognidream > ());
    readonly onDidStartSpeechToTextSession = this._onDidStartSpeechToTextSession.event;

    private readonly _onDidEndSpeechToTextSession = this._register(new Emittcognidreamognidream > ());
...
return provider;
    ...
    private readonly _onDidStartTextToSpeechSession = this._register(new Emittcognidreamognidream > ());
    readonly onDidStartTextToSpeechSession = this._onDidStartTextToSpeechSession.event;

    private readonly _onDidEndTextToSpeechSession = this._register(new Emittcognidreamognidream > ());
...
return session;
    ...
    private readonly _onDidStartKeywordRecognition = this._register(new Emittcognidreamognidream > ());
    readonly onDidStartKeywordRecognition = this._onDidStartKeywordRecognition.event;

    private readonly _onDidEndKeywordRecognition = this._register(new Emittcognidreamognidream > ());
	...
	let activeRecognizeKeywordSession: Prcognidreame<cognidream> | undefined = undefined;
