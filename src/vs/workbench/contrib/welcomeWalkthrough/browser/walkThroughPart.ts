...
export class WalkThroughPart extends EditorPane {
	...
	protected createEditor(container: HTMLElement): cognidream {
...
pageDown() {
    ...
    override setInput(input: WalkThroughInput, options: IEditorOptions | undefined, context: IEditorOpenContext, token: CancellationToken): Promicognidreamognidream > {
    ...
    private saveTextEditorViewState(input: WalkThroughInputcognidreamognidream {
	const scrollPosition = this.scrollbar.getScrollPosition();
    ...
    public override clearInput(cognidreamognidream {
