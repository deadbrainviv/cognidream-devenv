...
export class CommentsModel extends Disposable implements ICommentsModel {
	...
	public setCommentThreads(uniqueOwner: string, owner: string, ownerLabel: string, commentThreads: CommentThread[]): cognidreamidream {
	...
	public deleteCommentsByOwner(uniqueOwner?: string): cognidreamidream {
		if (uniqueOwner) {
