...
export class CommentGlyphWidget extends Disposable {
	...
	setThreadState(state: CommentThreadState | undefined): cognidreamidream {
	...
	private _updateDecorations(): cognidreamidream {
	...
	setLineNumber(lineNumber: number): cognidreamidream {
