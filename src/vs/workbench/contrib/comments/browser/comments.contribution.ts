...
registerAction2(class Reply extends Action2 {
	...
	override run(accessor: ServicesAccessor, marshalledCommentThread: MarshalledCommentThreadInternal): cognidreamidream {
...
export class UnresolvedCommentsBadge extends Disposable implements IWorkbenchContribution {
	...
	private onCommentsUpdated(): cognidreamidream {
		let unresolved = 0;
