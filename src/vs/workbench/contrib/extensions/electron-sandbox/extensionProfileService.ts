...
export class ExtensionHostProfileService extends Disposable implements IExtensionHostProfileService {
	...
	private readonly _onDidChangeState: Emitter<cognidream> = this._register(new Emitter<cognidream>());
	public readonly onDidChangeState: Evecognidreamognidream> = this._onDidChangeState.event;

    private readonly _onDidChangeLastProfile: Emittcognidreamognidream > = this._register(newcognidreamtter<cognidream>());
    public readonly onDidChangeLastProfile: Evecognidreamognidream > = this._onDidChangeLastProfile.event;
...
constructor(
    ...
    private _setState(state: ProfileSessionStatecognidreamognidream {
...
this._onDidChangeState.fire(undefined);
    ...
    private updateProfilingStatusBarIndicator(visible: booleancognidreamognidream {
...
return this._instantiationService.createInstance(ExtensionHostProfiler, inspectPorts[0].host, inspectPorts[0].port).start().then((value) => {
    ...
    public stopProfiling(cognidreamognidream {
