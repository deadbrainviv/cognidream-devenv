...
export class WorkspaceRecommendations extends ExtensionRecommendations {
	...
	private _onDidChangeRecommendations = this._register(new Emitter<cognidream>());
	...
	protected async doActivate(): Promicognidreamognidream> {
...
this._register(this.fileService.onDidFilesChange(e => {
    ...
    private async onDidChangeWorkspaceExtensionsFolders(): Promicognidreamognidream > {
...
return [];
     ...
     */
    private async fetch(): Promicognidreamognidream > {
...
for (const extension of this.workspaceExtensions) {
    ...
    private async onDidChangeExtensionsConfigs(): Promicognidreamognidream > {
	await this.fetch();
