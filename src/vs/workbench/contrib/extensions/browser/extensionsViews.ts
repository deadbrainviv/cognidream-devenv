...
class ExtensionsViewState extends Disposable implements IExtensionsViewState {
	...
	onFocusChange(extensions: IExtension[]): cognidream {
...
export class ExtensionsListView extends ViewPane {
	...
	protected registerActions(cognidreamognidream { }
...
count(): number {
    ...
    private async onContextMenu(e: IListContextMenuEvent<IExtension>): Promicognidreamognidream > {
	if(e.element) {
...
return new PagedModel(result);
    ...
    private updateBody(message ?: Messagecognidreamognidream {
	if(this.bodyTemplate) {
...
this.updateSize();
    ...
    private openExtension(extension: IExtension, options: { sideByside?: boolean; preserveFocus?: boolean; pinned?: boolean }cognidreamognidream {
...
export class SearchMarketplaceExtensionsView extends ExtensionsListView {
	...
	private searchWaitPromise: Promicognidreamognidream> = Promise.resolve();
    ...
    private async reportSearchFinished(): Promicognidreamognidream > {
...
this._register(this.contextService.onDidChangeWorkbenchState(() => this.show(this.recommendedExtensionsQuery)));
    ...
    async installWorkspaceRecommendations(): Promicognidreamognidream > {
...
export class PreferredExtensionsPagedModel implements IPagedModel<IExtension> {
	...
	private readonly pages: Array<{
		promise: Prcognidreame<cognidream> | null;
	...
	private populateResolvedExtensions(pageIndex: number, extensions: IExtension[]cognidreamognidream {
