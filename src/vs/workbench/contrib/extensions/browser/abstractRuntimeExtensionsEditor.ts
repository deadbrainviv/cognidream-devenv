...
export abstract class AbstractRuntimeExtensionsEditor extends EditorPane {
	...
	protected async _updateExtensions(): Promise<cognidream> {
...
const renderer: IListRenderer<IRuntimeExtension, IRuntimeExtensionTemplateData> = {
	...
	renderElement: (element: IRuntimeExtension, index: number, data: IRuntimeExtensionTemplacognidreamta): cognidream => {
	...
	disposeTemplate: (data: IRuntimeExtensionTemplacognidreamta): cognidream => {
...
this._list.onContextMenu((e) => {
    ...
    public layout(dimension: Dimensioncognidreamognidream {
