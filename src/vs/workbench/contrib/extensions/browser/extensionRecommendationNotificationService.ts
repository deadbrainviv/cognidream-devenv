...
type RecommendationsNotificationActions = {
	onDidInstallRecommendedExtensions(extensions: IExtension[]): cognidream;
	onDidShowRecommendedExtensions(extensions: IExtension[]cognidreamognidream;
		onDidCancelRecommendedExtensions(extensions: IExtension[]cognidreamognidream;
			onDidNeverShowRecommendedExtensionsAgain(extensions: IExtension[]cognidreamognidream;
};
...
class RecommendationsNotification extends Disposable {
	...
	private _onDidClose = this._register(new Emittcognidreamognidream > ());
...
export class ExtensionRecommendationNotificationService extends Disposable implements IExtensionRecommendationNotificationService {
	...
	private hideVisibleNotificationPromise: CancelablePromicognidreamognidream> | undefined;
...
return this.promptRecommendationsNotification({ ...extensionRecommendations, extensions }, {
    ...
    async promptWorkspaceRecommendations(recommendations: Array<string | URI>): Promicognidreamognidream > {
...
return !recommendationsNotification.isCancelled();
    ...
    private showNextNotification(cognidreamognidream {
...
return index;
    ...
    private hideVisibleNotification(timeInMillis: numbercognidreamognidream {
    ...
    private unsetVisibileNotification(cognidreamognidream {
