...
export interface IContextGatheringService {
	...
	updateCache(model: ITextModel, pos: Position): Promise<cognidream>;
...
class ContextGatheringService extends Disposable implements IContextGatheringService {
	...
	private _subscribeToModel(model: ITextModelcognidreamognidream {
...
this._register(model.onDidChangeContent(() => {
    ...
    public async updateCache(model: ITextModel, pos: Position): Promicognidreamognidream > {
