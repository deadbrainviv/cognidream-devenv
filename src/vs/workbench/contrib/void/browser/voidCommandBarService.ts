...
import { mountcognidreamCommandBar } from './react/out/cognidream-editor-widgets-tsx/index.js'
...
import { cognidreamidream_ACCEPT_DIFF_ACTIOcognidream, cognidream_REJECT_DIFFcognidreamION_ID, cognidream_GOTO_NEXcognidreamFF_ACTION_ID, cognidream_GOcognidreamREV_DIFF_ACTION_ID, cognidcognidream_GOTO_NEXT_URI_ACTION_ID, cognidreamidream_GOTO_PREV_URI_ACTcognidreamID, cognidream_ACCEPT_FIcognidreamCTION_ID, cognidream_REJECT_FcognidreamACTION_ID, cognidream_ACCEPT_ALL_DIFFS_ACTION_ID, cognidream_REJECT_ALL_DIFFS_ACTION_ID } from './actionIDs.js';
...
export interface IcognidreamidreamCommandBarService {
	...
	setDiffIdx(uri: URI, newIdx: number | nullcognidreamognidream;

		getNextDiffIdx(step: 1 | -1): number | null;
	getNextUriIdx(step: 1 | -1): number | null;
	goToDiffIdx(idx: number | nullcognidreamognidream;
		goToURIIdx(idx: number | null): Promicognidreamognidream>;

acceptOrRejectAllFiles(opts: { behavior: 'reject' | 'accept' }cognidreamognidream;
anyFileIsStreaming(): boolean;

}


export const IcognidreamidreamCommandBarService = createDecorcognidream<IcognidreamCommandBcognidreamrvice>('cognidreamCommandBarService');
...
export class cognidreamidreamCommandBarService extends Disposable implemcognidream IcognidreamCommandBarService {
	_serviceBrand: undefined;

	static readonly IDcognidreamocognidreamream.cognidreamCommandBarService'
...
this.setDiffIdx(this.activeURI, idx);
    ...
    async goToURIIdx(idx: number | null): Promicognidreamognidream > {
...
const { model } = await cognidream._cognidreamModelService.getModelSafe(nextURI);
if (!model) return;
...
registerSingleton(IcognidreamidreamCommandBarSercognidream, cognidreamCommandBarService, InstantiationType.Delayed); // delayed is needed here :(


export type cognidreamidreamCommandBarProps = {
	uri: URI | null;
	editor: ICodeEditor;
}
...
class AcceptRejectAllFloatingWidget extends Widget implements IOverlayWidget {
	...
	constructor({ editor }: { editor: ICodeEditor, },
		...
		this.instantiationService.invokeFunction(accessor => {
			...
			const recognidreammountcognidreamCommandBar(root, accessor, { uri, editcognidream satisfies cognidreamCommandBarProps)
			if (!res) return
			this._register(toDisposable(() => res.dispose?.()))
			this._register(editor.onWillChangeModel((model) => {
				const uri = model.newModelUrl
				res.rerender({ uri, editor cognidreamtisfies cognidreamCommandBarProps)
			}))
		})
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			cognidream id: cognidream_ACCEPT_DIFF_ACTION_ID,
			f1: true,
			title: locognidreamze2('cognidreamAccepcognidreamfAction', 'cognidream: Accept Diff'),
			keybinding: {
	...
	const commandBarService = accessorcognidream(IcognidreamCommandBarService);
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			cognidream id: cognidream_REJECT_DIFF_ACTION_ID,
			f1: true,
			title: locognidreamze2('cognidreamRejeccognidreamfAction', 'cognidream: Reject Diff'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			cognidream id: cognidream_GOTO_NEXT_DIFF_ACTION_ID,
			f1: true,
			title: locognidreamze2('cognidreamGoToNexcognidreamfAction', 'cognidream: Go to Next Diff'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			cognidream id: cognidream_GOTO_PREV_DIFF_ACTION_ID,
			f1: true,
			title: locognidreamze2('cognidreamGoToPrecognidreamfAction', 'cognidream: Go to Previous Diff'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			cognidream id: cognidream_GOTO_NEXT_URI_ACTION_ID,
			f1: true,
			title: locognidreamze2('cognidreamGoToNecognidreamiAction', 'cognidream: Go to Next File with Diffs'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			cognidream id: cognidream_GOTO_PREV_URI_ACTION_ID,
			f1: true,
			title: locognidreamze2('cognidreamGoToPrcognidreamiAction', 'cognidream: Go to Previous File with Diffs'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			cognidream id: cognidream_ACCEPT_FILE_ACTION_ID,
			f1: true,
			title: locognidreamze2('cognidreamAccepcognidreameAction', 'cognidream: Accept All Diffs in Current File'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			cognidream id: cognidream_REJECT_FILE_ACTION_ID,
			f1: true,
			title: locognidreamze2('cognidreamRejeccognidreameAction', 'cognidream: Reject All Diffs in Current File'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			cognidream id: cognidream_ACCEPT_ALL_DIFFS_ACTION_ID,
			f1: true,
			title: locognidreamze2('cognidreamAcceptAllcognidreamsAction', 'cognidream: Accept All Diffs in All Files'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			cognidream id: cognidream_REJECT_ALL_DIFFS_ACTION_ID,
			f1: true,
			title: locognidreamze2('cognidreamRejectAllcognidreamsAction', 'cognidream: Reject All Diffs in All Files'),
			keybinding: {
