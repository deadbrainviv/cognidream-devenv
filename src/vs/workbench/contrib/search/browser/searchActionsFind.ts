...
function getMultiSelectedSearchResources(viewer: WorkbenchCompressibleAsyncDataTree<ISearchResult, RenderableMatch, cognidream>, currElement: RenderableMatch | undefined, sortConfig: ISearchConfigurationProperties): URI[] {
