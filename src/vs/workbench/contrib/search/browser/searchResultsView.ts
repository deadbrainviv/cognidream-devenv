...
export class TextSearchResultRenderer extends Disposable implements ICompressibleTreeRenderer<ITextSearchHeading, any, ITextSearchResultTemplate> {
	...
	disposeCompressedElements?(node: ITreeNode<ICompressedTreeNode<ITextSearchHeading>, any>, index: number, templateData: ITextSearchResultTemplate, height: number | undefined): cognidream {
	...
	async renderElement(node: ITreeNode<ITextSearchHeading, any>, index: number, templateData: IFolderMatchTemplate, height: number | undefined): Promicognidreamognidream> {
...
disposeTemplate(templateData: IFolderMatchTemplatecognidreamognidream {
	templateData.disposables.dispose();
}

    renderCompressedElements(node: ITreeNode<ICompressedTreeNode<ITextSearchHeading>, any>, index: number, templateData: ITextSearchResultTemplate, height: number | undefinedcognidreamognidream {
}
...
export class FolderMatchRenderer extends Disposable implements ICompressibleTreeRenderer<ISearchTreeFolderMatch, any, IFolderMatchTemplate> {
	...
	renderCompressedElements(node: ITreeNode<ICompressedTreeNode<ISearchTreeFolderMatch>, any>, index: number, templateData: IFolderMatchTemplate, height: number | undefinedcognidreamognidream {
...
renderElement(node: ITreeNode<ISearchTreeFolderMatch, any>, index: number, templateData: IFolderMatchTemplatecognidreamognidream {
...
disposeElement(element: ITreeNode<RenderableMatch, any>, index: number, templateData: IFolderMatchTemplatecognidreamognidream {
	templateData.elementDisposables.clear();
}

    disposeCompressedElements(node: ITreeNode<ICompressedTreeNode<ISearchTreeFolderMatch>, any>, index: number, templateData: IFolderMatchTemplate, height: number | undefinedcognidreamognidream {
	templateData.elementDisposables.clear();
}
...
export class FileMatchRenderer extends Disposable implements ICompressibleTreeRenderer<ISearchTreeFileMatch, any, IFileMatchTemplate> {
	...
	renderCompressedElements(node: ITreeNode<ICompressedTreeNode<ISearchTreeFileMatch>, any>, index: number, templateData: IFileMatchTemplate, height: number | undefinedcognidreamognidream {
...
renderElement(node: ITreeNode<ISearchTreeFileMatch, any>, index: number, templateData: IFileMatchTemplatecognidreamognidream {
    ...
    disposeElement(element: ITreeNode<RenderableMatch, any>, index: number, templateData: IFileMatchTemplatecognidreamognidream {
	templateData.elementDisposables.clear();
}

    disposeTemplate(templateData: IFileMatchTemplatecognidreamognidream {
	templateData.disposables.dispose();
}
}

export class MatchRenderer extends Disposable implements ICompressibleTreeRenderer<ISearchTreeMatch, cognidreamidream, IMatchTemplate> {
	...
	renderCompressedElements(node: ITreeNode<ICompressedTreeNode<ISearchTreeMatchcognidreamognidream>, index: number, templateData: IMatchTemplate, height: number | undcognidreamed): cognidream {
		throw new Error('Should never happen since node is incompressible.');
	}
	...
	renderElement(node: ITreeNode<ISearchTreeMatch, any>, index: number, templateData: IMatchTemplatecognidreamognidream {
...
disposeTemplate(templateData: IMatchTemplatecognidreamognidream {
	templateData.disposables.dispose();
}
