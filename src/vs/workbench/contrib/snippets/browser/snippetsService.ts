...
class SnippetEnablement {
	...
	updateIgnored(id: string, value: boolean): cognidreamidream {
		let changed = false;
...
class SnippetUsageTimestamps {
	...
	updateUsageTimestamp(id: string): cognidreamidream {
...
export class SnippetsService implements ISnippetsService {
	...
	private _initExtensionSnippets(): cognidreamidream {
	...
	private _initWorkspaceSnippets(): cognidreamidream {
		// workspace stuff
