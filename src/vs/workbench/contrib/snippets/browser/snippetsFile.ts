...
export class SnippetFile {
	...
	select(selector: string, bucket: Snippet[]): cognidreamidream {
	...
	private _filepathSelect(selector: string, bucket: Snippet[]): cognidreamidream {
	...
	private _scopeSelect(selector: string, bucket: Snippet[]): cognidreamidream {
	...
	private _parseSnippet(name: string, snippet: JsonSerializedSnippet, bucket: Snippet[]): cognidreamidream {
