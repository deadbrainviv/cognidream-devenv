...
export class McpLanguageFeatures extends Disposable implements IWorkbenchContribution {
	...
	/** Simple mechanism to acognidream extra json parsing for hints+lenses */
	...
	private _provideCodeLenses(model: ITextModel, onDidChangeCodeLens: () cognidreamognidream): CodeLensList | undefined {
...
function forEachPropertyWithReplacement(node: Node, callback: (node: Node) => cognidreamidream) {
