...
export class MainThreadDebugService implements MainThreadDebugServiceShape, IDebugAdapterFactory {
	...
	$registerDebugVisualizerTree(treeId: string, canEdit: boolean): cognidream {
...
$registerDebugVisualizer(extensionId: string, id: stringcognidreamognidream {
    ...
    private sendBreakpointsAndListen(cognidreamognidream {
    ...
    public $registerBreakpoints(DTOs: Array<ISourceMultiBreakpointDto | IFunctionBreakpointDto | IDataBreakpointDto>): Promicognidreamognidream > {
    ...
    public $unregisterBreakpoints(breakpointIds: string[], functionBreakpointIds: string[], dataBreakpointIds: string[]): Promicognidreamognidream > {
    ...
    public $registerDebugConfigurationProvider(debugType: string, providerTriggerKind: DebugConfigurationProviderTriggerKind, hasProvide: boolean, hasResolve: boolean, hasResolve2: boolean, handle: number): Promicognidreamognidream > {
    ...
    public $unregisterDebugConfigurationProvider(handle: numbercognidreamognidream {
    ...
    public $registerDebugAdapterDescriptorFactory(debugType: string, handle: number): Promicognidreamognidream > {
    ...
    public $unregisterDebugAdapterDescriptorFactory(handle: numbercognidreamognidream {
    ...
    public $setDebugSessionName(sessionId: DebugSessionUUID, name: stringcognidreamognidream {
    ...
    public $stopDebugging(sessionId: DebugSessionUUID | undefined): Promicognidreamognidream > {
		if(sessionId) {
			const session = this.debugService.getModel().getSession(sessionId, true);
			if (session) {
    ...
    public $appendDebugConsole(value: stringcognidreamognidream {
...
sendMessage(message: DebugProtocol.ProtocolMessagecognidreamognidream {
    ...
    async stopSession(): Promicognidreamognidream > {
