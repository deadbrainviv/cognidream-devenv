...
export interface IFocusTracker {
	onGainedFocus(): cognidream;
	onLostFocus(cognidreamognidream;
}
...
this._codeEditorListeners.dispose();
    ...
    private _updatePropertiesNow(selectionChangeSource: string | nullcognidreamognidream {
	this._setProperties(
    ...
    private _setProperties(newProperties: MainThreadTextEditorProperties, selectionChangeSource: string | nullcognidreamognidream {
    ...
    public setCodeEditor(codeEditor: ICodeEditor | nullcognidreamognidream {
...
if (this._codeEditor) {
    ...
    public setSelections(selections: ISelection[]cognidreamognidream {
	if(this._codeEditor) {
...
this._setProperties(
    ...
    private _setIndentConfiguration(newConfiguration: ITextEditorConfigurationUpdatecognidreamognidream {
...
this._model.updateOptions(newOpts);
    ...
    public setConfiguration(newConfiguration: ITextEditorConfigurationUpdatecognidreamognidream {
...
if (typeof newConfiguration.lineNumbers !== 'undefined') {
    ...
    public setDecorations(key: string, ranges: IDecorationOptions[]cognidreamognidream {
	if(!this._codeEditor) {
	return;
}
this._codeEditor.setDecorationsByType('exthost-api', key, ranges);
    ...
    public setDecorationsFast(key: string, _ranges: number[]cognidreamognidream {
	if(!this._codeEditor) {
	return;
}
const ranges: Range[] = [];
...
this._codeEditor.setDecorationsByTypeFast(key, ranges);
    ...
    public revealRange(range: IRange, revealType: TextEditorRevealTypecognidreamognidream {
	if(!this._codeEditor) {
	return;
}
switch (revealType) {
