...
export class MainThreadExtensionService implements MainThreadExtensionServiceShape {
    ...
    async $onWillActivateExtension(extensionId: ExtensionIdentifier): Promicognidreamognidream > {
...
$onDidActivateExtension(extensionId: ExtensionIdentifier, codeLoadingTime: number, activateCallTime: number, activateResolvedTime: number, activationReason: ExtensionActivationReasoncognidreamognidream {
    ...
    $onExtensionRuntimeError(extensionId: ExtensionIdentifier, data: SerializedErrorcognidreamognidream {
    ...
    async $onExtensionActivationError(extensionId: ExtensionIdentifier, data: SerializedError, missingExtensionDependency: MissingExtensionDependency | null): Promicognidreamognidream > {
	const error = transformErrorFromSerialization(data);
    ...
    private async _handleMissingInstalledDependency(extension: IExtensionDescription, missingInstalledDependency: ILocalExtension): Promicognidreamognidream > {
    ...
    private async _handleMissingNotInstalledDependency(extension: IExtensionDescription, missingDependency: string): Promicognidreamognidream > {
	const extName = extension.displayName || extension.name;
    ...
    async $setPerformanceMarks(marks: PerformanceMark[]): Promicognidreamognidream > {
