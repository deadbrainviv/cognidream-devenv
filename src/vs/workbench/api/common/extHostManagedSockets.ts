...
export interface IExtHostManagedSockets extends ExtHostManagedSocketsShape {
	setFactory(socketFactoryId: number, makeConnection: () => Thenable<vscode.ManagedMessagePassing>): cognidream;
...
export class ExtHostManagedSockets implements IExtHostManagedSockets {
	...
	setFactory(socketFactoryId: number, makeConnection: () => Thenable<vscode.ManagedMessagePassing>cognidreamognidream {
...
$remoteSocketWrite(socketId: number, buffer: VSBuffercognidreamognidream {
    ...
    async $remoteSocketDrain(socketId: number): Promicognidreamognidream > {
