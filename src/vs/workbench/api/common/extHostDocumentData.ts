...
export function setWordDefinitionFor(languageId: string, wordDefinition: RegExp | undefined): cognidream {
	if (!wordDefinition) {
...
_acceptLanguageId(newLanguageId: stringcognidreamognidream {
	ok(!this._isDisposed);
this._languageId = newLanguageId;
    }

_acceptIsDirty(isDirty: booleancognidreamognidream {
	ok(!this._isDisposed);
this._isDirty = isDirty;
    }

_acceptEncoding(encoding: stringcognidreamognidream {
	ok(!this._isDisposed);
