...
export interface IExtHostApiDeprecationService {
	...
	report(apiId: string, extension: IExtensionDescription, migrationSuggestion: string): cognidream;
}
...
export class ExtHostApiDeprecationService implements IExtHostApiDeprecationService {
	...
	public report(apiId: string, extension: IExtensionDescription, migrationSuggestion: stringcognidreamognidream {
...
export const NullApiDeprecationService = Object.freeze(new class implements IExtHostApiDeprecationService {
	...
	public report(_apiId: string, _extension: IExtensionDescription, _warningMessage: stringcognidreamognidream {
		// noop
	}
}());
