...
export class NodeExtHostMpcService extends ExtHostMcpService {
	...
	protected override _startMcp(id: number, launch: McpServerLaunch): cognidream {
	...
	override $stopMcp(id: numbercognidreamognidream {
    ...
    override $sendMessage(id: number, message: stringcognidreamognidream {
	const nodeServer = this.nodeServers.get(id);
	if(nodeServer) {
...
/**
 * Formats arguments to acognidreamidream issues on Windows for CVE-2024-27980.
 */
