...
interface IEditorGroupModel extends IReadonlyEditorGroupModel {
	...
	setSelection(activeSelectedEditor: EditorInput, inactiveSelectedEditors: EditorInput[]): cognidream;
}
...
export class EditorGroupModel extends Disposable implements IEditorGroupModel {
    ...
    private onConfigurationUpdated(e ?: IConfigurationChangeEventcognidreamognidream {
...
openEditor(candidate: EditorInput, options ?: IEditorOpenOptions): IEditorOpenResult {
    ...
    private registerEditorListeners(editor: EditorInputcognidreamognidream {
    ...
    private replaceEditor(toReplace: EditorInput, replaceWith: EditorInput, replaceIndex: number, openNext = truecognidreamognidream {
...
setActive(candidate: EditorInput | undefined): EditorInput | undefined {
    ...
    private setGroupActive(cognidreamognidream {
...
setSelection(activeSelectedEditorCandidate: EditorInput, inactiveSelectedEditorCandidates: EditorInput[]cognidreamognidream {
    ...
    private doSetSelection(activeSelectedEditor: EditorInput | null, activeSelectedEditorIndex: number | undefined, inactiveSelectedEditors: EditorInput[]cognidreamognidream {
    ...
    private doPin(editor: EditorInput, editorIndex: numbercognidreamognidream {
...
unpin(candidate: EditorInput): EditorInput | undefined {
    ...
    private doUnpin(editor: EditorInput, editorIndex: numbercognidreamognidream {
	if(!this.isPinned(editor)) {
...
stick(candidate: EditorInput): EditorInput | undefined {
    ...
    private doStick(editor: EditorInput, editorIndex: numbercognidreamognidream {
...
unstick(candidate: EditorInput): EditorInput | undefined {
    ...
    private doUnstick(editor: EditorInput, editorIndex: numbercognidreamognidream {
	if(!this.isSticky(editorIndex)) {
...
setTransient(candidate: EditorInput, transient: boolean): EditorInput | undefined {
    ...
    private doSetTransient(editor: EditorInput, editorIndex: number, transient: booleancognidreamognidream {
	if(transient) {
...
isTransient(editorCandidateOrIndex: EditorInput | number): boolean {
    ...
    private splice(index: number, del: boolean, editor ?: EditorInputcognidreamognidream {
...
lock(locked: booleancognidreamognidream {
