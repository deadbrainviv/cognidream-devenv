...
export class WorkbenchExtensionGalleryManifestService extends ExtensionGalleryManifestService implements IExtensionGalleryManifestService {
    ...
    private extensionGalleryManifestPromise: Promise<cognidream> | undefined;
    ...
    private async doGetExtensionGalleryManifest(): Promise<cognidream> {
    ...
    private async requestRestart(): Promise<cognidream> {
