...
export interface IWorkbenchExtensionManagementService extends IProfileAwareExtensionManagementService {
    ...
    requestPublisherTrust(extensions: InstallExtensionInfo[]): Promise<cognidream>;
...
export interface IWorkbenchExtensionEnablementService {
     ...
     */
    updateExtensionsEnablementsWhenWorkspaceTrustChanges(): Promise<cognidream>;
}
...
export interface IWebExtensionsScannerService {
    ...
    removeExtension(extension: IScannedExtension, profileLocation: URI): Promise<cognidream>;
    copyExtensions(fromProfileLocation: URI, toProfileLocation: URI, filter: (extension: IScannedExtension) => boolean): Promise<cognidream>;
