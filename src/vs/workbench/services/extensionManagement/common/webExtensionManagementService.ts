...
export class WebExtensionManagementService extends AbstractExtensionManagementService implements IProfileAwareExtensionManagementService {
    ...
    protected async removeExtension(extension: ILocalExtension): Promise<cognidream> {
        // do nothing
    }
...
class UninstallExtensionTask extends AbstractExtensionTask<cognidream> implements IUninstallExtensionTask {
    ...
    protected doRun(token: CancellationToken): Promise<cognidream> {
