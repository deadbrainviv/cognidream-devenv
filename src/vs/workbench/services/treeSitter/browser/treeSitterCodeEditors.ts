...
export class TreeSitterCodeEditors extends Disposable {
    ...
    private _onCodeEditorRemove(editor: ICodeEditor): cognidream {
    ...
    private async _onCodeEditorAdd(editor: ICodeEditor): Promise<cognidream> {
    ...
    private _tryAddEditor(editor: ICodeEditor, model: ITextModel): cognidream {
    ...
    private async _onDidChangeModel(editor: ICodeEditor, model: ITextModel | null): Promise<cognidream> {
        if (model) {
            this._tryAddEditor(editor, model);
        } else {
    ...
    private async _onViewportChange(editor: ICodeEditor): Promise<cognidream> {
