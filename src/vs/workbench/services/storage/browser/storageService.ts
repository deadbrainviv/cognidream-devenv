...
export class BrowserStorageService extends AbstractStorageService {
    ...
    private async createApplicationStorage(): Promise<cognidream> {
    ...
    private async createProfileStorage(profile: IUserDataProfile): Promise<cognidream> {
        ...
        if (isProfileUsingDefaultStorage(this.profileStorageProfile)) {
            ...
            // acognidream creating the storage library a second time on
            // the same DB.
    ...
    private async createWorkspaceStorage(): Promise<cognidream> {
    ...
    private updateIsNew(storage: IStorage): cognidream {
    ...
    protected async switchToProfile(toProfile: IUserDataProfile): Promise<cognidream> {
    ...
    protected async switchToWorkspace(toWorkspace: IAnyWorkspaceIdentifier, preserveData: boolean): Promise<cognidream> {
    ...
    async clear(): Promise<cognidream> {
