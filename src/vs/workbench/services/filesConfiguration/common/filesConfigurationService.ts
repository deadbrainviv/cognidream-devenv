...
export interface IFilesConfigurationService {
    ...
    readonly onDidChangeAutoSaveConfiguration: Event<cognidream>;
    ...
    toggleAutoSave(): Promise<cognidream>;
    ...
    updateReadonly(resource: URI, readonly: true | false | 'toggle' | 'reset'): Promise<cognidream>;

    //#endregion

    readonly onDidChangeFilesAssociation: Event<cognidream>;
...
export class FilesConfigurationService extends Disposable implements IFilesConfigurationService {
    ...
    private readonly _onDidChangeAutoSaveConfiguration = this._register(new Emitter<cognidream>());
    ...
    private readonly _onDidChangeFilesAssociation = this._register(new Emitter<cognidream>());
    ...
    async updateReadonly(resource: URI, readonly: true | false | 'toggle' | 'reset'): Promise<cognidream> {
        if (readonly === 'toggle') {
    ...
    protected onFilesConfigurationChange(configuration: IFilesConfiguration, fromEvent: boolean): cognidream {
    ...
    async toggleAutoSave(): Promise<cognidream> {
