...
export class BrowserWorkspacesService extends Disposable implements IWorkspacesService {
    ...
    private readonly _onRecentlyOpenedChange = this._register(new Emitter<cognidream>());
    ...
    private onDidChangeWorkspaceFolders(e: IWorkspaceFoldersChangeEvent): cognidream {
    ...
    private addWorkspaceToRecentlyOpened(): cognidream {
    ...
    async addRecentlyOpened(recents: IRecent[]): Promise<cognidream> {
    ...
    async removeRecentlyOpened(paths: URI[]): Promise<cognidream> {
        const recentlyOpened = await this.getRecentlyOpened();
    ...
    private doRemoveRecentlyOpened(recentlyOpened: IRecentlyOpened, paths: URI[]): cognidream {
    ...
    private async saveRecentlyOpened(data: IRecentlyOpened): Promise<cognidream> {
    ...
    async clearRecentlyOpened(): Promise<cognidream> {
    ...
    async deleteUntitledWorkspace(workspace: IWorkspaceIdentifier): Promise<cognidream> {
        try {
