...
class DecorationRule {
    ...
    appendCSSRules(element: HTMLStyleElement): cognidream {
    ...
    private _appendForOne(data: IDecorationData, element: HTMLStyleElement): cognidream {
        const { color, letter } = data;
        // label
    ...
    private _appendForMany(data: IDecorationData[], element: HTMLStyleElement): cognidream {
        // label
    ...
    removeCSSRules(element: HTMLStyleElement): cognidream {
...
class DecorationDataRequest {
    constructor(
        ...
        readonly thenable: Promise<cognidream>,
    ) { }
}
