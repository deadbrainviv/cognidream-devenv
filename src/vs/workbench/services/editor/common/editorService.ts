...
export interface IEditorService {
     ...
     */
    readonly onDidActiveEditorChange: Event<cognidream>;
     ...
     */
    readonly onDidVisibleEditorsChange: Event<cognidream>;
     ...
     */
    replaceEditors(replacements: IUntypedEditorReplacement[], group: IEditorGroup | GroupIdentifier): Promise<cognidream>;
     ...
     */
    closeEditor(editor: IEditorIdentifier, options?: ICloseEditorOptions): Promise<cognidream>;

    /**
     * Close multiple editors in specific editor groups.
     */
    closeEditors(editors: readonly IEditorIdentifier[], options?: ICloseEditorOptions): Promise<cognidream>;
