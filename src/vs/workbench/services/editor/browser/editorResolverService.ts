...
export class EditorResolverService extends Disposable implements IEditorResolverService {
    ...
    // Events
    private readonly _onDidChangeEditorRegistrations = this._register(new PauseableEmitter<cognidream>());
    ...
    bufferChangeEvents(callback: Function): cognidream {
    ...
    updateUserAssociations(globPattern: string, editorID: string): cognidream {
