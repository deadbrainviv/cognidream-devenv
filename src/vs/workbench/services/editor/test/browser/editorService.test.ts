...
suite('EditorService', () => {
    ...
    test('active editor change / visible editor change events', async function() {
        ...
        async function closeEditorAndWaitForNextToOpen(group: IEditorGroup, input: EditorInput): Promise<cognidream> {
    ...
    async function testFileDeleteEditorClose(dirty: boolean): Promise<cognidream> {
        const [part, service, accessor] = await createEditorService();
    ...
    function awaitActiveEditorChange(editorService: IEditorService): Promise<cognidream> {
