...
suite('KeybindingsEditorModel', () => {
    ...
    function registerCommandWithTitle(command: string, title: string): cognidream {
    ...
    function assertKeybindingItem(actual: ResolvedKeybindingItem, expected: ResolvedKeybindingItem): cognidream {
