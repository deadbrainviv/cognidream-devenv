...
abstract class AbstractSettingsModel extends EditorModel {
     ...
     */
    private removeDuplicateResults(): cognidream {
...
export class SettingsEditorModel extends AbstractSettingsModel implements ISettingsEditorModel {
    ...
    private readonly _onDidChangeGroups: Emitter<cognidream> = this._register(new Emitter<cognidream>());
    readonly onDidChangeGroups: Event<cognidream> = this._onDidChangeGroups.event;
...
export class WorkspaceConfigurationEditorModel extends SettingsEditorModel {
    ...
    protected override parse(): cognidream {
        super.parse();
...
export class DefaultSettings extends Disposable {
    ...
    private initAllSettingsMap(allSettingsGroups: ISettingsGroup[]): cognidream {
...
class SettingsContentBuilder {
    ...
    pushLine(...lineText: string[]): cognidream {
        this._contentByLines.push(...lineText);
    }

    pushGroup(settingsGroups: ISettingsGroup, isFirst?: boolean, isLast?: boolean): cognidream {
    ...
    private pushSetting(setting: ISetting, indent: string): cognidream {
    ...
    private pushSettingDescription(setting: ISetting, indent: string): cognidream {
    ...
    private pushValue(setting: ISetting, preValueConent: string, indent: string): cognidream {
...
class RawSettingsContentBuilder extends SettingsContentBuilder {
    ...
    override pushGroup(settingsGroups: ISettingsGroup): cognidream {
...
export class DefaultRawSettingsEditorModel extends Disposable {
    ...
    private readonly _onDidContentChanged = this._register(new Emitter<cognidream>());
