...
export interface ISettingsEditorModel extends IPreferencesEditorModel<ISetting> {
    readonly onDidChangeGroups: Event<cognidream>;
...
export interface IPreferencesService {
    ...
    openGlobalKeybindingSettings(textual: boolean, options?: IOpenKeybindingsEditorOptions): Promise<cognidream>;
...
export interface IKeybindingsEditorPane extends IEditorPane {
    ...
    readonly onLayout: Event<cognidream>;

    search(filter: string): cognidream;
    focusSearch(): cognidream;
    clearSearchResults(): cognidream;
    focusKeybindings(): cognidream;
    recordSearchKeys(): cognidream;
    toggleSortByPrecedence(): cognidream;
    selectKeybinding(keybindingEntry: IKeybindingItemEntry): cognidream;
    defineKeybinding(keybindingEntry: IKeybindingItemEntry, add: boolean): Promise<cognidream>;
    defineWhenExpression(keybindingEntry: IKeybindingItemEntry): cognidream;
    ...
    copyKeybinding(keybindingEntry: IKeybindingItemEntry): Promise<cognidream>;
    copyKeybindingCommand(keybindingEntry: IKeybindingItemEntry): Promise<cognidream>;
    showSimilarKeybindings(keybindingEntry: IKeybindingItemEntry): cognidream;
}
...
export interface IDefineKeybindingEditorContribution extends IEditorContribution {
    showDefineKeybindingWidget(): cognidream;
}
