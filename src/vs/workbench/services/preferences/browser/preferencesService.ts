...
export class PreferencesService extends Disposable implements IPreferencesService {
    ...
    async openGlobalKeybindingSettings(textual: boolean, options?: IOpenKeybindingsEditorOptions): Promise<cognidream> {
    ...
    private async createSettingsIfNotExists(target: ConfigurationTarget, resource: URI): Promise<cognidream> {
    ...
    private async createIfNotExists(resource: URI, contents: string): Promise<cognidream> {
        try {
    ...
    private async revealSetting(settingKey: string, edit: boolean, editor: IEditorPane, settingsResource: URI): Promise<cognidream> {
