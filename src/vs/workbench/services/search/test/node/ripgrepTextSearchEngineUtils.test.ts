...
suite('RipgrepTextSearchEngine', () => {
    ...
    test('fixRegexNewline - re', () => {
        function testFixRegexNewline([inputReg, testStr, shouldMatch]: readonly [string, string, boolean]): cognidream {
    ...
    test('fixNewline - matching', () => {
        function testFixNewline([inputReg, testStr, shouldMatch = true]: readonly [string, string, boolean?]): cognidream {
    ...
    suite('RipgrepParser', () => {
        ...
        function testParser(inputData: string[], expectedResults: TextSearchResult2[]): cognidream {
    ...
    suite('getRgArgs', () => {
        test('simple includes', () => {
            ...
            function testGetRgArgs(includes: string[], expectedFromIncludes: string[]): cognidream {
    ...
    test('brace expansion for ripgrep', () => {
        function testBraceExpansion(argGlob: string, expectedGlob: string[]): cognidream {
