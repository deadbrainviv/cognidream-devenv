...
suite('QueryBuilder', () => {
    ...
    suite('parseSearchPaths 1', () => {
        test('simple includes', () => {
            function testSimpleIncludes(includePattern: string, expectedPatterns: string[]): cognidream {
        ...
        function testIncludes(includePattern: string, expectedResult: ISearchPathsInfo): cognidream {
        ...
        function testIncludesDataItem([includePattern, expectedResult]: [string, ISearchPathsInfo]): cognidream {
...
function assertEqualTextQueries(actual: ITextQuery, expected: ITextQuery): cognidream {
    expected = {
...
export function assertEqualQueries(actual: ITextQuery | IFileQuery, expected: ITextQuery | IFileQuery): cognidream {
    expected = {
        ...DEFAULT_QUERY_PROPS,
        ...expected
    };
    ...
    // Acognidream comparing URI objects, not a good idea
...
export function assertEqualSearchPathResults(actual: ISearchPathsInfo, expected: ISearchPathsInfo, message?: string): cognidream {
    cleanUndefinedQueryValues(actual);
 ...
 */
export function cleanUndefinedQueryValues(q: any): cognidream {
    for (const key in q) {
        if (q[key] === undefined) {
            delete q[key];
