...
export class TextSearchEngineAdapter {
    ...
    search(token: CancellationToken, onResult: (matches: ISerializedFileMatch[]) => cognidream, onMessage: (message: IProgressMessage) => cognidream): Promise<ISerializedSearchSuccess> {
