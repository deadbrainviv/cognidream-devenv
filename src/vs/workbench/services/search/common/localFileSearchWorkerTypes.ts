...
export abstract class LocalFileSearchWorkerHost {
    ...
    public static setChannel(workerClient: IWebWorkerClient<any>, obj: LocalFileSearchWorkerHost): cognidream {
        workerClient.setChannel<LocalFileSearchWorkerHost>(LocalFileSearchWorkerHost.CHANNEL_NAME, obj);
    }

    abstract $sendTextSearchMatch(match: IFileMatch<UriComponents>, queryId: number): cognidream;
}
