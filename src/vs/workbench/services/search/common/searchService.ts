...
export class SearchService extends Disposable implements ISearchService {
    ...
    async textSearch(query: ITextQuery, token?: CancellationToken, onProgress?: (item: ISearchProgressItem) => cognidream): Promise<ISearchComplete> {
    ...
    async aiTextSearch(query: IAITextQuery, token?: CancellationToken, onProgress?: (item: ISearchProgressItem) => cognidream): Promise<ISearchComplete> {
    ...
    textSearchSplitSyncAsync(
        ...
        onProgress?: ((result: ISearchProgressItem) => cognidream) | undefined,
    ...
    private doSearch(query: ISearchQuery, token?: CancellationToken, onProgress?: (item: ISearchProgressItem) => cognidream): Promise<ISearchComplete> {
    ...
    private async searchWithProviders(query: ISearchQuery, onProviderProgress: (progress: ISearchProgressItem) => cognidream, token?: CancellationToken) {
    ...
    private sendTelemetry(query: ISearchQuery, endToEndTime: number, complete?: ISearchComplete, err?: SearchError): cognidream {
    ...
    async clearCache(cacheKey: string): Promise<cognidream> {
