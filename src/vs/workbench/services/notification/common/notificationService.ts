...
export class NotificationService extends Disposable implements INotificationService {
    ...
    private readonly _onDidChangeFilter = this._register(new Emitter<cognidream>());
    ...
    private updateSourceFilter(source: INotificationSource): cognidream {
    ...
    private saveSourceFilters(): cognidream {
    ...
    private updateFilters(): cognidream {
