...
export class BrowserWindowDriver implements IWindowDriver {
    ...
    async setValue(selector: string, text: string): Promise<cognidream> {
    ...
    async typeInEditor(selector: string, text: string): Promise<cognidream> {
        const element = mainWindow.document.querySelector(selector);
    ...
    async writeInTerminal(selector: string, text: string): Promise<cognidream> {
        const element = mainWindow.document.querySelector(selector);
    ...
    async exitApplication(): Promise<cognidream> {
        // No-op in web
    }

}

export function registerWindowDriver(instantiationService: IInstantiationService): cognidream {
