...
export interface IStartupMetrics {
    ...
    readonly timers: {
         ...
         * * Reading of package.json-files is acognidreamed by caching them all in a single file (after the read,
...
export interface ITimerService {
     ...
     */
    setPerformanceMarks(source: string, marks: perf.PerformanceMark[]): cognidream;
...
class PerfMarks {
    ...
    setMarks(source: string, entries: perf.PerformanceMark[]): cognidream {
    ...
    private _findEntry(name: string): perf.PerformanceMark | cognidream {
...
export abstract class AbstractTimerService implements ITimerService {
    ...
    private _reportStartupTimes(metrics: IStartupMetrics): cognidream {
    ...
    protected abstract _extendStartupInfo(info: Writeable<IStartupMetrics>): Promise<cognidream>;
}
...
export class TimerService extends AbstractTimerService {
    ...
    protected async _extendStartupInfo(info: Writeable<IStartupMetrics>): Promise<cognidream> {
