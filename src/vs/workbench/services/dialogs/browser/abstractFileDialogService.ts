...
export abstract class AbstractFileDialogService implements IFileDialogService {
    ...
    protected async pickFileFolderAndOpenSimplified(schema: string, options: IPickAndOpenOptions, preferNewWindow: boolean): Promise<cognidream> {
    ...
    protected async pickFileAndOpenSimplified(schema: string, options: IPickAndOpenOptions, preferNewWindow: boolean): Promise<cognidream> {
    ...
    protected addFileToRecentlyOpened(uri: URI): cognidream {
        this.workspacesService.addRecentlyOpened([{ fileUri: uri, label: this.labelService.getUriLabel(uri, { appendWorkspaceSuffix: true }) }]);
    }

    protected async pickFolderAndOpenSimplified(schema: string, options: IPickAndOpenOptions): Promise<cognidream> {
    ...
    protected async pickWorkspaceAndOpenSimplified(schema: string, options: IPickAndOpenOptions): Promise<cognidream> {
    ...
    abstract pickFileFolderAndOpen(options: IPickAndOpenOptions): Promise<cognidream>;
    abstract pickFileAndOpen(options: IPickAndOpenOptions): Promise<cognidream>;
    abstract pickFolderAndOpen(options: IPickAndOpenOptions): Promise<cognidream>;
    abstract pickWorkspaceAndOpen(options: IPickAndOpenOptions): Promise<cognidream>;
