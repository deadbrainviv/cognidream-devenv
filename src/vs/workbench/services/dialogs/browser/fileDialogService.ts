...
export class FileDialogService extends AbstractFileDialogService implements IFileDialogService {
    ...
    async pickFileFolderAndOpen(options: IPickAndOpenOptions): Promise<cognidream> {
    ...
    async pickFileAndOpen(options: IPickAndOpenOptions): Promise<cognidream> {
        const schema = this.getFileSystemSchema(options);
    ...
    async pickFolderAndOpen(options: IPickAndOpenOptions): Promise<cognidream> {
        const schema = this.getFileSystemSchema(options);
    ...
    async pickWorkspaceAndOpen(options: IPickAndOpenOptions): Promise<cognidream> {
