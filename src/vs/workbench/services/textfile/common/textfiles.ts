...
export interface ITextFileService extends IDisposable {
     ...
     */
    revert(resource: URI, options?: IRevertOptions): Promise<cognidream>;
...
export interface ISaveErrorHandler {
     ...
     */
    onSaveError(error: Error, model: ITextFileEditorModel, options: ITextFileSaveAsOptions): cognidream;
}
...
export interface ITextFileEditorModelManager {
     ...
     */
    runSaveParticipants(model: ITextFileEditorModel, context: ITextFileSaveParticipantContext, progress: IProgress<IProgressStep>, token: CancellationToken): Promise<cognidream>;
...
export interface ITextFileEditorModel extends ITextEditorModel, IEncodingSupport, ILanguageSupport, IWorkingCopy {
    ...
    readonly onDidChangeOrphaned: Event<cognidream>;
    ...
    joinState(state: TextFileEditorModelState.PENDING_SAVE): Promise<cognidream>;

    updatePreferredEncoding(encoding: string | undefined): cognidream;

    save(options?: ITextFileSaveAsOptions): Promise<boolean>;
    revert(options?: IRevertOptions): Promise<cognidream>;

    resolve(options?: ITextFileResolveOptions): Promise<cognidream>;
