...
export default function createSuite(params: Params) {
    ...
    async function testReadStream(resource: URI): Promise<cognidream> {
    ...
    async function testRead(resource: URI): Promise<cognidream> {
    ...
    async function testLargeEncoding(encoding: string, needle: string): Promise<cognidream> {
