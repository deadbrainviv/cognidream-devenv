...
export interface IExtensionRecommendationsService {
    ...
    readonly onDidChangeRecommendations: Event<cognidream>;
...
export interface IExtensionIgnoredRecommendationsService {
    ...
    onDidChangeIgnoredRecommendations: Event<cognidream>;
    ...
    toggleGlobalIgnoredRecommendation(extensionId: string, ignore: boolean): cognidream;
}
