...
export class ExtensionIgnoredRecommendationsService extends Disposable implements IExtensionIgnoredRecommendationsService {
    ...
    private _onDidChangeIgnoredRecommendations = this._register(new Emitter<cognidream>());
    ...
    private async initIgnoredWorkspaceRecommendations(): Promise<cognidream> {
    ...
    toggleGlobalIgnoredRecommendation(extensionId: string, shouldIgnore: boolean): cognidream {
    ...
    private storeCachedIgnoredRecommendations(ignoredRecommendations: string[]): cognidream {
    ...
    private setStoredIgnoredRecommendationsValue(value: string): cognidream {
