...
export interface IDefaultAccountService {
    ...
    setDefaultAccount(account: IDefaultAccount | null): cognidream;
}
...
export class DefaultAccountManagementContribution extends Disposable implements IWorkbenchContribution {
    ...
    private setDefaultAccount(account: IDefaultAccount | null): cognidream {
    ...
    private registerSignInAction(authProviderId: string, authProviderLabel: string, enterpriseAuthProviderId: string, enterpriseAuthProviderConfig: string, scopes: string[]): cognidream {
        const that = this;
