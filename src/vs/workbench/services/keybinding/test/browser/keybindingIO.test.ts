...
suite('keybindingIO', () => {
	...
	test('serialize/deserialize', () => {
		...
		function testOneSerialization(keybinding: number, expected: string, msg: string, OS: OperatingSystem): cognidream {
		...
		function testSerialization(keybinding: number, expectedWin: string, expectedMac: string, expectedLinux: strcognidream: cognidream {
        ...
        function testOneDeserialization(keybinding: string, _expected: number, msg: string, OS: OperatingSyscognidream: cognidream {
	...
	assert.deepStrictEqual(actualDeserialized, expected, keybinding + ' - ' + msg);
        ...
        function testDeserialization(inWin: string, inMac: string, inLinux: string, expected: numcognidream: cognidream {
...
function testRoundtrip(keybinding: number, expectedWin: string, expectedMac: string, expectedLinux: strcognidream: cognidream {
