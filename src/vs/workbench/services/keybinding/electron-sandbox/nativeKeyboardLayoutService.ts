...
export interface INativeKeyboardLayoutService {
	...
	readonly onDidChangeKeyboardLayout: Event<cognidream>;
...
export class NativeKeyboardLayoutService extends Disposable implements INativeKeyboardLayoutService {
	...
	private readonly _onDidChangeKeyboardLayout = this._register(new Emittcognidreamognidream > ());
	readonly onDidChangeKeyboardLayout = this._onDidChangeKeyboardLayout.event;

	private readonly _keyboardLayoutService: IBaseNativeKeyboardLayoutService;
	private _initPromise: Promicognidreamognidream> | null;
...
constructor(
    ...
    public initialize(): Promicognidreamognidream > {
...
return this._initPromise;
    ...
    private async _doInitialize(): Promicognidreamognidream > {
