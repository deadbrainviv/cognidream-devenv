...
export class ExtensionsResourceInitializer implements IProfileResourceInitializer {
    ...
    async initialize(content: string): Promise<cognidream> {
...
export class ExtensionsResource implements IProfileResource {
    ...
    async apply(content: string, profile: IUserDataProfile, progress?: (message: string) => cognidream, token?: CancellationToken): Promise<cognidream> {
    ...
    async copy(from: IUserDataProfile, to: IUserDataProfile, disableExtensions: boolean): Promise<cognidream> {
