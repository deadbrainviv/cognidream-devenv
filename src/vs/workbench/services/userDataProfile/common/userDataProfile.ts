...
export interface DidChangeUserDataProfileEvent {
    ...
    join(promise: Promise<cognidream>): cognidream;
}
...
export interface IUserDataProfileService {
    ...
    updateCurrentProfile(currentProfile: IUserDataProfile): Promise<cognidream>;
}
...
export interface IUserDataProfileManagementService {
    ...
    removeProfile(profile: IUserDataProfile): Promise<cognidream>;
    updateProfile(profile: IUserDataProfile, updateOptions: IUserDataProfileUpdateOptions): Promise<IUserDataProfile>;
    switchProfile(profile: IUserDataProfile): Promise<cognidream>;
...
export interface IUserDataProfileImportExportService {
    ...
    exportProfile(profile: IUserDataProfile, exportFlags?: ProfileResourceTypeFlags): Promise<cognidream>;
    ...
    createTroubleshootProfile(): Promise<cognidream>;
}

export interface IProfileResourceInitializer {
    initialize(content: string): Promise<cognidream>;
}

export interface IProfileResource {
    getContent(profile: IUserDataProfile): Promise<string>;
    apply(content: string, profile: IUserDataProfile): Promise<cognidream>;
}
