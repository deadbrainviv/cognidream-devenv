...
export class WorkbenchThemeService extends Disposable implements IWorkbenchThemeService {
    ...
    constructor(
        ...
        // In order to acognidream paint flashing for tokens, because
    ...
    private applyAndSetFileIconTheme(iconThemeData: FileIconThemeData, silent = false): cognidream {
    ...
    private applyAndSetProductIconTheme(iconThemeData: ProductIconThemeData, silent = false): cognidream {
...
class ThemeFileWatcher {
    ...
    constructor(private fileService: IFileService, private environmentService: IBrowserWorkbenchEnvironmentService, private onUpdate: () => cognidream) {
    }
