...
function _parse(content: string, filename: string | null, locationKeyName: string | null): any {
    ...
    function advancePosBy(by: number): cognidream {
    ...
    function advancePosTo(to: number): cognidream {
        if (locationKeyName === null) {
            pos = to;
        } else {
            advancePosBy(to - pos);
    ...
    function skipWhitespace(): cognidream {
        while (pos < len) {
            const chCode = content.charCodeAt(pos);
    ...
    function advanceUntil(str: string): cognidream {
    ...
    function pushState(newState: State, newCur: any): cognidream {
    ...
    function fail(msg: string): cognidream {
