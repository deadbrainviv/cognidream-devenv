...
export class NativeAuxiliaryWindow extends AuxiliaryWindow {
    ...
    private handleMaximizedState(): cognidream {
        (async () => {
    ...
    private async handleFullScreenState(): Promise<cognidream> {
    ...
    protected override async handleVetoBeforeClose(e: BeforeUnloadEvent, veto: string): Promise<cognidream> {
    ...
    protected override async confirmBeforeClose(e: BeforeUnloadEvent): Promise<cognidream> {
    ...
    protected override preventUnload(e: BeforeUnloadEvent): cognidream {
        e.preventDefault();
        e.returnValue = true;
    }
