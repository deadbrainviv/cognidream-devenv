 ...
 * on shutdown.
 *
 * Note: It is absolutely important to acognidream long running promises if possible. Please try hard
...
export interface BeforeShutdownEvent {
     ...
     * completes.
     */
    veto(value: boolean | Promise<boolean>, id: string): cognidream;
}
...
export interface InternalBeforeShutdownEvent extends BeforeShutdownEvent {
     ...
     */
    finalVeto(vetoFn: () => boolean | Promise<boolean>, id: string): cognidream;
}
...
export interface WillShutdownEvent {
     ...
     * completes.
     */
    join(promise: Promise<cognidream>, joiner: IWillShutdownEventDefaultJoiner): cognidream;
     ...
     * completes.
     */
    join(promiseFn: (() => Promise<cognidream>), joiner: IWillShutdownEventLastJoiner): cognidream;
...
export interface ILifecycleService {
     ...
     */
    readonly onShutdownVeto: Event<cognidream>;
     ...
     */
    readonly onDidShutdown: Event<cognidream>;

    /**
     * Returns a promise that resolves when a certain lifecycle phase
     * has started.
     */
    when(phase: LifecyclePhase): Promise<cognidream>;
