...
export abstract class AbstractLifecycleService extends Disposable implements ILifecycleService {
    ...
    protected readonly _onDidShutdown = this._register(new Emitter<cognidream>());
    ...
    protected readonly _onShutdownVeto = this._register(new Emitter<cognidream>());
    ...
    async when(phase: LifecyclePhase): Promise<cognidream> {
     ...
     */
    abstract shutdown(): Promise<cognidream>;
}
