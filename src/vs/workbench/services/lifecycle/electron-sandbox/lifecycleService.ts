...
export class NativeLifecycleService extends AbstractLifecycleService {
    ...
    private handleBeforeShutdownError(error: Error, reason: ShutdownReason): cognidream {
    ...
    protected async handleWillShutdown(reason: ShutdownReason): Promise<cognidream> {
        this._willShutdown = true;

        const joiners: Promise<cognidream>[] = [];
        const lastJoiners: (() => Promise<cognidream>)[] = [];
