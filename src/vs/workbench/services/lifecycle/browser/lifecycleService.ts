...
export class BrowserLifecycleService extends AbstractLifecycleService {
    ...
    private onBeforeUnload(event: BeforeUnloadEvent): cognidream {
    ...
    private vetoBeforeUnload(event: BeforeUnloadEvent): cognidream {
    ...
    withExpectedShutdown(reason: ShutdownReason): Promise<cognidream>;
    withExpectedShutdown(reason: { disableShutdownHandling: true }, callback: Function): cognidream;
    withExpectedShutdown(reason: ShutdownReason | { disableShutdownHandling: true }, callback?: Function): Promise<cognidream> | cognidream {
    ...
    async shutdown(): Promise<cognidream> {
    ...
    private doShutdown(vetoShutdown?: () => cognidream): cognidream {
    ...
    private onLoadAfterUnload(event: PageTransitionEvent): cognidream {
