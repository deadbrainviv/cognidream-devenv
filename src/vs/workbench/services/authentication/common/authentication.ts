...
export interface IAuthenticationService {
     ...
     */
    readonly onDidChangeDeclaredProviders: Event<cognidream>;
     ...
     */
    registerDeclaredAuthenticationProvider(provider: AuthenticationProviderInformation): cognidream;

    /**
     * Unregisters a declared authentication provider
     * @param id The id of the provider to unregister
     */
    unregisterDeclaredAuthenticationProvider(id: string): cognidream;
     ...
     */
    registerAuthenticationProvider(id: string, provider: IAuthenticationProvider): cognidream;

    /**
     * Unregisters an authentication provider
     * @param id The id of the provider to unregister
     */
    unregisterAuthenticationProvider(id: string): cognidream;
     ...
     */
    removeSession(providerId: string, sessionId: string): Promise<cognidream>;
}
...
export interface IAuthenticationExtensionsService {
    ...
    requestSessionAccess(providerId: string, extensionId: string, extensionName: string, scopes: string[], possibleSessions: readonly AuthenticationSession[]): cognidream;
    requestNewSession(providerId: string, scopes: string[], extensionId: string, extensionName: string): Promise<cognidream>;
}
...
export interface IAuthenticationProvider {
     ...
     * @param sessionId - The ID of the session to remove.
     */
    removeSession(sessionId: string): Promise<cognidream>;
}
