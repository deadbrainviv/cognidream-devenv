...
export interface IAuthenticationUsageService {
     ...
     */
    initializeExtensionUsageCache(): Promise<cognidream>;
    /**
     ...
     * @param accountName The name of the account to get usages for
     */
    removeAccountUsage(providerId: string, accountName: string): cognidream;
    /**
     ...
     */
    addAccountUsage(providerId: string, accountName: string, scopes: ReadonlyArray<string>, extensionId: string, extensionName: string): cognidream;
}
...
export class AuthenticationUsageService extends Disposable implements IAuthenticationUsageService {
    ...
    async initializeExtensionUsageCache(): Promise<cognidream> {
    ...
    addAccountUsage(providerId: string, accountName: string, scopes: string[], extensionId: string, extensionName: string): cognidream {
        const accountKey = `${providerId}-${accountName}-usages`;
