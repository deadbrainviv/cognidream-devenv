...
export interface IAuthenticationAccessService {
    ...
    updateAllowedExtensions(providerId: string, accountName: string, extensions: AllowedExtension[]): cognidream;
    removeAllowedExtensions(providerId: string, accountName: string): cognidream;
}
