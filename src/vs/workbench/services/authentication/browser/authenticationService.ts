...
export class AuthenticationService extends Disposable implements IAuthenticationService {
    ...
    private _onDidChangeDeclaredProviders: Emitter<cognidream> = this._register(new Emitter<cognidream>());
    readonly onDidChangeDeclaredProviders: Event<cognidream> = this._onDidChangeDeclaredProviders.event;
    ...
    private _registerEnvContributedAuthenticationProviders(): cognidream {
    ...
    private _registerAuthenticationExtentionPointHandler(): cognidream {
    ...
    registerAuthenticationProvider(id: string, authenticationProvider: IAuthenticationProvider): cognidream {
    ...
    async removeSession(id: string, sessionId: string): Promise<cognidream> {
