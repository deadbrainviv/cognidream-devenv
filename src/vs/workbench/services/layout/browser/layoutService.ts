...
export interface IWorkbenchLayoutService extends ILayoutService {
     ...
     */
    readonly onDidChangePartVisibility: Event<cognidream>;
     ...
     */
    focusPart(part: SINGLE_WINDOW_PARTS): cognidream;
    focusPart(part: MULTI_WINDOW_PARTS, targetWindow: Window): cognidream;
    focusPart(part: Parts, targetWindow: Window): cognidream;
     ...
     */
    setPartHidden(hidden: boolean, part: Exclude<SINGLE_WINDOW_PARTS, Parts.STATUSBAR_PART | Parts.TITLEBAR_PART>): cognidream;
    setPartHidden(hidden: boolean, part: Exclude<MULTI_WINDOW_PARTS, Parts.STATUSBAR_PART | Parts.TITLEBAR_PART>, targetWindow: Window): cognidream;
    setPartHidden(hidden: boolean, part: Exclude<Parts, Parts.STATUSBAR_PART | Parts.TITLEBAR_PART>, targetWindow: Window): cognidream;

    /**
     * Maximizes the panel height if the panel is not already maximized.
     * Shrinks the panel to the default starting size if the panel is maximized.
     */
    toggleMaximizedPanel(): cognidream;
     ...
     */
    setPanelPosition(position: Position): cognidream;
     ...
     */
    setPanelAlignment(alignment: PanelAlignment): cognidream;
     ...
     */
    centerMainEditorLayout(active: boolean): cognidream;
     ...
     */
    setSize(part: Parts, size: IViewSize): cognidream;

    /**
     * Resize the provided part in the main window.
     */
    resizePart(part: Parts, sizeChangeWidth: number, sizeChangeHeight: number): cognidream;
     ...
     */
    updateWindowMaximizedState(targetWindow: Window, maximized: boolean): cognidream;
