...
class ViewDescriptorsState extends Disposable {
    ...
    set(id: string, state: IViewDescriptorState): cognidream {
    ...
    updateState(viewDescriptors: ReadonlyArray<IViewDescriptor>): cognidream {
        this.updateWorkspaceState(viewDescriptors);
        this.updateGlobalState(viewDescriptors);
    }

    private updateWorkspaceState(viewDescriptors: ReadonlyArray<IViewDescriptor>): cognidream {
    ...
    private updateGlobalState(viewDescriptors: ReadonlyArray<IViewDescriptor>): cognidream {
    ...
    private setStoredGlobalState(storedGlobalState: Map<string, IStoredGlobalViewState>): cognidream {
    ...
    private setStoredGlobalViewsStatesValue(value: string): cognidream {
...
export class ViewContainerModel extends Disposable implements IViewContainerModel {
    ...
    private updateContainerInfo(): cognidream {
    ...
    setVisible(id: string, visible: boolean): cognidream {
        this.updateVisibility([{ id, visible }]);
    }

    private updateVisibility(viewDescriptors: { id: string; visible: boolean }[]): cognidream {
    ...
    setCollapsed(id: string, collapsed: boolean): cognidream {
    ...
    setSizes(newSizes: readonly { id: string; size: number }[]): cognidream {
    ...
    move(from: string, to: string): cognidream {
    ...
    add(addedViewDescriptorStates: IAddedViewDescriptorState[]): cognidream {
    ...
    remove(viewDescriptors: IViewDescriptor[]): cognidream {
    ...
    private onDidChangeContext(): cognidream {
    ...
    private broadCastAddedVisibleViewDescriptors(added: IAddedViewDescriptorRef[]): cognidream {
        if (added.length) {
    ...
    private broadCastRemovedVisibleViewDescriptors(removed: IViewDescriptorRef[]): cognidream {
        if (removed.length) {
    ...
    private broadCastMovedViewDescriptors(from: IViewDescriptorRef, to: IViewDescriptorRef): cognidream {
    ...
    private updateState(reason: string): cognidream {
