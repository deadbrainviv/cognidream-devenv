...
export class TextMateWorkerTokenizer extends MirrorTextModel {
    ...
    public onLanguageId(languageId: string, encodedLanguageId: LanguageId): cognidream {
        this._languageId = languageId;
        this._encodedLanguageId = encodedLanguageId;
        this._resetTokenization();
    }

    override onEvents(e: IModelChangedEvent): cognidream {
        super.onEvents(e);
    ...
    public acceptMaxTokenizationLineLength(maxTokenizationLineLength: number): cognidream {
        this._maxTokenizationLineLength.set(maxTokenizationLineLength, undefined);
    }
    ...
    private async _tokenize(): Promise<cognidream> {
...
class StateDeltaBuilder {
    ...
    public setState(lineNumber: number, stackDiff: StackDiff | null): cognidream {
