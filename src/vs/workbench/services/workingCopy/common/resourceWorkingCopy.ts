...
export abstract class ResourceWorkingCopy extends Disposable implements IResourceWorkingCopy {
    ...
    protected setOrphaned(orphaned: boolean): cognidream {
    ...
    abstract onDidChangeDirty: Event<cognidream>;
    abstract onDidChangeContent: Event<cognidream>;
    ...
    abstract revert(options?: IRevertOptions): Promise<cognidream>;
