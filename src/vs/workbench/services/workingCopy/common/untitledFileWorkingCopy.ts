...
export class UntitledFileWorkingCopy<M extends IUntitledFileWorkingCopyModel> extends Disposable implements IUntitledFileWorkingCopy<M> {
    ...
    private setModified(modified: boolean): cognidream {
    ...
    async resolve(): Promise<cognidream> {
        this.trace('resolve()');
    ...
    private onModelContentChanged(e: IUntitledFileWorkingCopyModelContentChangedEvent): cognidream {
