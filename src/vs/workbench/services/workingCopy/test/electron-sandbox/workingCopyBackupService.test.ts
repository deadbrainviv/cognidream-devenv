...
export class NodeTestWorkingCopyBackupService extends NativeWorkingCopyBackupService {
    ...
    private pendingBackupsArr: Promise<cognidream>[];
    ...
    async waitForAllBackups(): Promise<cognidream> {
        await Promise.all(this.pendingBackupsArr);
    }

    joinBackupResource(): Promise<cognidream> {
        return new Promise(resolve => this.backupResourceJoiners.push(resolve));
    }

    override async backup(identifier: IWorkingCopyIdentifier, content?: VSBufferReadableStream | VSBufferReadable, versionId?: number, meta?: any, token?: CancellationToken): Promise<cognidream> {
    ...
    joinDiscardBackup(): Promise<cognidream> {
        return new Promise(resolve => this.discardBackupJoiners.push(resolve));
    }

    override async discardBackup(identifier: IWorkingCopyIdentifier): Promise<cognidream> {
    ...
    override async discardBackups(filter?: { except: IWorkingCopyIdentifier[] }): Promise<cognidream> {
...
suite('WorkingCopyBackupService', () => {
    ...
    suite('resolve', () => {
        ...
        async function testShouldRestoreOriginalContentsWithBrokenBackup(identifier: IWorkingCopyIdentifier): Promise<cognidream> {
            const contents = [
                'Lorem ipsum ',
                'dolor öäü sit amet ',
                'adipiscing ßß elit',
        ...
        async function testShouldUpdateMetaFromFileWhenResolving(identifier: IWorkingCopyIdentifier): Promise<cognidream> {
