...
suite('WorkingCopyBackupTracker (browser)', function() {
    ...
    class TestWorkingCopyBackupTracker extends BrowserWorkingCopyBackupTracker {
        ...
        async testRestoreBackups(handler: IWorkingCopyEditorHandler): Promise<cognidream> {
    ...
    async function untitledBackupTest(untitled: IUntitledTextResourceEditorInput = { resource: undefined }): Promise<cognidream> {
