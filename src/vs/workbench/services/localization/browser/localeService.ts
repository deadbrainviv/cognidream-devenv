...
export class WebLocaleService implements ILocaleService {
    ...
    async setLocale(languagePackItem: ILanguagePackItem, _skipDialog = false): Promise<cognidream> {
    ...
    async clearLocalePreference(): Promise<cognidream> {
        localeStorage.clearLocale();
        localeStorage.clearExtensionId();
