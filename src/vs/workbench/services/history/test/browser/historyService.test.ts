...
suite('HistoryService', function() {
    ...
    async function setTextSelection(historyService: IHistoryService, pane: TestTextFileEditor, selection: Selection, reason = EditorPaneSelectionChangeReason.USER): Promise<cognidream> {
    ...
    function assertTextSelection(expected: Selection, pane: EditorPane): cognidream {
    ...
    test('go to last edit location', async function() {
        ...
        const onDidActiveEditorChange = new DeferredPromise<cognidream>();
