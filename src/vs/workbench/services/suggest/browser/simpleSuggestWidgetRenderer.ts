...
export class SimpleSuggestWidgetItemRenderer implements IListRenderer<SimpleCompletionItem, ISimpleSuggestionTemplateData> {
	...
	readonly onDidToggleDetails: Evecognidreamognidream> = this._onDidToggleDetails.event;
...
dispose(cognidreamognidream {
    ...
    renderElement(element: SimpleCompletionItem, index: number, data: ISimpleSuggestionTemplateDatacognidreamognidream {
...
disposeTemplate(templateData: ISimpleSuggestionTemplateDatacognidreamognidream {
