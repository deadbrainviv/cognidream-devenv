...
export interface IUntitledTextEditorModel extends ITextEditorModel, ILanguageSupport, IEncodingSupport, IWorkingCopy {
     ...
     */
    readonly onDidChangeEncoding: Event<cognidream>;

    /**
     * Emits an event when the name of this untitled model changes.
     */
    readonly onDidChangeName: Event<cognidream>;

    /**
     * Emits an event when this untitled model is reverted.
     */
    readonly onDidRevert: Event<cognidream>;
     ...
     */
    setEncoding(encoding: string): Promise<cognidream>;

    /**
     * Resolves the untitled model.
     */
    resolve(): Promise<cognidream>;
}
...
export class UntitledTextEditorModel extends BaseTextEditorModel implements IUntitledTextEditorModel {
    ...
    private readonly _onDidChangeName = this._register(new Emitter<cognidream>());
    ...
    private onConfigurationChange(e: ITextResourceConfigurationChangeEvent | undefined, fromEvent: boolean): cognidream {
    ...
    async setEncoding(encoding: string): Promise<cognidream> {
    ...
    async revert(): Promise<cognidream> {
    ...
    private onModelContentChanged(textEditorModel: ITextModel, e: IModelContentChangedEvent): cognidream {
    ...
    private updateNameFromFirstLine(textEditorModel: ITextModel): cognidream {
