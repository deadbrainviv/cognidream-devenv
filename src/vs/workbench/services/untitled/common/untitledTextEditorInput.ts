...
export class UntitledTextEditorInput extends AbstractTextResourceEditorInput implements IEncodingSupport, ILanguageSupport {
    ...
    private modelResolve: Promise<cognidream> | undefined = undefined;
    ...
    private registerModelListeners(model: IUntitledTextEditorModel): cognidream {
    ...
    private onDidCreateUntitledModel(model: IUntitledTextEditorModel): cognidream {
    ...
    setEncoding(encoding: string, mode: EncodingMode /* ignored, we only have Encode */): Promise<cognidream> {
    ...
    private disposeModelReference(): cognidream {
