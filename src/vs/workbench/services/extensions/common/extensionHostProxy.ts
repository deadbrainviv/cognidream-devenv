...
export interface IExtensionHostProxy {
    ...
    startExtensionHost(extensionsDelta: IExtensionDescriptionDelta): Promise<cognidream>;
    ...
    updateRemoteConnectionData(connectionData: IRemoteConnectionData): Promise<cognidream>;
