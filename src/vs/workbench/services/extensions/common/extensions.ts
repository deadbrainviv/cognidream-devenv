...
export const nullExtensionDescription = Object.freeze<IExtensionDescription>({
    ...
    publisher: 'vscode',
    engines: { vscode: '' },
    extensionLocation: URI.parse('cognidream:location'),
    isBuiltin: false,
...
export function checkProposedApiEnabled(extension: IExtensionDescription, proposal: ApiProposalName): cognidream {
...
export interface IWillActivateEvent {
    ...
    readonly activation: Promise<cognidream>;
}
...
export interface WillStopExtensionHostsEvent {
     ...
     */
    veto(value: boolean | Promise<boolean>, reason: string): cognidream;
}
...
export interface IExtensionService {
     ...
     */
    onDidRegisterExtensions: Event<cognidream>;
     ...
     */
    activateByEvent(activationEvent: string, activationKind?: ActivationKind): Promise<cognidream>;

    /**
     * Send an activation ID and activate interested extensions.
     *
     */
    activateById(extensionId: ExtensionIdentifier, reason: ExtensionActivationReason): Promise<cognidream>;
     ...
     */
    startExtensionHosts(updates?: { readonly toAdd: readonly IExtension[]; readonly toRemove: readonly string[] }): Promise<cognidream>;

    /**
     * Modify the environment of the remote extension host
     * @param env New properties for the remote extension host
     */
    setRemoteEnvironment(env: { [key: string]: string | null }): Promise<cognidream>;
}
...
export class NullExtensionService implements IExtensionService {
    ...
    onDidRegisterExtensions: Event<cognidream> = Event.None;
    ...
    readonly extensions = [];
    activateByEvent(_activationEvent: string): Promise<cognidream> { return Promise.resolve(undefined); }
    activateById(extensionId: ExtensionIdentifier, reason: ExtensionActivationReason): Promise<cognidream> { return Promise.resolve(undefined); }
    ...
    async startExtensionHosts(): Promise<cognidream> { }
    async setRemoteEnvironment(_env: { [key: string]: string | null }): Promise<cognidream> { }
