...
export interface MessagePortLike {
    postMessage(message: any, transfer?: any[]): cognidream;
    addEventListener(type: 'message', listener: (e: any) => unknown): cognidream;
    removeEventListener(type: 'message', listener: (e: any) => unknown): cognidream;
    start(): cognidream;
}
