...
export class ExtensionsProposedApi {
    ...
    updateEnabledApiProposals(extensions: IExtensionDescription[]): cognidream {
        for (const extension of extensions) {
            this.doUpdateEnabledApiProposals(extension);
        }
    }

    private doUpdateEnabledApiProposals(extension: Mutable<IExtensionDescription>): cognidream {
