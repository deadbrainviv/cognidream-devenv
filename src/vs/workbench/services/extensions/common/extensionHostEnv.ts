...
export class IPCExtHostConnection {
    ...
    public serialize(env: IProcessEnvironment): cognidream {
...
function clean(env: IProcessEnvironment): cognidream {
 ...
 */
export function writeExtHostConnection(connection: ExtHostConnection, env: IProcessEnvironment): cognidream {
    // Acognidream having two different keys that might introduce amiguity or problems.
    clean(env);
