...
export interface IExtensionHostManager {
    ...
    dispose(): cognidream;
    ready(): Promise<cognidream>;
    representsRunningLocation(runningLocation: ExtensionRunningLocation): boolean;
    deltaExtensions(extensionsDelta: IExtensionDescriptionDelta): Promise<cognidream>;
    ...
    start(extensionRegistryVersionId: number, allExtensions: readonly IExtensionDescription[], myExtensions: ExtensionIdentifier[]): Promise<cognidream>;
