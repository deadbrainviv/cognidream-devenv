...
export class ExtensionRunningLocationTracker {
    ...
    public initializeRunningLocation(localExtensions: IExtensionDescription[], remoteExtensions: IExtensionDescription[]): cognidream {
     ...
     */
    private _updateRunningLocationForAddedExtensions(toAdd: IExtensionDescription[]): cognidream {
        // Determine new running location
        const localProcessExtensions: IExtensionDescription[] = [];
        const localWebWorkerExtensions: IExtensionDescription[] = [];
