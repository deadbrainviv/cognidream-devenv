...
export class CachedExtensionScanner {
    ...
    private _scannedExtensionsResolve!: (result: IExtensionDescription[]) => cognidream;
    private _scannedExtensionsReject!: (err: any) => cognidream;
    ...
    public async startScanningExtensions(): Promise<cognidream> {
        try {
