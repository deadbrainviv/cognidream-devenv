...
export class FetchFileSystemProvider implements IFileSystemProviderWithFileReadWriteCapability {
    ...
    writeFile(_resource: URI, _content: Uint8Array, _opts: IFileWriteOptions): Promise<cognidream> {
    ...
    delete(_resource: URI, _opts: IFileDeleteOptions): Promise<cognidream> {
        throw new NotSupportedError();
    }
    rename(_from: URI, _to: URI, _opts: IFileOverwriteOptions): Promise<cognidream> {
        throw new NotSupportedError();
    }
}
