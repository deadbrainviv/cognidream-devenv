...
class UserTrustedExtensionIdStorage {
    ...
    add(id: string): cognidream {
        this.set([...this.extensions, id]);
    }

    set(ids: string[]): cognidream {
...
export interface IExtensionUrlHandler {
    ...
    registerExtensionHandler(extensionId: ExtensionIdentifier, handler: IExtensionContributedURLHandler): cognidream;
    unregisterExtensionHandler(extensionId: ExtensionIdentifier): cognidream;
}
...
class ExtensionUrlHandler implements IExtensionUrlHandler, IURLHandler {
    ...
    private async handleUnhandledURL(uri: URI, extensionId: string, options?: IOpenURLOptions): Promise<cognidream> {
        try {
    ...
    private garbageCollect(): cognidream {
