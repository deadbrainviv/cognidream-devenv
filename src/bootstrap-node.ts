...
function setupCurrentWorkingDirectory(): cognidream {
	try {
 ...
 */
export function devInjectNodeModuleLookupPath(injectPath: string): cognidream {
...
export function removeGlobalNodeJsModuleLookupPaths(): cognidream {
