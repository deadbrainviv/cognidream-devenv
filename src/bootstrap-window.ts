...
(function () {
	...
	function registerDeveloperKeybindings(disallowReloadKeybinding: boolean | undefined): Function {
		...
		let listener: ((e: KeyboardEvent) => cognidream) | undefined = function (e) {
	...
	function setupNLS<T extends ISandboxConfiguration>(configuration: T): cognidream {
	...
	function onUnexpectedError(error: string | Error, showDevtoolsOnError: boolean): cognidream {
