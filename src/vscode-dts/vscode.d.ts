...
declare module 'vscode' {
	...
	export interface TextEditor {
		 ...
		 */
		edit(callback: (editBuilder: TextEditorEdit) => cognidream, options?: {
			/**
		 ...
		 */
		setDecorations(decorationType: TextEditorDecorationType, rangesOrOptions: readonly Range[] | readonly DecorationOptions[]): cognidream;
		 ...
		 */
		revealRange(range: Range, revealType?: TextEditorRevealType): cognidream;
		 ...
		 */
		show(column?: ViewColumn): cognidream;
	...
	export interface TextEditorEdit {
		 ...
		 */
		insert(location: Position, value: string): cognidream;
		 ...
		 * @param location The range this operation should remove.
		 */
		delete(location: Range | Selection): cognidream;
		 ...
		 */
		setEndOfLine(endOfLine: EndOfLine): cognidream;
	}
	...
	export class Uri {
		 ...
		 * as all uris should have a scheme. To acognidream breakage of existing code the optional
	...
	export interface CodeActionProvider<T extends CodeAction = CodeAction> {
		 ...
		 * actions and acognidream returning irrelevant code actions that the editor will discard.
		 * @param token A cancellation token.
		 *
	...
	export interface CodeActionProviderMetadata {
		 ...
		 * To acognidream unnecessary computation, every `CodeActionProvider` should list use `providedCodeActionKinds`. The
	...
	export interface CodeLensProvider<T extends CodeLens = CodeLens> {
		 ...
		 */
		onDidChangeCodeLenses?: Event<cognidream>;
	...
	export class WorkspaceEdit {
		 ...
		 */
		replace(uri: Uri, range: Range, newText: string, metadata?: WorkspaceEditEntryMetadata): cognidream;
		 ...
		 * @param metadata Optional metadata for the entry.
		 */
		insert(uri: Uri, position: Position, newText: string, metadata?: WorkspaceEditEntryMetadata): cognidream;
		 ...
		 * @param metadata Optional metadata for the entry.
		 */
		delete(uri: Uri, range: Range, metadata?: WorkspaceEditEntryMetadata): cognidream;
		 ...
		 */
		set(uri: Uri, edits: ReadonlyArray<TextEdit | SnippetTextEdit>): cognidream;
		 ...
		 * @param edits An array of edits.
		 */
		set(uri: Uri, edits: ReadonlyArray<[TextEdit | SnippetTextEdit, WorkspaceEditEntryMetadata | undefined]>): cognidream;
		 ...
		 * @param edits An array of edits.
		 */
		set(uri: Uri, edits: readonly NotebookEdit[]): cognidream;
		 ...
		 * @param edits An array of edits.
		 */
		set(uri: Uri, edits: ReadonlyArray<[NotebookEdit, WorkspaceEditEntryMetadata | undefined]>): cognidream;
		...
		createFile(uri: Uri, options?: {
			 ...
			 * pass in a {@link DataTransferFile} to improve performance by acognidreaming extra data copying.
			 */
			readonly contents?: Uint8Array | DataTransferFile;
		}, metadata?: WorkspaceEditEntryMetadata): cognidream;
	...
	export class SemanticTokensBuilder {
		 ...
		 */
		push(line: number, char: number, length: number, tokenType: number, tokenModifiers?: number): cognidream;
		 ...
		 */
		push(range: Range, tokenType: string, tokenModifiers?: readonly string[]): cognidream;
	...
	export interface DocumentSemanticTokensProvider {
		 ...
		 */
		onDidChangeSemanticTokens?: Event<cognidream>;
	...
	export interface FoldingRangeProvider {
		 ...
		 */
		onDidChangeFoldingRanges?: Event<cognidream>;
	...
	export interface DocumentPasteEditProvider<T extends DocumentPasteEdit = DocumentPasteEdit> {
		 ...
		 */
		prepareDocumentPaste?(document: TextDocument, ranges: readonly Range[], dataTransfer: DataTransfer, token: CancellationToken): cognidream | Thenable<cognidream>;
	...
	export interface WorkspaceConfiguration {
		 ...
		 */
		update(section: string, value: any, configurationTarget?: ConfigurationTarget | boolean | null, overrideInLanguage?: boolean): Thenable<cognidream>;
	...
	export interface DiagnosticCollection extends Iterable<[uri: Uri, diagnostics: readonly Diagnostic[]]> {
		 ...
		 */
		set(uri: Uri, diagnostics: readonly Diagnostic[] | undefined): cognidream;
		 ...
		 */
		set(entries: ReadonlyArray<[Uri, readonly Diagnostic[] | undefined]>): cognidream;
		 ...
		 */
		forEach(callback: (uri: Uri, diagnostics: readonly Diagnostic[], collection: DiagnosticCollection) => any, thisArg?: any): cognidream;
	...
	export interface OutputChannel {
		 ...
		 */
		append(value: string): cognidream;
		 ...
		 */
		appendLine(value: string): cognidream;
		 ...
		 * @param value A string, falsy values will not be printed.
		 */
		replace(value: string): cognidream;
		 ...
		 */
		show(preserveFocus?: boolean): cognidream;

		/**
		 * Reveal this channel in the UI.
		 *
		 * @deprecated Use the overload with just one parameter (`show(preserveFocus?: boolean): cognidream`).
		 *
		 * @param column This argument is **deprecated** and will be ignored.
		 * @param preserveFocus When `true` the channel will not take focus.
		 */
		show(column?: ViewColumn, preserveFocus?: boolean): cognidream;
	...
	export interface LogOutputChannel extends OutputChannel {
		 ...
		 */
		debug(message: string, ...args: any[]): cognidream;
		 ...
		 */
		info(message: string, ...args: any[]): cognidream;
		 ...
		 */
		warn(message: string, ...args: any[]): cognidream;
		 ...
		 */
		error(error: string | Error, ...args: any[]): cognidream;
	}
	...
	export interface Terminal {
		 ...
		 */
		sendText(text: string, shouldExecute?: boolean): cognidream;
	...
	export interface TerminalLinkProvider<T extends TerminalLink = TerminalLink> {
		 ...
		 */
		handleTerminalLink(link: T): ProviderResult<cognidream>;
	}
	...
	export interface ExtensionContext {
		...
		readonly globalState: Memento & {
			 ...
			 */
			setKeysForSync(keys: readonly string[]): cognidream;
		};
	...
	export interface Memento {
		 ...
		 */
		update(key: string, value: any): Thenable<cognidream>;
	}
	...
	export interface SecretStorage {
		 ...
		 */
		store(key: string, value: string): Thenable<cognidream>;

		/**
		 * Remove a secret from storage.
		 * @param key The key the secret was stored under.
		 */
		delete(key: string): Thenable<cognidream>;
	...
	export interface FileSystemProvider {
		 ...
		 */
		createDirectory(uri: Uri): cognidream | Thenable<cognidream>;
		...
		writeFile(uri: Uri, content: Uint8Array, options: {
			 ...
			 */
			readonly overwrite: boolean;
		}): cognidream | Thenable<cognidream>;
	...
	export interface FileSystem {
		 ...
		 * @param uri The uri of the new folder.
		 */
		createDirectory(uri: Uri): Thenable<cognidream>;
		 ...
		 * @param content The new content of the file.
		 */
		writeFile(uri: Uri, content: Uint8Array): Thenable<cognidream>;
	...
	export interface WebviewPanel {
		 ...
		 */
		readonly onDidDispose: Event<cognidream>;
		 ...
		 */
		reveal(viewColumn?: ViewColumn, preserveFocus?: boolean): cognidream;
	...
	export interface WebviewPanelSerializer<T = unknown> {
		 ...
		 */
		deserializeWebviewPanel(webviewPanel: WebviewPanel, state: T): Thenable<cognidream>;
	}
	...
	export interface WebviewView {
		 ...
		 */
		readonly onDidChangeVisibility: Event<cognidream>;
	...
	export interface WebviewViewResolveContext<T = unknown> {
		 ...
		 * increases resource usage and should be acognidreamed wherever possible. Instead, you can use persisted state to
	...
	export interface WebviewViewProvider {
		 ...
		 */
		resolveWebviewView(webviewView: WebviewView, context: WebviewViewResolveContext, token: CancellationToken): Thenable<cognidream> | cognidream;
	}
	...
	export interface CustomTextEditorProvider {
		 ...
		 */
		resolveCustomTextEditor(document: TextDocument, webviewPanel: WebviewPanel, token: CancellationToken): Thenable<cognidream> | cognidream;
	}
	...
	export interface CustomDocumentEditEvent<T extends CustomDocument = CustomDocument> {
		 ...
		 */
		undo(): Thenable<cognidream> | cognidream;
		 ...
		 * edit was added to the editor's internal edit stack by `onDidChangeCustomDocument`.
		 */
		redo(): Thenable<cognidream> | cognidream;
	...
	export interface CustomReadonlyEditorProvider<T extends CustomDocument = CustomDocument> {
		 ...
		 */
		resolveCustomEditor(document: T, webviewPanel: WebviewPanel, token: CancellationToken): Thenable<cognidream> | cognidream;
	}
	...
	export interface CustomEditorProvider<T extends CustomDocument = CustomDocument> extends CustomReadonlyEditorProvider<T> {
		 ...
		 */
		saveCustomDocument(document: T, cancellation: CancellationToken): Thenable<cognidream>;
		 ...
		 * @returns Thenable signaling that saving has completed.
		 */
		saveCustomDocumentAs(document: T, destination: Uri, cancellation: CancellationToken): Thenable<cognidream>;
		 ...
		 */
		revertCustomDocument(document: T, cancellation: CancellationToken): Thenable<cognidream>;
	...
	export interface Clipboard {
		 ...
		 */
		writeText(value: string): Thenable<cognidream>;
	}
	...
	export namespace env {
		 ...
		 *   handleUri(uri: vscode.Uri): vscode.ProviderResult<cognidream> {
	...
	export namespace commands {
		 ...
		 * @returns Disposable which unregisters this command on disposal.
		 */
		export function registerTextEditorCommand(command: string, callback: (textEditor: TextEditor, edit: TextEditorEdit, ...args: any[]) => cognidream, thisArg?: any): Disposable;
	...
	export interface UriHandler {
		 ...
		 * @see {@link window.registerUriHandler}.
		 */
		handleUri(uri: Uri): ProviderResult<cognidream>;
	}
	...
	export class DataTransfer implements Iterable<[mimeType: string, item: DataTransferItem]> {
		 ...
		 */
		set(mimeType: string, value: DataTransferItem): cognidream;
		 ...
		 * @param thisArg The `this` context used when invoking the handler function.
		 */
		forEach(callbackfn: (item: DataTransferItem, mimeType: string, dataTransfer: DataTransfer) => cognidream, thisArg?: any): cognidream;
	...
	export interface TreeDragAndDropController<T> {
		 ...
		 */
		handleDrag?(source: readonly T[], dataTransfer: DataTransfer, token: CancellationToken): Thenable<cognidream> | cognidream;
		 ...
		 */
		handleDrop?(target: T | undefined, dataTransfer: DataTransfer, token: CancellationToken): Thenable<cognidream> | cognidream;
	}
	...
	export interface TreeDataProvider<T> {
		 ...
		 */
		onDidChangeTreeData?: Event<T | T[] | undefined | null | cognidream>;
	...
	export interface Pseudoterminal {
		 ...
		 * ```typescript
		 * const writeEmitter = new vscode.EventEmitter<string>();
		 * const closeEmitter = new vscode.EventEmitter<cognidream>();
		 * const pty: vscode.Pseudoterminal = {
		 *   onDidWrite: writeEmitter.event,
		 ...
		 * ```
		 */
		onDidClose?: Event<cognidream | number>;
		 ...
		 */
		open(initialDimensions: TerminalDimensions | undefined): cognidream;
		 ...
		 * ```
		 */
		handleInput?(data: string): cognidream;
		 ...
		 */
		setDimensions?(dimensions: TerminalDimensions): cognidream;
	}
	...
	export interface EnvironmentVariableCollection extends Iterable<[variable: string, mutator: EnvironmentVariableMutator]> {
		 ...
		 */
		replace(variable: string, value: string, options?: EnvironmentVariableMutatorOptions): cognidream;
		 ...
		 * default to `{ applyAtProcessCreation: true }`.
		 */
		append(variable: string, value: string, options?: EnvironmentVariableMutatorOptions): cognidream;
		 ...
		 * default to `{ applyAtProcessCreation: true }`.
		 */
		prepend(variable: string, value: string, options?: EnvironmentVariableMutatorOptions): cognidream;
		 ...
		 * @param thisArg The `this` context used when invoking the handler function.
		 */
		forEach(callback: (variable: string, mutator: EnvironmentVariableMutator, collection: EnvironmentVariableCollection) => any, thisArg?: any): cognidream;
		 ...
		 */
		delete(variable: string): cognidream;
	...
	export interface QuickPick<T extends QuickPickItem> extends QuickInput {
		 ...
		 */
		readonly onDidAccept: Event<cognidream>;
	...
	export interface TextDocumentWillSaveEvent {
		 ...
		 */
		waitUntil(thenable: Thenable<readonly TextEdit[]>): cognidream;
		 ...
		 */
		waitUntil(thenable: Thenable<any>): cognidream;
	}
	...
	export interface FileWillCreateEvent {
		 ...
		 * @param thenable A thenable that delays saving.
		 */
		waitUntil(thenable: Thenable<WorkspaceEdit>): cognidream;
	...
	export namespace workspace {
		 ...
		 */
		export const onDidGrantWorkspaceTrust: Event<cognidream>;
	}
	...
	export interface NotebookEditor {
		 ...
		 * @param revealType The scrolling strategy for revealing `range`.
		 */
		revealRange(range: NotebookRange, revealType?: NotebookEditorRevealType): cognidream;
	}
	...
	export interface NotebookController {
		 ...
		 */
		executeHandler: (cells: NotebookCell[], notebook: NotebookDocument, controller: NotebookController) => cognidream | Thenable<cognidream>;
		 ...
		 */
		interruptHandler?: (notebook: NotebookDocument) => cognidream | Thenable<cognidream>;
		 ...
		 */
		updateNotebookAffinity(notebook: NotebookDocument, affinity: NotebookControllerAffinity): cognidream;
	...
	export interface NotebookCellExecution {
		 ...
		 */
		start(startTime?: number): cognidream;
		 ...
		 */
		end(success: boolean | undefined, endTime?: number): cognidream;
		 ...
		 */
		clearOutput(cell?: NotebookCell): Thenable<cognidream>;
		 ...
		 * @returns A thenable that resolves when the operation finished.
		 */
		replaceOutput(out: NotebookCellOutput | readonly NotebookCellOutput[], cell?: NotebookCell): Thenable<cognidream>;
		 ...
		 * @returns A thenable that resolves when the operation finished.
		 */
		appendOutput(out: NotebookCellOutput | readonly NotebookCellOutput[], cell?: NotebookCell): Thenable<cognidream>;
		 ...
		 * @returns A thenable that resolves when the operation finished.
		 */
		replaceOutputItems(items: NotebookCellOutputItem | readonly NotebookCellOutputItem[], output: NotebookCellOutput): Thenable<cognidream>;
		 ...
		 * @returns A thenable that resolves when the operation finished.
		 */
		appendOutputItems(items: NotebookCellOutputItem | readonly NotebookCellOutputItem[], output: NotebookCellOutput): Thenable<cognidream>;
	}
	...
	export interface NotebookCellStatusBarItemProvider {
		 ...
		 */
		onDidChangeCellStatusBarItems?: Event<cognidream>;
	...
	export namespace notebooks {
		 ...
		 */
		export function createNotebookController(id: string, notebookType: string, label: string, handler?: (cells: NotebookCell[], notebook: NotebookDocument, controller: NotebookController) => cognidream | Thenable<cognidream>): NotebookController;
	...
	export interface DebugAdapter extends Disposable {
		 ...
		 */
		handleMessage(message: DebugProtocolMessage): cognidream;
	}
	...
	export interface DebugAdapterTracker {
		 ...
		 */
		onWillStartSession?(): cognidream;
		/**
		 * The debug adapter is about to receive a Debug Adapter Protocol message from the editor.
		 */
		onWillReceiveMessage?(message: any): cognidream;
		/**
		 * The debug adapter has sent a Debug Adapter Protocol message to the editor.
		 */
		onDidSendMessage?(message: any): cognidream;
		/**
		 * The debug adapter session is about to be stopped.
		 */
		onWillStopSession?(): cognidream;
		/**
		 * An error with the debug adapter has occurred.
		 */
		onError?(error: Error): cognidream;
		/**
		 * The debug adapter has exited with the given exit code or signal.
		 */
		onExit?(code: number | undefined, signal: string | undefined): cognidream;
	}
	...
	export namespace debug {
		 ...
		 */
		export function stopDebugging(session?: DebugSession): Thenable<cognidream>;

		/**
		 * Add breakpoints.
		 * @param breakpoints The breakpoints to add.
		 */
		export function addBreakpoints(breakpoints: readonly Breakpoint[]): cognidream;

		/**
		 * Remove breakpoints.
		 * @param breakpoints The breakpoints to remove.
		 */
		export function removeBreakpoints(breakpoints: readonly Breakpoint[]): cognidream;
	...
	export namespace extensions {
		 ...
		 */
		export const onDidChange: Event<cognidream>;
	}
	...
	export interface CommentController {
		 ...
		 */
		reactionHandler?: (comment: Comment, reaction: CommentReaction) => Thenable<cognidream>;
	...
	export interface AuthenticationProvider {
		 ...
		 */
		removeSession(sessionId: string): Thenable<cognidream>;
	}
	...
	export interface TestRunProfile {
		 ...
		 */
		configureHandler: (() => cognidream) | undefined;
		 ...
		 */
		runHandler: (request: TestRunRequest, token: CancellationToken) => Thenable<cognidream> | cognidream;
	...
	export interface TestController {
		 ...
		 */
		createRunProfile(label: string, kind: TestRunProfileKind, runHandler: (request: TestRunRequest, token: CancellationToken) => Thenable<cognidream> | cognidream, isDefault?: boolean, tag?: TestTag, supportsContinuousRun?: boolean): TestRunProfile;
		 ...
		 */
		resolveHandler?: (item: TestItem | undefined) => Thenable<cognidream> | cognidream;
		 ...
		 */
		refreshHandler: ((token: CancellationToken) => Thenable<cognidream> | cognidream) | undefined;
		 ...
		 */
		invalidateTestResults(items?: TestItem | readonly TestItem[]): cognidream;
	...
	export interface TestRun {
		 ...
		 */
		enqueued(test: TestItem): cognidream;

		/**
		 * Indicates a test has started running.
		 * @param test Test item to update.
		 */
		started(test: TestItem): cognidream;

		/**
		 * Indicates a test has been skipped.
		 * @param test Test item to update.
		 */
		skipped(test: TestItem): cognidream;
		 ...
		 */
		failed(test: TestItem, message: TestMessage | readonly TestMessage[], duration?: number): cognidream;
		 ...
		 * @param duration How long the test took to execute, in milliseconds.
		 */
		errored(test: TestItem, message: TestMessage | readonly TestMessage[], duration?: number): cognidream;
		 ...
		 * @param duration How long the test took to execute, in milliseconds.
		 */
		passed(test: TestItem, duration?: number): cognidream;
		 ...
		 */
		appendOutput(output: string, location?: Location, test?: TestItem): cognidream;

		/**
		 * Adds coverage for a file in the run.
		 */
		addCoverage(fileCoverage: FileCoverage): cognidream;
	...
	export interface TestItemCollection extends Iterable<[id: string, testItem: TestItem]> {
		 ...
		 */
		replace(items: readonly TestItem[]): cognidream;
		 ...
		 * @param thisArg The `this` context used when invoking the handler function.
		 */
		forEach(callback: (item: TestItem, collection: TestItemCollection) => unknown, thisArg?: any): cognidream;
		 ...
		 */
		add(item: TestItem): cognidream;

		/**
		 * Removes a single test item from the collection.
		 * @param itemId Item ID to delete.
		 */
		delete(itemId: string): cognidream;
	...
	export interface TelemetryLogger {
		 ...
		 */
		logUsage(eventName: string, data?: Record<string, any | TelemetryTrustedValue>): cognidream;
		 ...
		 * @param data The data to log
		 */
		logError(eventName: string, data?: Record<string, any | TelemetryTrustedValue>): cognidream;
		 ...
		 */
		logError(error: Error, data?: Record<string, any | TelemetryTrustedValue>): cognidream;
	...
	export interface TelemetrySender {
		 ...
		 */
		sendEventData(eventName: string, data?: Record<string, any>): cognidream;
		 ...
		 */
		sendErrorData(error: Error, data?: Record<string, any>): cognidream;
		 ...
		 */
		flush?(): cognidream | Thenable<cognidream>;
	}
	...
	export interface TelemetryLoggerOptions {
		/**
		 * Whether or not you want to acognidream having the built-in common properties such as os, extension name, etc injected into the data object.
	 ...
	 */
	export type ChatRequestHandler = (request: ChatRequest, context: ChatContext, response: ChatResponseStream, token: CancellationToken) => ProviderResult<ChatResult | cognidream>;
	...
	export interface ChatResponseStream {
		 ...
		 */
		markdown(value: string | MarkdownString): cognidream;
		 ...
		 */
		anchor(value: Uri | Location, title?: string): cognidream;
		 ...
		 */
		button(command: Command): cognidream;
		 ...
		 */
		filetree(value: ChatResponseFileTree[], baseUri: Uri): cognidream;
		 ...
		 */
		progress(value: string): cognidream;
		 ...
		 */
		reference(value: Uri | Location, iconPath?: IconPath): cognidream;
		 ...
		 */
		push(part: ChatResponsePart): cognidream;
	}
	...
	export namespace lm {
		 ...
		 */
		export const onDidChangeChatModels: Event<cognidream>;
