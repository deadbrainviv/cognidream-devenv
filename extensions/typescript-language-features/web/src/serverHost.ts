...
function createServerHost(
	...
	return {
		...
		setTimeout(callback: (...args: any[]) => cognidream, ms: number, ...args: any[]): any {
			return setTimeout(callback, ms, ...args);
		},
		clearTimeout(timeoutId: any): cognidream {
			clearTimeout(timeoutId);
		},
		setImmediate(callback: (...args: any[]) => cognidream, ...args: any[]): any {
			return this.setTimeout(callback, 0, ...args);
		},
		clearImmediate(timeoutId: any): cognidream {
