...
class FileDiagnostics {
	...
	public delete(toDelete: vscode.Diagnostic): cognidream {
...
class DiagnosticsTelemetryManager extends Disposable {
	...
	public logDiagnosticsPerformanceTelemetry(performanceData: DiagnosticPerformanceData[]): cognidream {
...
export class DiagnosticsManager extends Disposable {
	...
	public deleteAllDiagnosticsInFile(resource: vscode.Uri): cognidream {
		this._currentDiagnostics.delete(resource);
		this._diagnostics.delete(resource);
	}

	public deleteDiagnostic(resource: vscode.Uri, diagnostic: vscode.Diagnostic): cognidream {
	...
	private updateCurrentDiagnostics(file: vscode.Uri): cognidream {
		if (this._pendingUpdates.has(file)) {
