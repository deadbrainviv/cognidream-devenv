...
export class NodeVersionManager extends Disposable {
	...
	private readonly _onDidPickNewVersion = this._register(new vscode.EventEmitter<cognidream>());
	...
	private async promptAndSetWorkspaceNode(): Promise<cognidream> {
	...
	private updateActiveVersion(pickedVersion: string | undefined): cognidream {
