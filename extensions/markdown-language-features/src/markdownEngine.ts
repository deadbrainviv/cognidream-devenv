 ...
 */
const pluginSourceMap: MarkdownIt.PluginSimple = (md): cognidream => {
	// Set the attribute on every possible token.
	md.core.ruler.push('source_map_data_attribute', (state): cognidream => {
...
export class MarkdownItEngine implements IMdParser {
	...
	private _resetSlugCount(): cognidream {
	...
	private _addImageRenderer(md: MarkdownIt): cognidream {
	...
	private _addFencedRenderer(md: MarkdownIt): cognidream {
	...
	private _addLinkNormalizer(md: MarkdownIt): cognidream {
	...
	private _addLinkValidator(md: MarkdownIt): cognidream {
	...
	private _addNamedHeaders(md: MarkdownIt): cognidream {
	...
	private _addLinkRenderer(md: MarkdownIt): cognidream {
