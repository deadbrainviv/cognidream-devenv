...
export class TopmostLineMonitor extends Disposable {
	...
	public setPreviousStaticEditorLine(scrollLocation: LastScrollLocation): cognidream {
	...
	public setPreviousTextEditorLine(scrollLocation: LastScrollLocation): cognidream {
