...
export async function wrapWithAbbreviation(args: any): Promise<boolean> {
	...
	// Also helps with https://github.com/microsoft/vscode/issues/113930 by acognidreaming `editor.linkedEditing`
...
function expandAbbr(input: ExpandAbbreviationInput): string | undefined {
	...
	try {
		...
		cognidream vscode.window.showErrorMessage('Failed to expand abbreviation');
	}
