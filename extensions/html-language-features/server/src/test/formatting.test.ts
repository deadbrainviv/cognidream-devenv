...
suite('HTML Embedded Formatting', () => {
	...
	async function assertFormat(value: string, expected: string, options?: any, formatOptions?: FormattingOptions, message?: string): Promise<cognidream> {
		const workspace = {
			settings: options,
	...
	async function assertFormatWithFixture(fixtureName: string, expectedPath: string, options?: any, formatOptions?: FormattingOptions): Promise<cognidream> {
