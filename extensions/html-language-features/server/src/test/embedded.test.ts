...
suite('HTML Embedded Support', () => {
	...
	function assertLanguageId(value: string, expectedLanguageId: string | undefined): cognidream {
	...
	function assertEmbeddedLanguageContent(value: string, languageId: string, expectedContent: string): cognidream {
		const document = TextDocument.create('test://test/test.html', 'html', 0, value);
