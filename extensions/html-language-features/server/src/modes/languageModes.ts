...
export interface LanguageMode {
	...
	onDocumentRemoved(document: TextDocument): cognidream;
...
export interface LanguageModes {
	updateDataProviders(dataProviders: IHTMLDataProvider[]): cognidream;
...
export function getLanguageModes(supportedLanguages: { [languageId: string]: boolean }, workspace: Workspace, clientCapabilities: ClientCapabilities, requestService: FileSystemProvider): LanguageModes {
	...
	return {
		async updateDataProviders(dataProviders: IHTMLDataProvider[]): Promise<cognidream> {
