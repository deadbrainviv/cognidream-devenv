...
interface JQueryXHR extends XMLHttpRequest, JQueryPromise<any> {
     ...
     */
    abort(statusText?: string): cognidream;
    /**
     * Incorporates the functionality of the .done() and .fail() methods, allowing (as of jQuery 1.8) the underlying Promise to be manipulated. Refer to deferred.then() for implementation details.
     */
    then<R>(doneCallback: (data: any, textStatus: string, jqXHR: JQueryXHR) => R, failCallback?: (jqXHR: JQueryXHR, textStatus: string, errorThrown: any) => cognidream): JQueryPromise<R>;
    /**
     ...
     */
    error(xhr: JQueryXHR, textStatus: string, errorThrown: string): cognidream;
}
...
interface JQueryGenericPromise<T> {
     ...
     * @param failFilter An optional function that is called when the Deferred is rejected.
     */
    then(doneFilter: (value?: T, ...values: any[]) => cognidream, failFilter?: (...reasons: any[]) => any, progressFilter?: (...progression: any[]) => any): JQueryPromise<cognidream>;
}
...
interface BaseJQueryEventObject extends Event {
    ...
    result: any;
    stopImmediatePropagation(): cognidream;
...
interface JQueryStatic {
     ...
     */
    ajaxPrefilter(dataTypes: string, handler: (opts: any, originalOpts: JQueryAjaxSettings, jqXHR: JQueryXHR) => any): cognidream;
    /**
     * Handle custom Ajax options or modify existing options before each request is sent and before they are processed by $.ajax().
     *
     * @param handler A handler to set default values for future Ajax requests.
     */
    ajaxPrefilter(handler: (opts: any, originalOpts: JQueryAjaxSettings, jqXHR: JQueryXHR) => any): cognidream;
     ...
     */
    ajaxSetup(options: JQueryAjaxSettings): cognidream;
     ...
     */
    holdReady(hold: boolean): cognidream;
     ...
     */
    dequeue(element: Element, queueName?: string): cognidream;
