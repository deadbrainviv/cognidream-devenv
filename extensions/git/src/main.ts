...
async function warnAboutMissingGit(): Promise<cognidream> {
...
async function checkGitv1(info: IGit): Promise<cognidream> {
	const config = workspace.getConfiguration('git');
...
async function checkGitWindows(info: IGit): Promise<cognidream> {
...
async function checkGitVersion(info: IGit): Promise<cognidream> {
