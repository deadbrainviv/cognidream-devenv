...
export class GitHistoryProvider implements SourceControlHistoryProvider, FileDecorationProvider, IDisposable {
	...
	private readonly _onDidChangeCurrentHistoryItemRefs = new EventEmitter<cognidream>();
	readonly onDidChangeCurrentHistoryItemRefs: Event<cognidream> = this._onDidChangeCurrentHistoryItemRefs.event;
	...
	private async onDidRunWriteOperation(result: OperationResult): Promise<cognidream> {
