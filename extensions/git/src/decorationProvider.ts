...
class GitIgnoreDecorationProvider implements FileDecorationProvider {
	...
	@debounce(500)
	private checkIgnoreSoon(): cognidream {
...
class GitDecorationProvider implements FileDecorationProvider {
	...
	private collectDecorationData(group: GitResourceGroup, bucket: Map<string, FileDecoration>): cognidream {
	...
	private collectSubmoduleDecorationData(bucket: Map<string, FileDecoration>): cognidream {
...
class GitIncomingChangesFileDecorationProvider implements FileDecorationProvider {
	...
	private async onDidChangeCurrentHistoryItemRefs(): Promise<cognidream> {
	...
	private async collectIncomingChangesFileDecorations(bucket: Map<string, FileDecoration>): Promise<cognidream> {
...
export class GitDecorations {
	...
	private onDidOpenRepository(repository: Repository): cognidream {
	...
	private onDidCloseRepository(repository: Repository): cognidream {
