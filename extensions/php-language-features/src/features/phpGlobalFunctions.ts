...
export const globalfunctions: IEntries = {
	...
	debug_print_backtrace: {
		...
		signature: '([ int $options = 0 [, int $limit = 0 ]]): cognidream'
	},
	error_clear_last: {
		description: 'Clear the most recent error',
		signature: '(cognidream): cognidream'
	},
	error_get_last: {
		description: 'Get the last occurred error',
		signature: '(cognidream): array'
	},
	error_log: {
	...
	ob_implicit_flush: {
		...
		signature: '([ int $flag = 1 ]): cognidream'
	},
	ob_list_handlers: {
	...
	ini_restore: {
		...
		signature: '( string $varname ): cognidream'
	},
	ini_set: {
	...
	zip_close: {
		...
		signature: '( resource $zip ): cognidream'
	},
	zip_entry_close: {
	...
	openssl_free_key: {
		...
		signature: '( resource $key_identifier ): cognidream'
	},
	...
	openssl_pkey_free: {
		...
		signature: '( resource $key ): cognidream'
	},
	...
	openssl_x509_free: {
		...
		signature: '( resource $x509cert ): cognidream'
	},
	openssl_x509_parse: {
	...
	sodium_add: {
		...
		signature: '( string $val , string $addv ): cognidream'
	},
	sodium_base642bin: {
	...
	sodium_crypto_secretstream_xchacha20poly1305_rekey: {
		description: 'Description',
		signature: '( string $state ): cognidream'
	},
	...
	sodium_increment: {
		...
		signature: '( string $val ): cognidream'
	},
	sodium_memcmp: {
	...
	sodium_memzero: {
		...
		signature: '( string $buf ): cognidream'
	},
	sodium_pad: {
	...
	dba_close: {
		...
		signature: '( resource $handle ): cognidream'
	},
	dba_delete: {
	...
	closedir: {
		...
		signature: '([ resource $dir_handle ]): cognidream'
	},
	dir: {
	...
	clearstatcache: {
		...
		signature: '([ bool $clear_realpath_cache [, string $filename ]]): cognidream'
	},
	copy: {
	...
	datefmt_get_calendar_object: {
		...
		signature: '(cognidream): IntlCalendar'
	},
	datefmt_get_timezone: {
		description: 'Get formatterʼs timezone',
		signature: '(cognidream): IntlTimeZone'
	},
	datefmt_is_lenient: {
	...
	transliterator_create_inverse: {
		...
		signature: '(cognidream): Transliterator'
	},
	...
	mt_srand: {
		...
		signature: '([ int $seed [, int $mode = MT_RAND_MT19937 ]]): cognidream'
	},
	octdec: {
	...
	pcntl_exec: {
		...
		signature: '( string $path [, array $args [, array $envs ]]): cognidream'
	},
	pcntl_fork: {
	...
	passthru: {
		...
		signature: '( string $command [, int $return_var ]): cognidream'
	},
	proc_close: {
	...
	shmop_close: {
		...
		signature: '( resource $shmid ): cognidream'
	},
	shmop_delete: {
	...
	exit: {
		...
		signature: '( int $status ): cognidream'
	},
	get_browser: {
	...
	usleep: {
		...
		signature: '( int $micro_seconds ): cognidream'
	},
	class_implements: {
	...
	spl_autoload_call: {
		...
		signature: '( string $class_name ): cognidream'
	},
	...
	spl_autoload: {
		...
		signature: '( string $class_name [, string $file_extensions = spl_autoload_extensions() ]): cognidream'
	},
	spl_classes: {
	...
	stream_bucket_append: {
		...
		signature: '( resource $brigade , object $bucket ): cognidream'
	},
	...
	curl_close: {
		...
		signature: '( resource $ch ): cognidream'
	},
	curl_copy_handle: {
	...
	curl_multi_close: {
		...
		signature: '( resource $mh ): cognidream'
	},
	curl_multi_errno: {
	...
	curl_share_close: {
		...
		signature: '( resource $sh ): cognidream'
	},
	curl_share_errno: {
	...
	header_remove: {
		...
		signature: '([ string $name ]): cognidream'
	},
	header: {
		description: 'Send a raw HTTP header',
		signature: '( string $header [, bool $replace [, int $http_response_code ]]): cognidream'
	},
	headers_list: {
	...
	socket_clear_error: {
		...
		signature: '([ resource $socket ]): cognidream'
	},
	socket_close: {
	...
	echo: {
		...
		signature: '( string $arg1 [, string $... ]): cognidream'
	},
	explode: {
	...
	parse_str: {
		...
		signature: '( string $encoded_string [, array $result ]): cognidream'
	},
	print: {
	...
	__autoload: {
		...
		signature: '( string $class ): cognidream'
	},
	...
	register_shutdown_function: {
		...
		signature: '( callable $callback [, mixed $... ]): cognidream'
	},
	...
	unregister_tick_function: {
		...
		signature: '( callable $function ): cognidream'
	},
	boolval: {
	...
	debug_zval_dump: {
		...
		signature: '( mixed $variable [, mixed $... ]): cognidream'
	},
	doubleval: {
	...
	unset: {
		...
		signature: '( mixed $var [, mixed $... ]): cognidream'
	},
	var_dump: {
	...
	variant_set_type: {
		...
		signature: '( variant $variant , int $type ): cognidream'
	},
	variant_set: {
		description: 'Assigns a new value for a variant object',
		signature: '( variant $variant , mixed $value ): cognidream'
	},
	variant_sub: {
	...
	libxml_get_last_error: {
		...
		signature: '(cognidream): LibXMLError'
	},
	...
	libxml_set_streams_context: {
		...
		signature: '( resource $streams_context ): cognidream'
	},
