...
suite('vscode API - workspace', () => {
	...
	async function testEditRenameEdit(newUriCreator: (oldUri: vscode.Uri) => vscode.Uri): Promise<cognidream> {
	...
	async function test77735(withOpenedEditor: boolean): Promise<cognidream> {
	...
	test('encoding: openTextDocument', async () => {
		...
		const documentChangePromise = new Promise<cognidream>(resolve => {
