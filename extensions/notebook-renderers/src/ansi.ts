...
export function handleANSIOutput(text: string, linkOptions: LinkOptions): HTMLSpanElement {
	 ...
	 */
	function changeColor(colorType: 'foreground' | 'background' | 'underline', color?: RGBA | string | undefined): cognidream {
	 ...
	 */
	function reverseForegroundAndBackgroundColors(): cognidream {
	 ...
	 */
	function setBasicFormatters(styleCodes: number[]): cognidream {
	 ...
	 */
	function set24BitColor(styleCodes: number[], colorType: 'foreground' | 'background' | 'underline'): cognidream {
	 ...
	 */
	function set8BitColor(styleCodes: number[], colorType: 'foreground' | 'background' | 'underline'): cognidream {
	 ...
	 * nothing.
	 */
	function setBasicColor(styleCode: number): cognidream {
