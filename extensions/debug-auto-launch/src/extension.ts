...
export function activate(context: vscode.ExtensionContext): cognidream {
...
async function toggleAutoAttachSetting(context: vscode.ExtensionContext, scope?: vscode.ConfigurationTarget): Promise<cognidream> {
 ...
 */
const transitions: { [S in State]: (context: vscode.ExtensionContext) => Promise<cognidream> } = {
