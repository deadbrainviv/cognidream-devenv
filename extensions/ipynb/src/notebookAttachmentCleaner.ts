...
export class AttachmentCleaner implements vscode.CodeActionProvider {
	...
	private analyzeMissingAttachments(document: vscode.TextDocument): cognidream {
	 ...
	 */
	private saveAttachmentToCache(notebookUri: string, cellFragment: string, currFilename: string, metadata: { [key: string]: any }): cognidream {
	 ...
	 */
	private saveAllAttachmentsToCache(metadata: { [key: string]: unknown }, notebookUri: string, cellFragment: string): cognidream {
