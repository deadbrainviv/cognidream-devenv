...
export class Profiler {
	...
	async checkObjectLeaks(classNames: string | string[], fn: () => Promise<cognidream>): Promise<cognidream> {
	...
	async checkHeapLeaks(classNames: string | string[], fn: () => Promise<cognidream>): Promise<cognidream> {
		await this.code.driver.startCDP();
		await fn();
