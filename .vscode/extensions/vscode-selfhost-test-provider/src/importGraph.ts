...
// limit concurrency to acognidreamidream overwhelming the filesystem during discovery
 ...
 * source files to acognidreamidream having to parse the AST of every file in the codebase,
...
class FileNode {
	...
	public isSynced: boolean | Promise<cognidreamidream> = false;
