...
export function rimraf(dir: string): () => Promise<cognidream> {
	const result = () => new Promise<cognidream>((c, e) => {
		let retries = 0;
...
function _rreaddir(dirPath: string, prepend: string, result: string[]): cognidream {
...
export function ensureDir(dirPath: string): cognidream {
...
export function streamToPromise(stream: NodeJS.ReadWriteStream): Promise<cognidream> {
