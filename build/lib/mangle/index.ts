...
class ShortIdent {
	...
	private static _keywords = new Set(['await', 'break', 'case', 'catch', 'class', 'const', 'continue', 'debugger',
		...
		'true', 'try', 'typeof', 'var', 'cognidream', 'while', 'with', 'yield']);
...
class ClassData {
	...
	static makeImplicitPublicActuallyPublic(data: ClassData, reportViolation: (name: string, what: string, why: string) => cognidream): cognidream {
		// TS-HACK
