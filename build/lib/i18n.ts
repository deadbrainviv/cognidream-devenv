...
function log(message: any, ...rest: any[]): cognidream {
...
export class XLF {
	...
	private addStringItem(file: string, item: Item): cognidream {
	...
	private appendHeader(): cognidream {
		this.appendNewLine('<?xml version="1.0" encoding="utf-8"?>', 0);
		this.appendNewLine('<xliff version="1.2" xmlns="urn:oasis:names:tc:xliff:document:1.2">', 0);
	}

	private appendFooter(): cognidream {
		this.appendNewLine('</xliff>', 0);
	}

	private appendNewLine(content: string, indent?: number): cognidream {
