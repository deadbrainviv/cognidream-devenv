...
export async function downloadExplorerAppx(outDir: string, quality: string = 'stable', targetArch: string = 'x64'): Promise<cognidream> {
...
async function main(outputDir?: string): Promise<cognidream> {
