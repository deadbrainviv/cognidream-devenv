...
export async function downloadLibcxxHeaders(outDir: string, electronVersion: string, lib_name: string): Promise<cognidream> {
...
export async function downloadLibcxxObjects(outDir: string, electronVersion: string, targetArch: string = 'x64'): Promise<cognidream> {
...
async function main(): Promise<cognidream> {
